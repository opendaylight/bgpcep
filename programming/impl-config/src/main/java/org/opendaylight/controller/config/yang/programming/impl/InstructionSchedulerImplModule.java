...
public final class InstructionSchedulerImplModule extends org.opendaylight.controller.config.yang.programming.impl.AbstractInstructionSchedulerImplModule
{
	...
	public java.lang.AutoCloseable createInstance() {
		// FIXME: configured
		final NotificationProviderService notifs = null; // Preconditions.checkNotNull(session.getSALService(NotificationProviderService.class));

		// FIXME: configured
		final RpcProviderRegistry rpcs = null;
		...
		final ProgrammingServiceImpl inst = new ProgrammingServiceImpl(notifs, exec, timer);

		final RpcRegistration<ProgrammingService> reg = rpcs.addRpcImplementation(ProgrammingService.class, inst);

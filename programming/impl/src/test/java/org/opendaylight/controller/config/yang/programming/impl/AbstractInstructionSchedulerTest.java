...
public abstract class AbstractInstructionSchedulerTest extends AbstractConfigTest {
    ...
    private static final String DATA_BROKER_INSTANCE_NAME = "binding-data-compatible-broker-instance";
    ...
    public ObjectName createCompatibleDataBrokerInstance(final ConfigTransactionJMXClient transaction, final ObjectName domBrokerInstance)
            throws InstanceAlreadyExistsException, InstanceNotFoundException {
        final ObjectName nameCreated = transaction.createModule(ForwardedCompatibleDataBrokerImplModuleFactory.NAME, DATA_BROKER_INSTANCE_NAME);
        ...
        mxBean.setDomAsyncBroker(domBrokerInstance);
        return nameCreated;
    }

    public ObjectName createAsyncDataBrokerInstance(final ConfigTransactionJMXClient transaction, final ObjectName domBrokerInstance) throws InstanceAlreadyExistsException, InstanceNotFoundException {
    ...
    private ObjectName createDomAsyncDataBroker(final ConfigTransactionJMXClient transaction) throws InstanceAlreadyExistsException {
    ...
    public ObjectName createDomBrokerInstance(final ConfigTransactionJMXClient transaction) throws InstanceAlreadyExistsException {

...
public class ProgrammingServiceImplTest extends AbstractConcurrentDataBrokerTest {
    ...
    private static final InstructionsQueueKey INSTRUCTIONS_QUEUE_KEY =
        new InstructionsQueueKey("test-instraction-queue");
    ...
    private KeyedInstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.programming.
        ...
        return InstanceIdentifier.builder(InstructionsQueue.class, INSTRUCTIONS_QUEUE_KEY).build()

...
public class ProgrammingRpcHandlerTest extends AbstractProgrammingTest {
    ...
    public void testCancelInstruction() throws Exception {
        ...
        final var cancelRpc = ((CancelInstruction) rpcMap.get(CancelInstruction.class));
        cancelRpc.invoke(mockedCancel);
    ...
    public void testCancelDependantInstruction() throws Exception {
        ...
        final var cancelRpc = ((CancelInstruction) rpcMap.get(CancelInstruction.class));
        cancelRpc.invoke(getCancelInstruction("mockedSubmit1"));
    ...
    public void testCleanInstructions() throws Exception {
        ...
        final var cleanRpc = ((CleanInstructions) rpcMap.get(CleanInstructions.class));

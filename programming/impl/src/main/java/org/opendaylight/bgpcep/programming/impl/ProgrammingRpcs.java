...
final class ProgrammingRpcs implements ClusterSingletonService, InstructionScheduler {
    private static final Logger LOG = LoggerFactory.getLogger(ProgrammingRpcs.class);
    ...
    ProgrammingRpcs(final DataBroker dataProvider, final NotificationPublishService notifs,

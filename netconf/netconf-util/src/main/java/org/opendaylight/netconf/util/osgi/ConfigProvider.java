...
public interface ConfigProvider {
	 ...
	 * properties are then searched. The method returns {@code null} if the property is not found.
	 * 
	 * <p>
	 ...
	 * @throws SecurityException If the caller does not have the appropriate {@code PropertyPermission} to read the

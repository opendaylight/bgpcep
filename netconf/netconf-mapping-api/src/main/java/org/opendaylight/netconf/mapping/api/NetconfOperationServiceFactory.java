...
/**
 * Factory that must be registered in OSGi service registry in order to be used by netconf-impl. Responsible for
 * creating per-session instances of {@link NetconfOperationService}.
 */

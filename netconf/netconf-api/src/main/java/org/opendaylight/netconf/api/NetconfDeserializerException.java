...
/**
 * This exception is thrown by {@link NetconfSessionListener#onMessage(NetconfMessage)} to indicate fatal communication
 * problem after which the session should be closed.
 */

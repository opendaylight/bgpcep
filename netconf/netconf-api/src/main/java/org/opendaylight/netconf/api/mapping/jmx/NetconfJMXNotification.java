...
public abstract class NetconfJMXNotification extends Notification {
	...
	protected NetconfJMXNotification(TransactionProviderJMXNotificationType type, NotificationBroadcasterSupport source, String message) {
	 ...
	 * @param cfgSnapshot
	 */
	public static CommitJMXNotification afterCommit(NotificationBroadcasterSupport source, String message, Element cfgSnapshot,

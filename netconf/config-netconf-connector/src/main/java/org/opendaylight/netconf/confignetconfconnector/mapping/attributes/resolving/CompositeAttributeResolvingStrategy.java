...
final class CompositeAttributeResolvingStrategy extends AbstractAttributeResolvingStrategy<CompositeDataSupport, CompositeType> {
	...
	public Optional<CompositeDataSupport> parseAttribute(String attrName, Object value) {
		...
		try {
			...
			throw new RuntimeException("An error occured during restoration of composite type " + this + " for attribute " + attrName
					+ " from value " + value, e);
		}

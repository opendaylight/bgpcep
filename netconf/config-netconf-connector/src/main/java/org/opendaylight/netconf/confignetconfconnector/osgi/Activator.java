...
public class Activator implements BundleActivator, YangStoreServiceTracker.YangStoreTrackerListener {
	...
	ServiceRegistration<NetconfOperationServiceFactory> osgiRegistration;
	...
	public synchronized void onYangStoreAdded(YangStoreService yangStoreService) {
		...
		osgiRegistration = context.registerService(NetconfOperationServiceFactory.class, factory, new Hashtable<String, Object>());
	}

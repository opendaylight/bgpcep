...
public abstract class AbstractEditConfigStrategy implements EditConfigStrategy {
	...
	abstract void handleMissingInstance(Map<String, AttributeConfigElement> configuration, ConfigTransactionClient ta, String module,
			String instance);

	abstract void executeStrategy(Map<String, AttributeConfigElement> configuration, ConfigTransactionClient ta, ObjectName objectName);

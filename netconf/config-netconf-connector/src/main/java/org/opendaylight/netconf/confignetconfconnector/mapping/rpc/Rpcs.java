...
import org.opendaylight.netconf.confignetconfconnector.operations.runtimerpc.RuntimeRpcElementResolved;
...
public class Rpcs {
	...
	public ModuleRpcs getRpcMapping(RuntimeRpcElementResolved id) {
		...
		Preconditions.checkState(modules != null, "No module %s found for namespace %s", id.getModuleName(), id.getNamespace());

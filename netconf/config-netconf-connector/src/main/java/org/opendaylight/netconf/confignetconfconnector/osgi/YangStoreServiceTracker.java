...
class YangStoreServiceTracker extends ServiceTracker {
	...
	@Override
	public synchronized YangStoreService addingService(final ServiceReference reference) {
		final YangStoreService yangStoreService = (YangStoreService) super.addingService(reference);

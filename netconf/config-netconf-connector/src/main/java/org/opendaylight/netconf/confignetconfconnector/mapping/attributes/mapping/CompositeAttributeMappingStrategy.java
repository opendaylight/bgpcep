...
public class CompositeAttributeMappingStrategy extends AbstractAttributeMappingStrategy<Map<String, Object>, CompositeType> {
	...
	public CompositeAttributeMappingStrategy(CompositeType compositeType,
			Map<String, AttributeMappingStrategy<?, ? extends OpenType<?>>> innerStrategies, Map<String, String> jmxToJavaNameMapping) {
		super(compositeType);
	...
	public Optional<Map<String, Object>> mapAttribute(Object value) {
		...
		Preconditions.checkArgument(expectedCompositeTypeKeys.equals(currentCompositeTypeKeys),
				"Composite type mismatch, expected composite type with attributes " + expectedCompositeTypeKeys + " but was "
						+ currentCompositeTypeKeys);
		...
		for (String jmxName : jmxToJavaNameMapping.keySet()) {
			...
			AttributeMappingStrategy<?, ? extends OpenType<?>> attributeMappingStrategy = innerStrategies.get(innerAttrJmxName);

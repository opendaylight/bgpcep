...
package org.opendaylight.netconf.confignetconfconnector.mapping.rpc;
...
public final class InstanceRuntimeRpc {
	...
	private void resolveConfiguration(Map<String, AttributeConfigElement> mappedConfig) {
		...
		Map<String, AttributeResolvingStrategy<?, ? extends OpenType<?>>> resolvingStrategies = new ObjectResolver(null).prepareResolving(yangToAttrConfig);

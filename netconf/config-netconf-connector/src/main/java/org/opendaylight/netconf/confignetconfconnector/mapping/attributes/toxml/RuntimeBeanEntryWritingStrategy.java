...
public class RuntimeBeanEntryWritingStrategy extends CompositeAttributeWritingStrategy {
	...
	public RuntimeBeanEntryWritingStrategy(Document document, String key, Map<String, AttributeWritingStrategy> innerStrats) {
		super(document, key, innerStrats);
	}

	/* (non-Javadoc)
	 * @see org.opendaylight.controller.config.netconf.mapping.attributes.toxml.AttributeWritingStrategy#writeElement(org.w3c.dom.Element, java.lang.Object)
	 */
	@Override
	public void writeElement(Element parentElement, String namespace, Object value) {
		...
		for (Entry<?, ?> runtimeBeanInstanceMappingEntry : map.entrySet()) {
			...
			// wrap runtime attributes with number assigned to current runtime bean
			...
			Element runtimeInstanceNode = document.createElement("_" + (String) runtimeBeanInstanceMappingEntry.getKey());

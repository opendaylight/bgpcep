...
class NetconfOperationServiceFactoryTracker extends ServiceTracker {
	...
	@Override
	public NetconfOperationServiceFactory addingService(ServiceReference reference) {
		NetconfOperationServiceFactory netconfOperationServiceFactory = (NetconfOperationServiceFactory) super.addingService(reference);
	...
	public void removedService(ServiceReference reference, Object service) {
		operationRouter.onRemoveNetconfOperationServiceFactory((NetconfOperationServiceFactory) service);
	}
}

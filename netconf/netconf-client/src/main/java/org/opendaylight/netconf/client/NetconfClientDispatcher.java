...
public class NetconfClientDispatcher extends AbstractDispatcher<NetconfClientSession, NetconfClientSessionListener> {
	...
	public Future<NetconfClientSession> createClient(InetSocketAddress address, final NetconfClientSessionListener sessionListener,
	...
	private static class ClientChannelInitializer extends ChannelInitializer {
		...
		private ClientChannelInitializer(Optional<SSLContext> maybeContext, NetconfClientSessionNegotiatorFactory negotiatorFactory,

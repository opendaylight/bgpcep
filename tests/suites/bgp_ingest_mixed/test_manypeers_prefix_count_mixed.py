...
COUNT_PREFIX_COUNT_MANY = 200_000
BGP_PEERS_COUNT = 70
INSERT = 10
WITHDRAW = 9
PREFILL = 10
...
@pytest.mark.run(order=SuiteOrder.BGP_INGEST_MIXED_MANYPEERS_PREFIX_COUNT)
    ...
    test_description = textwrap.dedent(
        """
            ...
            **TODO:** Currently, if a bug causes prefix count to remain at zero, \
            affected test cases will wait for max time. Reconsider. If zero is \
            allowed as stable, higher period or repetitions would be required. \

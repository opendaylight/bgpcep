...
class BaseTestManyPeerPrefixCount:
    ...
    def test_many_peers_prefix_count(
        ...
        bgp_peers_count,
        count_change_count_many,
        insert,
        withdraw,
        prefill,
    ):
        bgp_filling_timeout = TEST_DURATION_MULTIPLIER * (count_change_count_many * 4.0 / 10000 + 80)
        ...
        with allure_step_with_separate_logging("step_kill_talking_bgp_speakers"):
            ...
            infra.backup_file(src_file_name="play.py.out", target_file_name="manypeers_cc_play.log")
        ...
        with allure_step_with_separate_logging("step_delete_bgp_peers_configurations"):
            ...
            bgp.delete_bgp_peer_group(peer_group_name=PEER_GROUP, rib_instance=RIB_INSTANCE)

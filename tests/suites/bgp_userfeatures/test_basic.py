...
@pytest.mark.run(order=SuiteOrder.BGP_USER_BASIC)
class TestBasic:
    ...
    @allure.description(
        textwrap.dedent(
            ...
            **TC_PG** (test case peer group) tests configuration and \
            reconfiguration of peer-groups and neighbors configured by them.

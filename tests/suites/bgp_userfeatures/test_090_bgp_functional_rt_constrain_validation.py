...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpfunct/090_bgp_functional_rt_constrain_validation.robot
#
...
@pytest.mark.run(order=SuiteOrder.BGP_USER_RT_CONSTRAIN_VALIDATION)
class TestBgpfunctionalRtConstrainValidation:
    ...
    def test_bgp_functional_rt_constrain_validation(
        ...
        with allure_step_with_separate_logging("step_start_bgp_peers"):
            ...
            # time until odl really starts to accept incoming bgp connection.
            # The failure happens if the incoming connection comes too quickly

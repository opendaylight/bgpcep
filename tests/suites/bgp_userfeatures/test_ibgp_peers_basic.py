...
class TestIbgpPeersBasic:
    ...
    def connect_bgp_peer1_and_verify(self, cluster_id: str = None):
        ...
        utils.wait_until_function_pass(10, 1, prefix_counting.check_example_ipv4_topology_contains, f"'prefix': '{BGP_PEER1_FIRST_PREFIX_IP}/{PREFIX_LEN}'")
    ...
    def connect_bgp_peer2_and_verify(self, cluster_id: str = None):
        ...
        utils.wait_until_function_pass(10, 1, prefix_counting.check_example_ipv4_topology_contains, f"'prefix': '{BGP_PEER2_FIRST_PREFIX_IP}/{PREFIX_LEN}'")
    ...
    def test_ibgp_peers_basic(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_tc1_check_for_empty_ipv4_topology"):
            ...
            utils.wait_until_function_pass(10, 1, prefix_counting.check_example_ipv4_topology_does_not_contain, 'prefix')

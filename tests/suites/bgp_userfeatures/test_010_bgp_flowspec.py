...
class TestBgpFlowspec:
    ...
    def delete_bgp_peer_configuration(self):
        ...
        templated_requests.delete_templated_request("variables/bgpflowspec/bgp_peer", mapping)
    ...
    def test_bgp_flowspec(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_flowspec_test_1"):
            ...
            utils.wait_until_function_pass(15, 1, templated_requests.get_templated_request, "variables/bgpflowspec/bgp_flowspec", mapping=None, verify=True)
        ...
        with allure_step_with_separate_logging("step_flowspec_test_2"):
            ...
            utils.wait_until_function_pass(15, 1, templated_requests.get_templated_request, "variables/bgpflowspec/bgp_flowspec_redirect", mapping=None, verify=True)
            bgp.stop_exabgp(exabgp_process)
            flowspec.verify_flowspec_data_is_empty()

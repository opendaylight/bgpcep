...
class TestBgpfunctionalL3Vpn:
    ...
    def test_bgp_functional_l3vpn(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_l3vpn_ipv4_to_odl"):
            ...
            self.wait_until_expected_data("variables/bgpfunctional/l3vpn_ipv4/empty_route", 3, 2)
            exabgp_process = bgp.start_exabgp_and_verify_connected("tmp/bgp-l3vpn-ipv4.cfg", TOOLS_IP)
            self.wait_until_expected_data("variables/bgpfunctional/l3vpn_ipv4/bgp_l3vpn_ipv4", 15, 1)

...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpfunct/bgp_functional_md5.robot
#
...
class TestBgpFunctionalMd5:
    ...
    def reconfigure_odl_to_accept_connections(self, password: str):
        ...
        templated_requests.put_templated_request(BGP_PEER_FOLDER, mapping, json=False)

...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpfunct/010_bgp_functional_l3vpn.robot
#
...
HOLDTIME = 180
L3VPN_EXA_CFG = "bgp-l3vpn-ipv4-manypeers.cfg"
L3VPN_EXP = "exa_expected"
L3VPN_RSP = "bgp_l3vpn_ipv4_manypeers"
...
class TestBgpfunctionalL3Vpn:
    ...
    def prepare_config_files(self):
        ...
        controller_testlib.infra.save_text_to_a_file(f"tmp/{L3VPN_EXA_CFG}", config)

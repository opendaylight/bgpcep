...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpuser/ebgp_peers_basic.robot
#
...
@pytest.mark.run(order=SuiteOrder.BGP_USER_MANY_EBGP_PEERS)

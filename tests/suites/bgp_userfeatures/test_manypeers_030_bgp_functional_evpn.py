...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpfunct/030_bgp_functional_evpn.robot
#
...
@pytest.mark.run(order=SuiteOrder.BGP_USER_MANY_EVPN)
class TestBgpfunctionalEvpn:
    ...
    def verify_test_preconditions(self):
        ...
        volatiles_list = templated_requests.resolve_volatiles_path(
            f"{EVPN_DIR}/empty_routes"
        )
        utils.verify_jsons_match(
            expected_content,
            resp.content,
    ...
    def test_bgp_functional_evpn(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging(
            ...
            self.play_to_odl_template(
                "route_eth_lacp_extdef", peer_id=9 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging(
            ...
            self.play_to_odl_template(
                "route_eth_lacp_extesilab", peer_id=10 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging(
            ...
            self.play_to_odl_template(
                "route_eth_lacp_extesr", peer_id=11 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging("step_play_to_odl_route_eth_lacp_extl2"):
            self.play_to_odl_template(
                "route_eth_lacp_extl2", peer_id=12 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging(
            ...
            self.play_to_odl_template(
                "route_eth_lacp_extmac", peer_id=13 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging(
            ...
            self.play_to_odl_template(
                "pmsi_rsvp_te_p2mp_lsp", peer_id=29 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging("step_play_to_odl_pmsi_mldp_p2mp_lsp"):
            self.play_to_odl_template(
                "pmsi_mldp_p2mp_lsp", peer_id=30 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging("step_play_to_odl_pmsi_bidir_pim_tree"):
            self.play_to_odl_template(
                "pmsi_bidir_pim_tree", peer_id=33 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging(
            ...
            self.play_to_odl_template(
                "pmsi_ingress_replication", peer_id=34 % BGP_PEERS_COUNT
            )
        ...
        with allure_step_with_separate_logging("step_play_to_odl_pmsi_mldp_mp2mp_lsp"):
            self.play_to_odl_template(
                "pmsi_mldp_mp2mp_lsp", peer_id=35 % BGP_PEERS_COUNT
            )

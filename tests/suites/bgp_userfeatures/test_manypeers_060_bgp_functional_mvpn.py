...
MVPN_APP_PEER_MAPPING = {"IP": ODL_IP, "BGP_RIB": RIB_NAME}
...
class TestBgpfunctionalMvpn:
    ...
    def test_bgp_functional_Mvpn(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_odl_to_play_intra_as_ipmsi_ad"):
            bgp.odl_to_play_template("intra_as_ipmsi_ad", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_intra_as_ipmsi_ad"):
            bgp.play_to_odl_template("intra_as_ipmsi_ad", MVPN_DIR, peer_id=0 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_inter_as_ipmsi_ad"):
            bgp.odl_to_play_template("inter_as_ipmsi_ad", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_inter_as_ipmsi_ad"):
            bgp.play_to_odl_template("inter_as_ipmsi_ad", MVPN_DIR, peer_id=1 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_spmsi_ad"):
            bgp.odl_to_play_template("spmsi_ad", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_spmsi_ad"):
            bgp.play_to_odl_template("spmsi_ad", MVPN_DIR, peer_id=2 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_leaf_ad"):
            bgp.odl_to_play_template("leaf_ad", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_leaf_ad"):
            bgp.play_to_odl_template("leaf_ad", MVPN_DIR, peer_id=3 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_source_active_ad"):
            bgp.odl_to_play_template("source_active_ad", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_source_active_ad"):
            bgp.play_to_odl_template("source_active_ad", MVPN_DIR, peer_id=4 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_shared_tree_join"):
            bgp.odl_to_play_template("shared_tree_join", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_shared_tree_join"):
            bgp.play_to_odl_template("shared_tree_join", MVPN_DIR, peer_id=5 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_source_tree_join"):
            bgp.odl_to_play_template("source_tree_join", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_source_tree_join"):
            bgp.play_to_odl_template("source_tree_join", MVPN_DIR, peer_id=6 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging(
            "step_odl_to_play_intra_pe_distinguisher"
        ):
            bgp.odl_to_play_template("intra_pe_distinguisher", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging(
            "step_play_to_odl_intra_pe_distinguisher"
        ):
            bgp.play_to_odl_template("intra_pe_distinguisher", MVPN_DIR, peer_id=7 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_intra_vrf"):
            bgp.odl_to_play_template("intra_vrf", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_intra_vrf"):
            bgp.play_to_odl_template("intra_vrf", MVPN_DIR, peer_id=8 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_intra_source_as"):
            bgp.odl_to_play_template("intra_source_as", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_intra_source_as"):
            bgp.play_to_odl_template("intra_source_as", MVPN_DIR, peer_id=9 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_odl_to_play_intra_source_as_4"):
            bgp.odl_to_play_template("intra_source_as_4", MVPN_DIR, peers_count=BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_intra_source_as_4"):
            bgp.play_to_odl_template("intra_source_as_4", MVPN_DIR, peer_id=10 % BGP_PEERS_COUNT)

        with allure_step_with_separate_logging("step_play_to_odl_intra_ipv6"):
            bgp.play_to_odl_template("intra_ipv6", MVPN_DIR, "ipv6", peer_id=11 % BGP_PEERS_COUNT)

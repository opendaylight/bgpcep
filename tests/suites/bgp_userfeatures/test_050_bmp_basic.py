...
class TestBmpBasic:
    ...
    @allure.description(
        ...
        "for listening. To test this feature bgp-bmp-mock tool is used. It is a part of "
        "the bgpcep project. It is a java tool which simulates more peers and more routers. "
        "In this particular test suite it simulates 1 peer with 1 router, which means it "
        "advertizes one peer ipv4 address towards odl. As a result one route should "

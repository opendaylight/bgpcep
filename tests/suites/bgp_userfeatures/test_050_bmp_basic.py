...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpfunct/050_bmp_basic.robot
#
...
@pytest.mark.run(order=SuiteOrder.BGP_USER_BMP)
class TestBmpBasic:
    ...
    @allure.description(
        textwrap.dedent(
            ...
            **This is a basic test for bgp monitoring protocol feature.**
            ...
            should be bound for listening. To test this feature bgp-bmp-mock tool \
            is used. It is a part of the bgpcep project. It is a java tool which \

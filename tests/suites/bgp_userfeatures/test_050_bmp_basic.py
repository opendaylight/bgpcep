...
BGP_BMP_DIR = "variables/bgpfunctional/bmp_basic/filled_structure"
...
class TestBmpBasic:
    ...
    @allure.description(
        ...
        "\n"
        "After the feature odl-bgpcep-bmp installation, the port 12345 should be bound "
        "for listening. To test this feature bgp-bmp-mock tool is used. It is a part "
        "of the bgpcep project. It is a java tool which simulates more peers and more "
        "routers. In this particular test suite it simulates 1 peer with 1 router, "
        "which means it advertizes one peer ipv4 address towards odl. As a result "
        "one route should appear in the "

...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpuser/ibgp_peer_lsp.robot
#
...
@pytest.mark.run(order=SuiteOrder.BGP_USER_MANY_IBGP_LSP)
class TestIbgpPeerLsp:
    ...
    def test_ibgp_peer_lsp(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_tc1_connect_bgp_peer"):
            ...
            for i in range(BGP_PEERS_COUNT):
                ip = f"127.0.1.{i}"
                log_file = f"tmp/bgp_peer_{i}.log"
                ls_identifier = i + 1
        ...
        with allure_step_with_separate_logging("step_tc2_check_example_bgp_rib"):
            ...
            for i in range(BGP_PEERS_COUNT):
                ...
                utils.wait_until_function_pass(
                    ...
                    "variables/bgpuser/lsp/manypeers_effective_rib_in",
                    mapping,
                    verify=True,
                )

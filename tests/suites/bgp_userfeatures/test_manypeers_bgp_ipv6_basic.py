...
class TestBgpIpv6Basic:
    ...
    def setup_config_file(self, config_file, exabgp_ip_template, odl_ip, router_id_template):
    ...
    def setup_config_files(self):
        ...
        self.setup_config_file(
            "exaipv4", exabgp_ip_template=IPV4_IP_TEMPLATE, odl_ip=ODL_IP, router_id_template=IPV4_IP_TEMPLATE
        )
    ...
    def test_bgp_ipv6_basic(self, allure_step_with_separate_logging, step_tag_checker):
        ...
        with allure_step_with_separate_logging("step_start_exabgp"):
            """Start exabgp."""
            exabgp_ips = [self.format_ip(EXABGP_ID_TEMPLATE, i+2) for i in range(BGP_PEERS_COUNT)]
        ...
        with allure_step_with_separate_logging("step_start_exabgp_2"):
            ...
            exabgp_ips = [self.format_ip(IPV4_IP_TEMPLATE, i+2) for i in range(BGP_PEERS_COUNT)]
            self.exabgp_process = bgp.start_exabgp_and_verify_connected(

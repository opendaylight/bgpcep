...
# https://github.com/opendaylight/integration-test/blob/901c7e139945b436d95a44b3b592904c3d7a4f9f/csit/suites/bgpcep/bgpingest/bgp_app_peer_prefixcount.robot
#
...
BGP_FILLING_TIMEOUT = TEST_DURATION_MULTIPLIER * (
    TOTAL_COUNT * BGP_PEERS_COUNT / 1_000 + 40
)
...
BGP_APP_PEER_LOG_FILE = "bgp_app_peer.log"
HOLDTIME = 180
...
class TestBgpAppManyPeerPrefixCount:
    ...
    @allure.description(
        textwrap.dedent("""
            **BGP performance of ingesting many BGP peers from 1 BGP \
            application peer**
            ...
            BGP application peer are performed as well.
    ...
    def test_bgp_app_many_peers_prefix_count(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging(
            ...
            infra.backup_file(
                src_file_name=BGP_APP_PEER_LOG_FILE,
                target_file_name="bgp_app_peer_singles_many.log",
            )
        ...
        with allure_step_with_separate_logging("step_disconnect_bgp_peer"):
            ...
            infra.backup_file(
                ...
                target_file_name="bgp_peer_disconnect_many.log",
            )
        ...
        with allure_step_with_separate_logging(
            ...
            infra.backup_file(
                src_file_name=BGP_APP_PEER_LOG_FILE,
                target_file_name="bgp_app_peer_delete_all_many.log",
            )
        ...
        with allure_step_with_separate_logging("step_stop_bgp_peers"):
            ...
            infra.backup_file(
                src_file_name=BGP_PEER_LOG_FILE,
                target_file_name="bgp_peer_reconnect_many.log",
            )

...
BGP_FILLING_TIMEOUT = TEST_DURATION_MULTIPLIER * (TOTAL_COUNT * 1.0 / 100 + 20)
...
@pytest.mark.run(order=SuiteOrder.BGP_INGEST_APP_SINGLEPEER_PREFIX_COUNT)
class TestBgpAppPeerPrefixCount:
    ...
    @allure.description(
        textwrap.dedent(
            ...
            *http://docs.opendaylight.org/en/stable-boron/user-guide/\
            bgp-user-guide.html#application-peer-configuration*

...
def verify_process_did_not_stop_immediately(pid: int, retry_count: int = 10, interval: int = 1):
    ...
    Returns:
        None
     """
     verify_function_returns_concrete_value_for_some_time(retry_count, interval, True, infra.is_process_still_running, pid)

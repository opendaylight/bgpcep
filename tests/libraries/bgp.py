...
def start_gobgp(gobgp_path: str, cfg_file: str, log_file: str = "gobgp.log", grpc_address: str = ":50051") -> subprocess.Popen:
...
def start_gobgp_and_verify_connected(
    gobgp_path: str, cfg_file: str, exabgp_ips: str, log_file: str = "gobgp.log", grpc_address: str = ":50051"
) -> subprocess.Popen:
    """Starts exabgp and verifies if was successfully conncted.

...
def set_bgp_neighbour(ip: str, holdtime: int = 180, peer_port: int = 17900, rib_instance: str = "example-bgp-rib", passive_mode: bool = True) -> requests.Response:
...
def set_bgp_neighbours(first_neigbout_ip: str, count: int, holdtime: int = 180, peer_port: int = 17900, rib_instance: str = "example-bgp-rib", passive_mode: bool = True):
...
def set_bgp_peer_group_members(
    peer_group_name: str, first_neigbout_ip: str, count: int, rib_instance: str = "example-bgp-rib",
):
...
def set_bgp_application_peer(ip: str, rib_instance: str = "example-bgp-rib") -> requests.Response:
...
def set_and_verify_bgp_peer_group(
    peer_group_name: str, holdtime: int = 180, rib_instance: str = "example-bgp-rib", passive_mode: bool = True, rr_client: bool = False
):
...
def delete_bgp_neighbour(ip: str, rib_instance: str = "example-bgp-rib") -> requests.Response:
...
def delete_bgp_neighbours(first_neigbout_ip: str, count: int, rib_instance: str = "example-bgp-rib"):
...
def start_bgp_speaker_and_verify_connected(speaker_ip: str = "127.0.0.1", *args, **kwargs) -> subprocess.Popen:
    ...
    utils.wait_until_function_pass(3, 3, verify_bgp_speaker_connected, speaker_ip=speaker_ip, connected=True)

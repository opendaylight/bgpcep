...
def start_gobgp(gobgp_path: str, cfg_file: str) -> subprocess.Popen:
...
def start_gobgp_and_verify_connected(
    gobgp_path: str, cfg_file: str, gobgp_ip: str
) -> subprocess.Popen:
    """Starts exabgp and verifies if was successfully conncted.
    ...
    utils.wait_until_function_pass(
        5, 5, verify_exabgp_connection, exabgp_ip=gobgp_ip, expect_connected=True
    )

...
def start_bgp_app_peer(count=None, command="post", prefix="8.0.0.0", prefix_len=28, uri="data/bgp-rib:application-rib=10.0.0.10/tables=bgp-types%3Aipv4-address-family,bgp-types%3Aunicast-subsequent-address-family", log_level="info"):

...
class BaseSinglePeerChangeCount:
    bgp_speaker_process = None
    last_change_count_single = 1

    def test_single_peer_change_count(self, allure_step_with_separate_logging, prefixes_count, insert, withdraw, prefill):

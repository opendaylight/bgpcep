...
class TestPcepUser:
    ...
    def test_pcep_user(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("strep_start_pcc_mock"):
            ...
            self.pcep_mock_process = infra.shell(f"java -jar build_tools/pcep-pcc-mock.jar --reconnect 1 --local-address 127.0.0.1 --remote-address 127.0.0.1 2>&1 | tee {LOG_NAME}", run_in_background=True)

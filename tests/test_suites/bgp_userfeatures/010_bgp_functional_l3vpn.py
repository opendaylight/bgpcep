...
class TestBgpfunctionslL3Vpn:
    ...
    def prepare_config_files(self):
        infra.shell("cp data/bgpfunctional/exa.cfg tmp/")
        ...
        infra.shell("cp data/bgpfunctional/l3vpn_ipv4/bgp-l3vpn-ipv4.cfg tmp/")
    ...
    def test_bgp_functionsl_l3vpn(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_l3vpn_ipv4_to_odl"):
            ...
            self.wait_until_expected_data("data/bgpfunctional/l3vpn_ipv4/empty_route", 3, 2)
            exabgp_process = bgp.start_exabgp_and_verify_connected("tmp/bgp-l3vpn-ipv4.cfg", TOOLS_IP)
            self.wait_until_expected_data("data/bgpfunctional/l3vpn_ipv4/bgp_l3vpn_ipv4", 15, 1)
        ...
        with allure_step_with_separate_logging("step_start_play"):
            ...
            test case."""
            self.bgp_speaker_process = bgp.start_bgp_speaker_with_verify_and_retry(retries=3, ammount=0, my_ip=TOOLS_IP, peer_ip=ODL_IP, log_level="debug", allf=True, wfr=1)
        ...
        with allure_step_with_separate_logging("step_play_to_odl_rt_constrain_type_0"):
            ...
            recieves such route."""
            bgp.play_to_odl_non_removal_template("rt_constrain_type_0", RT_CONSTRAIN_DIR)

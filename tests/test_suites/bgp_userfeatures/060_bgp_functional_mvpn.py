...
MVPN_DIR = "data/bgpfunctional/mvpn"
...
class TestBgpfunctionalMvpn:
    ...
    def test_bgp_functional_Mvpn(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_start_bgp_peer"):
            ...
            test case."""
            self.bgp_speaker_process = bgp.start_bgp_speaker_with_verify_and_retry(retries=3, ammount=0, my_ip=TOOLS_IP, peer_ip=ODL_IP, log_level="debug", mvpn=True, wfr=1)
        ...
        with allure_step_with_separate_logging("step_odl_to_play_intra_pe_distinguisher"):
            bgp.odl_to_play_template("intra_pe_distinguisher", MVPN_DIR)

        with allure_step_with_separate_logging("step_play_to_odl_intra_pe_distinguisher"):

...
class TestBgpfunctionalRtConstrain:
    ...
    def set_app_peer(self):
        ...
        templated_requests.put_templated_request(
            f"{RT_CONSTRAIN_DIR}/app_peer", mapping, json=False
        )
    ...
    def delete_app_peer(self):
        ...
        templated_requests.delete_templated_request(
            f"{RT_CONSTRAIN_DIR}/app_peer", mapping
        )
    ...
    def test_bgp_functional_rt_constrain(self, allure_step_with_separate_logging):
        ...
        with allure_step_with_separate_logging("step_start_bgp_peer"):
            ...
            test case."""
            self.bgp_speaker_process = bgp.start_bgp_speaker_with_verify_and_retry(retries=3, ammount=0, my_ip=TOOLS_IP, peer_ip=ODL_IP, log_level="debug", rt_constrain=True, wfr=1)

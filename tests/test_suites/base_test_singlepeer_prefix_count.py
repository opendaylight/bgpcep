...
class BaseTestSinglePeerPrefixCount:
    ...
    def test_single_peer_prefix_count(
        ...
        with allure_step_with_separate_logging(
            ...
            infra.shell(
                "mv performance-bgp.csv " \
                "results/prefixcount-talking-performance-bgp.csv",
                check_rc=True,
            )
        ...
        with allure_step_with_separate_logging(
            ...
            assert (
                topology_count == 0
            ), f"Ipv4 topology is not empty as expected, there are " \
               f"{topology_count} prefixes present."
        ...
        with allure_step_with_separate_logging(
            ...
            infra.shell(
                "mv performance-bgp.csv " \
                "results/prefixcount-listening-performance-bgp.csv",
                check_rc=True,
            )

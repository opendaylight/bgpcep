...
class TestManyPeerChangeCount:
    ...
    def test_reconfigure_odl_to_accept_connection(self):
        ...
        bgp.set_bgp_peer_group_members(first_neigbout_ip=FIRST_PEER_IP, count=BGP_PEERS_COUNT, peer_group_name="internal-neighbors")
    ...
    def test_start_talking_bgp_speaker(self):
        ...
        TestManyPeerChangeCount.bgp_speaker_process = bgp.start_bgp_speaker(ammount=PREFIXES_COUNT,

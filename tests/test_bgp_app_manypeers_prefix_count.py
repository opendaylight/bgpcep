...
class TestBgpAppPeerPrefixCount:
    ...
    @pytest.mark.skip_if_fails("test_reconfigure_odl_to_accept_connections")
    def test_connect_bgp_peers(self):
        """Start BGP peer tool"""
    ...
    @pytest.mark.skip_if_fails(
        [
            "test_reconfigure_odl_to_accept_bgp_application_peer",
            "test_connect_bgp_peers",
        ]
    )
    ...
    @pytest.mark.skip_if_fails("test_connect_bgp_peers")

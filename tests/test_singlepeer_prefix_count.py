...
class TestSinglePeerPrefixCount:
    ...
    def test_store_result_for_talking_bgp_speaker(self):
        ...
        infra.shell("mv performance-bgp.csv results/prefixcount-talking-performance-bgp.csv")
    ...
    @pytest.mark.skip_if_fails(["test_reconfigure_odl_to_initiate_connection",
    ...
    def test_store_result_for_listening_bgp_speaker(self):
        ...
        infra.shell("mv performance-bgp.csv results/prefixcount-listening-performance-bgp.csv")

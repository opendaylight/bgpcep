...
class TestManyPeerPrefixCount:
    ...
    def test_start_talking_bgp_managers(self):
    ...
    @pytest.mark.skip_if_fails(
        ["test_reconfigure_odl_to_accept_connections", "test_start_talking_bgp_managers"]
    )
    ...
    @pytest.mark.skip_if_fails("test_start_talking_bgp_managers")
    def test_kill_talking_bgp_speakers(self):
        bgp.stop_bgp_speaker(self.bgp_speaker_process)

    @pytest.mark.skip_if_fails("test_kill_talking_bgp_speakers")

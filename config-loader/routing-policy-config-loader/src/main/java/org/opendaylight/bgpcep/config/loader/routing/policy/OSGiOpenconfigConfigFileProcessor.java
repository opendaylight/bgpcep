...
// FIXME: merge with OpenconfigConfigFileProcessor once we have constructor injection
public final class OSGiOpenconfigConfigFileProcessor extends AbstractOSGiConfigFileProcessor {
    ...
    @Activate
    void activate() {
        start(new OpenconfigRoutingConfigFileProcessor(configLoader, dataBroker));
    }

...
Interval of such update can by configured using the following edit (PUT) call:
...
.. note::
   ...
   * if the duration of update take take longer than ``timer`` value - in this case new update is scheduled after

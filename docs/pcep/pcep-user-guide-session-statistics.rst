...
.. note::
   Setting the timer doesn't mean stats will update exactly at when interval expires. There may be a slight delay
   between the timer ending and the data refreshing.

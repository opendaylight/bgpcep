...

    {
        ...
        "loc-rib":
        {
            "tables":
            {
                ...
                "safi": "x:unicast-subsequent-address",
                "ipv4-routes": null,
                "attributes":
                {
                    "uptodate": "true"
...
@line 7: Loc-RIB - Per-protocol instance RIB, which contains the routes that have been selected by local BGP speaker's decision process.

@line 8: The BGP-4 supports carrying IPv4 prefixes, such routes are stored in *ipv4-address-family*/*unicast-subsequent-address-family* table.

...
class InetSocketAddressUtilTest {
    ...
    @Test
    void parseAddressesDefaultPort() throws Exception {
    ...
    @Test
    void parseAddressesWithoutPort() throws Exception {
    ...
    @Test
    void getInetSocketAddress() throws Exception {
    ...
    @Test
    void getRandomLoopbackInetSocketAddressTest() throws Exception {

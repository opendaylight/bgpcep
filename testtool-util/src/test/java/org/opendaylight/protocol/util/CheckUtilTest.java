...
public class CheckUtilTest extends AbstractConcurrentDataBrokerTest {
    ...
    public void testWaitFutureSuccess() {
        ...
        doAnswer(invocation -> {
            invocation.getArgument(0, GenericFutureListener.class).operationComplete(CheckUtilTest.this.future);
    ...
    public void testCheckReceivedMessagesNotEqual() {
        ...
        assertThrows(AssertionError.class, () -> checkReceivedMessages(this.listenerCheck, 1, TIMEOUT));
    }

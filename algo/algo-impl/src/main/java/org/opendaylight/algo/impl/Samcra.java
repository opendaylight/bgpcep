...
public class Samcra extends AbstractPathComputation {
    ...
    public ConstrainedPath computeP2pPath(VertexKey src, VertexKey dst, PathConstraints cts) {
        ...
        cpathBuilder.setBandwitdh(cts.getBandwitdh()).setClassType(cts.getClassType());
    ...
    private float relaxSamcra(ConnectedEdge edge, CspfPath currentPath, CspfPath source) {
        ...
        if (currentSamcraPath == null) {
            ...
            while (it.hasNext()) {
                CspfPath testedPath = it.next();
                if (testedPath.getPathStatus() == CspfPath.SELECTED) {
                    pathListIndex = pathList.indexOf(testedPath);
                    testedPath.setPathStatus(CspfPath.ACTIVE);
                    pathList.set(pathListIndex, testedPath);
                }
            }
    ...
    /**
     * Evaluate if Samcra Path is dominated or not once adding the new segment.
     *
    ...
    private boolean isPathDominated(SamcraPath samcraPath) {
        ...
        while ((it.hasNext()) && !(pathDominated)) {
            ...
            if (testedPath.getPathStatus() != CspfPath.DOMINATED) {
                ...
                if ((((metric != null) && (pathCostDominated)) && (((delay != null) && (pathDelayDominated))
                        || (delay == null))) || ((metric == null) && ((delay != null) && (pathDelayDominated)))) {
                    pathDominated = true;
                    LOG.debug("New path is dominated with teCost: {} delayCost: {}", teCost, delayCost);
                } else if ((((metric != null) && (testedPathCostDominated))
                        && (((delay != null) && (testedPathDelayDominated)) || (delay == null)))
                        || ((metric == null) && ((delay != null) && (testedPathDelayDominated)))) {
    ...
    private CspfPath createNonDominatedPath(ConnectedEdge edge, ConnectedVertex vertex, CspfPath cspfPath) {
        ...
        /* Compute TE, Delay and Path length as well as path Weight */
        float teLength = 0.0F;

...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.message.rev171122.UpdateMessage;
...
final class BmpRibInWriter {
    ...
    public void onMessage(final UpdateMessage message) {
        ...
        if (!checkEndOfRib(message)) {
            final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.message.rev171122.path.attributes.Attributes attrs = message.getAttributes();
    ...
    private synchronized void addRoutes(final MpReachNlri nlri, final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang
        .bgp.message.rev171122.path.attributes.Attributes attributes) {

...
public class TopologyDataChangeCounterTest extends AbstractConcurrentDataBrokerTest {
    ...
    private final DataObjectIdentifier<Counter> counterIId1 = DataObjectIdentifier.builder(DataChangeCounter.class)
            .child(Counter.class, new CounterKey(COUNTER_ID1))
            .build();
    private final DataObjectIdentifier<Counter> counterIId2 = DataObjectIdentifier.builder(DataChangeCounter.class)
            .child(Counter.class, new CounterKey(COUNTER_ID2))
            .build();
    ...
    public void testDataChangeCounter() throws Exception {
        ...
        readDataOperational(getDataBroker(), counterIId1, count -> {
        ...
        counter.close();
        checkNotPresentOperational(getDataBroker(), counterIId1);
    }
    ...
    public void testDataChangeCounterTwoInstances() throws Exception {
        ...
        readDataOperational(getDataBroker(), counterIId2, count -> {
            assertEquals(0, count.getCount().longValue());
            return count;
        });
        ...
        checkPresentOperational(getDataBroker(), counterIId2);

        counter2.close();
        checkNotPresentOperational(getDataBroker(), counterIId2);
    }
}

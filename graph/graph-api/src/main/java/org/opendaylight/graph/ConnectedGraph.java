 ...
 * Graph (see graph theory). So, Edge and Connected Edge are unidirectional, thus to connect bidirectionally 2 vertices
...
public interface ConnectedGraph {
     ...
     */
    ArrayList<ConnectedVertex> getVertices();
     ...
     */
    ArrayList<ConnectedEdge> getEdges();

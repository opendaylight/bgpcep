...
/*
 * Connected Graph Provider is a new service provided by the Graph feature to manage the Connected Graph. It allows
 * to get, create, add and delete Connected Graph. All associated Graph are automatically stored in the DataStore.
 *
...
public interface ConnectedGraphProvider {
    ...
    /**
     * Get all registered Connected Graphs.
     *
     * @return List of Connected Graph
     */
    ArrayList<ConnectedGraph> getConnectedGraphs();
     ...
     *
     * @param name Name of the Graph
     * @param type Type of Graph (Intra or Inter domain)
     *
     * @return Connected Graph
     */
    ConnectedGraph createConnectedGraph(String name, GraphType type);

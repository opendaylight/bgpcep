...
public interface ConnectedVertex {
     ...
     * @return List of Connected Edge
     */
    List<ConnectedEdge> getInputEdges(BigDecimal minimumBandwidth, int classType);
     ...
     * @return List of Connected Edge
     */
    List<ConnectedEdge> getOutputEdges(BigDecimal minimumBandwidth, int classType);
     ...
     * @return List of Connected Edge
     */
    List<ConnectedEdge> getOutputEdges(BigDecimal minimumBandwidth, int classType, Delay delay, Uint32 teMetric);

...
public class ConnectedVertexImpl implements ConnectedVertex {
    ...
    @Override
    public List<ConnectedEdge> getInputEdges(long minBw, int pri) {
    ...
    @Override
    public List<ConnectedEdge> getOutputEdges(long minBw, int pri) {
        ArrayList<ConnectedEdge> liste = new ArrayList<ConnectedEdge>();
        if (pri < 0 || pri > 7) {
            return liste;
        }
    ...
    @Override
    public List<ConnectedEdge> getOutputEdges(long minBw, int pri, int delay, int te) {
        ArrayList<ConnectedEdge> liste = new ArrayList<ConnectedEdge>();
        if (pri < 0 || pri > 7) {
            return liste;
        }

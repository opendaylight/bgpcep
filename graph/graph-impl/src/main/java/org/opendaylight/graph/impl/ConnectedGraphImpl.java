...
public class ConnectedGraphImpl implements ConnectedGraph {
     ...
     */
    private ConnectedVertexImpl updateConnectedVertex(long key) {
        ConnectedVertexImpl vertex = null;
        if (key == 0) {
            return vertex;
        }
     ...
     */
    private ConnectedEdgeImpl updateConnectedEdge(long key) {
        ConnectedEdgeImpl edge = null;
        if (key == 0) {
            return edge;
        }
        edge = edges.get(key);
    ...
    @Override
    public ArrayList<ConnectedVertex> getVertices() {
    ...
    public ConnectedVertex getConnectedVertex(IpAddress address) {
        ...
        if (address.getIpv4Address() != null) {
            prefix = new IpPrefix(new Ipv4Prefix(address.getIpv4Address() + "/32"));
        }
        if (address.getIpv6Address() != null) {
            prefix = new IpPrefix(new Ipv6Prefix(address.getIpv6Address() + "/128"));
        }
    ...
    @Override
    public ArrayList<ConnectedEdge> getEdges() {
    ...
    public void deleteVertex(VertexKey key) {
        Preconditions.checkArgument(key != null, "Provided Vertex Key is a null object");
    ...
    public void deleteEdge(EdgeKey key) {
        Preconditions.checkArgument(key != null, "Provided Edge Key is a null object");
    ...
    public void deletePrefix(IpPrefix ippfx) {
        Preconditions.checkArgument(ippfx != null, "Provided Prefix is a null object");

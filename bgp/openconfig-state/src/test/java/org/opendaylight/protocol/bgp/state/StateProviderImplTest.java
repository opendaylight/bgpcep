...
public class StateProviderImplTest extends AbstractDataBrokerTest {
    ...
    private List<BGPPeerState> bgpPeerStates = new ArrayList<>();
    private List<BGPRIBState> bgpRibStates = new ArrayList<>();
    ...
    public void setUp() throws Exception {
        ...
        }).when(this.bgpRibState).getPrefixesCount(eq(this.TABLES_KEY));
        ...
        doReturn(1L).when(this.bgpSessionState).getNotificationMessagesReceivedCount();
        doReturn(1L).when(this.bgpSessionState).getNotificationMessagesSentCount();
        doReturn(1L).when(this.bgpSessionState).getUpdateMessagesReceivedCount();
        doReturn(1L).when(this.bgpSessionState).getUpdateMessagesSentCount();
    ...
    public void testStateProvider() throws Exception {
        ...
        final Neighbor neighborExpected = buildNeighborExpected();
    ...
    Neighbor buildNeighborExpected() {
        ...
        final org.opendaylight.yang.gen.v1.http.openconfig.net.yang.bgp.rev151009.bgp.neighbor.group.State state =
            new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.bgp.rev151009.bgp.neighbor.group.StateBuilder()
                .setSendCommunity(CommunityType.NONE)
                .setRouteFlapDamping(false)
        ...
        return new NeighborBuilder()
            .setNeighborAddress(this.neighborAddress)

...
public class StateProviderImplTest extends ConstantSchemaAbstractDataBrokerTest {
    ...
    public void setUp() {
        ...
        doReturn(true).when(this.bgpGracelfulRestartState).isLlGracefulRestartAdvertised(any());
        doReturn(true).when(this.bgpGracelfulRestartState).isLlGracefulRestartReceived(any());
        doReturn(60).when(this.bgpGracelfulRestartState).getLlGracefulRestartTimer(any());

...
public final class OSGiBGPTableTypeRegistryConsumer implements BGPTableTypeRegistryConsumer {
    ...
    @Override
    public Optional<BgpTableType> getTableType(final Class<? extends AfiSafiType> afiSafiType) {
    ...
    @Override
    public Optional<Class<? extends AfiSafiType>> getAfiSafiType(final BgpTableType bgpTableType) {

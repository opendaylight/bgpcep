...
public final class SimpleParameterRegistry implements ParameterRegistry {
	...
	private final HandlerRegistry<DataObject, ParameterParser, ParameterSerializer> handlers = new HandlerRegistry<>();
	...
	public byte[] serializeParameter(final BgpParameters parameter) {
		final ParameterSerializer serializer = handlers.getSerializer(parameter);
		if (serializer == null) {
			return null;
		}

...
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROAsNumberSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROIpv4PrefixSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROIpv6PrefixSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROLabelSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROPathKey128SubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROPathKey32SubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROUnnumberedInterfaceSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.SEROProtectionSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.Label.GeneralizedLabelParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.Label.Type1LabelParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.Label.WavebandSwitchingLabelParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.RROIpv4PrefixSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.RROIpv6PrefixSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.RROLabelSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.RROPathKey128SubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.RROPathKey32SubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.RROUnnumberedInterfaceSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.RRO.SRROProtectionSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROAsNumberSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROIpv4PrefixSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROIpv6PrefixSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROPathKey128SubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROPathKey32SubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROSRLGSubobjectParser;
import org.opendaylight.protocol.bgp.parser.impl.subobject.XRO.XROUnnumberedInterfaceSubobjectParser;
import org.opendaylight.protocol.bgp.parser.spi.AbstractBGPExtensionProviderActivator;
import org.opendaylight.protocol.bgp.parser.spi.BGPExtensionProviderContext;
import org.opendaylight.protocol.bgp.parser.spi.LabelRegistry;
...
public class BGPRsvpActivator extends AbstractBGPExtensionProviderActivator {
    @Override
    ...
    private void registerRSVPTEParsers(final BGPExtensionProviderContext context) {
        ...
        context.registerRsvpObjectSerializer(DetourObject.class, DetourObjectType7Parser.CTYPE, detourC7);
        ...
        context.registerRsvpObjectSerializer(DetourObject.class, DetourObjectType8Parser.CTYPE, detourC8);
        ...
        context.registerRsvpObjectSerializer(DetourObject.class, FastRerouteObjectType1Parser.CTYPE, fastC1);
        ...
        context.registerRsvpObjectSerializer(DetourObject.class, FastRerouteObjectType7Parser.CTYPE, fastC7);
        ...
        context.registerRsvpObjectSerializer(TspecObject.class, SenderTspecObjectParser.CTYPE, tSpec);
        ...
        context.registerRsvpObjectSerializer(FlowSpecObject.class, FlowSpecObjectParser.CTYPE, fSpec);
        ...
        context.registerRsvpObjectSerializer(SessionAttributeObject.class, SessionAttributeObjectType7Parser.CTYPE, sAttributeC7);
        ...
        context.registerRsvpObjectSerializer(SessionAttributeObject.class, SessionAttributeObjectType1Parser.CTYPE, sAttributeC1);
        ...
        context.registerRsvpObjectSerializer(RecordRouteObject.class, RecordRouteObjectParser.CTYPE, rroParser);
        ...
        context.registerRsvpObjectSerializer(ExcludeRouteObject.class, ExcludeRouteObjectParser.CTYPE, xroParser);
        ...
        context.registerRsvpObjectSerializer(ExplicitRouteObject.class, ExplicitRouteObjectParser.CTYPE, eroParser);

        final AssociationObjectParserType1 ipv4AsoParser = new AssociationObjectParserType1();
        context.registerRsvpObjectParser(AssociationObjectParserType1.CLASS_NUM, AssociationObjectParserType1.CTYPE, ipv4AsoParser);
        context.registerRsvpObjectSerializer(AssociationObject.class, AssociationObjectParserType1.CTYPE, ipv4AsoParser);

        final AssociationObjectParserType2 ipv6AsoParser = new AssociationObjectParserType2();
        context.registerRsvpObjectParser(AssociationObjectParserType2.CLASS_NUM, AssociationObjectParserType2.CTYPE, ipv6AsoParser);
        context.registerRsvpObjectSerializer(AssociationObject.class, AssociationObjectParserType2.CTYPE, ipv6AsoParser);
        ...
        context.registerRsvpObjectSerializer(AdminStatusObject.class, AdminStatusObjectParser.CTYPE, admParser);
        ...
        context.registerRsvpObjectSerializer(BandwidthObject.class, BandwidthObjectType1Parser.CTYPE,
            bandT1Parser);

        final BandwidthObjectType1Parser bandT2Parser = new BandwidthObjectType1Parser();
        context.registerRsvpObjectParser(BandwidthObjectType1Parser.CLASS_NUM, BandwidthObjectType2Parser.CTYPE, bandT2Parser);
        context.registerRsvpObjectSerializer(BandwidthObject.class, BandwidthObjectType2Parser.CTYPE, bandT2Parser);
        ...
        context.registerRsvpObjectSerializer(MetricObject.class, MetricObjectParser.CTYPE, metricParser);
        ...
        context.registerRsvpObjectSerializer(PrimaryPathRouteObject.class, PrimaryPathRouteObjectParser.CTYPE, primatyParser);
        ...
        context.registerRsvpObjectSerializer(LspAttributesObject.class, AttributesObjectParser.CTYPE, lspAttributeParser);
        ...
        context.registerRsvpObjectSerializer(LspRequiredAttributesObject.class, RequiredAttributesObjectParser.CTYPE,
            lspRequiredAttParser);
        ...
        context.registerRsvpObjectSerializer(ProtectionObject.class, ProtectionObjectType1Parser.CTYPE, protectionType1Parser);
        ...
        context.registerRsvpObjectSerializer(ProtectionObject.class, ProtectionObjectType2Parser.CTYPE, protectionType2Parser);
        ...
        context.registerRsvpObjectSerializer(SecondaryExplicitRouteObject.class, SecondaryExplicitRouteObjectParser.CTYPE, serTypeParser);
        ...
        context.registerRsvpObjectSerializer(SecondaryRecordRouteObject.class, SecondaryRecordRouteObjectParser.CTYPE, srroTypeParser);
    }

    private void registerLabelParsers(final List<AutoCloseable> regs, final BGPExtensionProviderContext context) {
    ...
    private void registerRROParsers(final List<AutoCloseable> regs, final BGPExtensionProviderContext context, final LabelRegistry labelReg) {
        ...
        final SRROProtectionSubobjectParser ssroParser = new SRROProtectionSubobjectParser();
        regs.add(context.registerRROSubobjectParser(SRROProtectionSubobjectParser.TYPE, ssroParser));
        regs.add(context.registerRROSubobjectSerializer(
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.record.route.subobjects
                .subobject.type.ProtectionCase.class, ssroParser));
    }

    private void registerXROParsers(final List<AutoCloseable> regs, final BGPExtensionProviderContext context) {
    ...
    private void registerEROParsers(final List<AutoCloseable> regs, final BGPExtensionProviderContext context, final LabelRegistry labelReg) {
        ...
        final SEROProtectionSubobjectParser seroParser = new SEROProtectionSubobjectParser();
        regs.add(context.registerEROSubobjectParser(SEROProtectionSubobjectParser.TYPE, seroParser));
        regs.add(context.registerEROSubobjectSerializer(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.explicit.route.subobjects.subobject.type.ProtectionCase.class, seroParser));
    }
}

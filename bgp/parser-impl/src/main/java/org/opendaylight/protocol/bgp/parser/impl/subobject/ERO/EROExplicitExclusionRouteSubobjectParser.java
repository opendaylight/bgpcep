...
public class EROExplicitExclusionRouteSubobjectParser implements EROSubobjectParser, EROSubobjectSerializer {
    ...
    public SubobjectContainer parseSubobject(final ByteBuf buffer, final boolean loose) throws BGPParsingException {
        ...
        final List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainer> list = parseSubobject(buffer);
        ...
        for (final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainer s : list) {
            final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.explicit.route
                .subobjects.subobject.type.exrs._case.exrs.ExrsBuilder b = new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.explicit.route
    ...
    public void serializeSubobject(final SubobjectContainer subobject, final ByteBuf buffer) {
        ...
        final List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route
        ...
        for (final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.explicit.route.subobjects.subobject.type.exrs._case.exrs.Exrs ex : e.getExrs()) {
            final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainerBuilder b = new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainerBuilder();
    ...
    private List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainer> parseSubobject(
        final ByteBuf buffer) throws BGPParsingException {
        Preconditions.checkArgument(buffer != null && buffer.isReadable(), "Array of bytes is mandatory. Can't be null or empty.");
        final List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainer> subs = new ArrayList<>();
        while (buffer.isReadable()) {
            ...
            if (length > buffer.readableBytes()) {
                throw new BGPParsingException("Wrong length specified. Passed: " + length + "; Expected: <= "
    ...
    private void serializeSubobject(
        final List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainer> subobjects, final ByteBuf body) {
        for (final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.exclude.route.object.exclude.route.object.SubobjectContainer subobject : subobjects) {

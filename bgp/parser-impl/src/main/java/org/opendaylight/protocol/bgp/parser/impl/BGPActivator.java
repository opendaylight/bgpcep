...
public final class BGPActivator extends AbstractBGPExtensionProviderActivator {
    ...
    private void registerCapabilityParsers(final List<AutoCloseable> regs, final BGPExtensionProviderContext context) {
        ...
        final MultiProtocolCapabilityHandler multiProtocolCapSerializer = new MultiProtocolCapabilityHandler(afiReg, safiReg);
        ...
        final As4CapabilityHandler as4capSerializer = new As4CapabilityHandler();
        ...
        final GracefulCapabilityHandler gracefulCapabilitySerializer = new GracefulCapabilityHandler(afiReg, safiReg);

...
public final class RouteTargetIpv4EcHandler extends AbstractIpv4ExtendedCommunity {
    ...
    public void serializeExtendedCommunity(final ExtendedCommunity extendedCommunity, final ByteBuf byteAggregator) {
        ...
        ByteBufWriteUtil.writeIpv4Address(routeTarget.getAdministrator(), byteAggregator);
        ByteBufWriteUtil.writeUnsignedShort(routeTarget.getAssignedNumber(), byteAggregator);
    }

    @Override
    public ExtendedCommunity parseExtendedCommunity(final ByteBuf buffer) throws BGPDocumentedException, BGPParsingException {
        final RouteTargetIpv4 routeTarget = new RouteTargetIpv4Builder()
            .setAdministrator(Ipv4Util.addressForByteBuf(buffer))
            .setAssignedNumber(buffer.readUnsignedShort())
            .build();

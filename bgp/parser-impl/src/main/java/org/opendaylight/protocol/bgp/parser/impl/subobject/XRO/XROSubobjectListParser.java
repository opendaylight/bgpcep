...
public abstract class XROSubobjectListParser extends AbstractBGPObjectParser {
    ...
    public List<SubobjectContainer> parseList(final ByteBuf byteBuf) throws BGPParsingException {
        ...
        while (byteBuf.isReadable()) {
            ...
            if (length > byteBuf.readableBytes()) {
                throw new BGPParsingException("Wrong length specified. Passed: " + length + "; Expected: <= " + byteBuf.readableBytes());
            }

...
public abstract class AbstractBGPObjectParser implements RsvpTeObjectParser, RsvpTeObjectSerializer {
    ...
    @VisibleForTesting
    @Override
    public RsvpTeObject parseObject(final ByteBuf byteBuf) throws BGPParsingException {
        if (byteBuf == null) {
            return null;
        }
    ...
    protected abstract RsvpTeObject localParseObject(final ByteBuf byteBuf) throws BGPParsingException;
}

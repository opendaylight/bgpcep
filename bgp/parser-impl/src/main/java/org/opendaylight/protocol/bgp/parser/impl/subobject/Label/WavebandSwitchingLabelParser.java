...
package org.opendaylight.protocol.bgp.parser.impl.subobject.Label;
...
public class WavebandSwitchingLabelParser implements LabelParser, LabelSerializer {
    ...
    @Override
    public LabelType parseLabel(final ByteBuf buffer) throws BGPParsingException {
    ...
    public void serializeLabel(final boolean unidirectional, final boolean global, final LabelType subobject, final ByteBuf buffer) {
        ...
        org.opendaylight.protocol.pcep.spi.LabelUtil.formatLabel(CTYPE, unidirectional, global, body, buffer);
    }
}

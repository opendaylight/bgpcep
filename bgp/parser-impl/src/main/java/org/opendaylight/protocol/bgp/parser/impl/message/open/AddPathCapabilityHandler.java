...
public class AddPathCapabilityHandler implements CapabilityParser, CapabilitySerializer {
    ...
    public CParameters parseCapability(final ByteBuf buffer) throws BGPDocumentedException, BGPParsingException {
        final List<AddressFamilies> families = new ArrayList<AddressFamilies>();
        while (buffer.isReadable()) {
            ...
            families.add(new AddressFamiliesBuilder().setAfi(afi).setSafi(safi).setSendReceive(SendReceive.forValue(sendReceive)).build());
        }

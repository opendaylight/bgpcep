...
package org.opendaylight.protocol.bgp.parser.impl.subobject.RRO;
...
import org.opendaylight.protocol.bgp.parser.impl.TE.AbstractBGPObjectParser;
import org.opendaylight.protocol.bgp.parser.spi.RROSubobjectRegistry;
...
public abstract class RROSubobjectListParser extends AbstractBGPObjectParser {
    ...
    public List<SubobjectContainer> parseList(final ByteBuf buffer) throws BGPParsingException {

...
public final class ExtendedCommunitiesAttributeParser extends AbstractAttributeParser implements AttributeSerializer {
    ...
    public void parseAttribute(final ByteBuf buffer, final AttributesBuilder builder,
        ...
        if (readable % 8 != 0) {
            throw errorHandling.throwError(new BGPTreatAsWithdrawException(BGPError.ATTR_LENGTH_ERROR,
        ...
        while (buffer.isReadable()) {
            ...
            try {
                ...
                throw errorHandling.throwError(new BGPTreatAsWithdrawException(BGPError.MALFORMED_ATTR_LIST, e,
                    "Failed to parse extended community"));
            }
            if (exComm != null) {
                set.add(exComm);
            }

...
public final class MessageRegistryImpl implements MessageRegistry {
	...
	private final Map<Integer, MessageParser> parsers = new HashMap<>();
	private final Map<Class<? extends Notification>, MessageSerializer> serializers = new HashMap<>();
	...
	@Override
	public synchronized MessageSerializer getMessageSerializer(final Notification message) {

...
public final class AsPathAttributeParser extends AbstractAttributeParser implements AttributeSerializer {
    ...
    /*
     * Representation of one AS Path Segment. It is, in fact, a TLV, but the length field is representing the count of
     * A Numbers in the collection (in its value). If the segment is of type AS_SEQUENCE, the collection is a List, if

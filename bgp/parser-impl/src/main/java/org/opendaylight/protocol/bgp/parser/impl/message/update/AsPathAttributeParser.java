    ...
    private static AsPath parseAsPath(final ReferenceCache refCache, final ByteBuf buffer) throws BGPDocumentedException, BGPParsingException {
        ...
        while (buffer.isReadable()) {
            ...
            if (segmentType == SegmentType.AS_SEQUENCE) {
                final List<AsNumber> asSequenceList = AsPathSegmentParser.parseAsSequenceToAsNumberList(refCache, count, buffer.readSlice(count * AsPathSegmentParser.AS_NUMBER_LENGTH));

...
public class RROLabelSubobjectParser implements RROSubobjectParser, RROSubobjectSerializer {
    ...
    @Override
    public SubobjectContainer parseSubobject(final ByteBuf buffer) throws BGPParsingException {
        ...
        if (labelType == null) {
            throw new BGPParsingException("Unknown C-TYPE for ero label subobject. Passed: " + cType);
        }
    ...
    public void serializeSubobject(final SubobjectContainer subobject, final ByteBuf buffer) {
        ...
        org.opendaylight.protocol.pcep.spi.RROSubobjectUtil.formatSubobject(TYPE, body, buffer);
    }
}

...
public class RouteRefreshCapabilityHandler implements CapabilityParser, CapabilitySerializer {
    ...
    private static final CParameters1 RR_CAP = new CParameters1Builder().setRouteRefreshCapability(new RouteRefreshCapabilityBuilder().build()).build();
    ...
    public CParameters parseCapability(final ByteBuf buffer) throws BGPDocumentedException, BGPParsingException {
        return new CParametersBuilder().addAugmentation(CParameters1.class, RR_CAP).build();
    }

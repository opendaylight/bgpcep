...
public class Ipv4NlriParserTest {
    ...
    public void serializeAttributeTest() throws UnsupportedEncodingException {
        ...
        assertFalse(arraysAreSame(this.inputBytes.array(), outputBytes.array()));
    }
    ...
    public void parseUnreachedNlriTest() {
        ...
        assertNotNull("Withdraw routes, destination type should not be null", b.getWithdrawnRoutes().getDestinationType());
    ...
    private boolean arraysAreSame(final byte[] a, final byte[] b) {
        if (a == null || b == null) {
            return false;
        }

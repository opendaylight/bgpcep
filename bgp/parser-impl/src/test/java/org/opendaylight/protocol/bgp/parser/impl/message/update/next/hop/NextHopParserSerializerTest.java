...
public class NextHopParserSerializerTest {
    ...
    public void testSerializeIpv6LinkNextHopCase() throws BGPParsingException {
        ...
        // Ipv6NextHopCase with link local has been deprecated until it is removed, we parse Link local
        assertArrayEquals(ipv6lB, ByteArray.readAllBytes(buffer));

        final CNextHop parsedHop = ipv6NextHopParserSerializer.parseNextHop(Unpooled.wrappedBuffer(ipv6B));
        ...
        // Ipv6NextHopCase with link local has been deprecated therefore is not parsed

...
import org.opendaylight.protocol.bgp.parser.impl.subobject.ERO.EROExplicitExclusionRouteSubobjectParser;
...
public class EROSubobjectParserTest {
    ...
    private SimpleBGPExtensionProviderContext ctx;
    private BGPRsvpActivator act;

    @Before
    public void setUp() {
        this.ctx = new SimpleBGPExtensionProviderContext();
        this.act = new BGPRsvpActivator();
        this.act.start(this.ctx);
    }

    @Test
    public void testEROIp4PrefixSubobject() throws BGPParsingException {
    ...
    @Test
    public void testEROIp6PrefixSubobject() throws BGPParsingException {
    ...
    @Test
    public void testEROAsNumberSubobject() throws BGPParsingException {
    ...
    @Test
    public void testEROUnnumberedSubobject() throws BGPParsingException {
    ...
    @Test
    public void testEROPathKey32Subobject() throws BGPParsingException {
    ...
    @Test
    public void testEROPathKey128Subobject() throws BGPParsingException {

...
public class NextHopAttributeParserTest {
    ...
    public void testParseEmptyIpv4Attribute() {
        final String message = assertThrows(NullPointerException.class,
            ...
            .getMessage();
        assertEquals("""
            Cannot invoke "org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.types.rev200120.next.hop
            .c.next.hop.ipv4.next.hop._case.Ipv4NextHop.getGlobal()" because the return value of "org.opendaylight.yang
            .gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.types.rev200120.next.hop .c.next.hop.Ipv4NextHopCase
    ...
    public void testParseEmptyIpv6Attribute() {
        ...
        assertEquals("""
            Cannot invoke "org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.types.rev200120.next.hop
            .c.next.hop.ipv6.next.hop._case.Ipv6NextHop.getGlobal()" because "nextHop" is null""", message);
    }
}

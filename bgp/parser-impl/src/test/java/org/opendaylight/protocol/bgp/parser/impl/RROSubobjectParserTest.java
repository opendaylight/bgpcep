...
public class RROSubobjectParserTest {
    ...
    @Test
    public void testRROIp4PrefixSubobject() throws BGPParsingException {
    ...
    @Test
    public void testRROIp6PrefixSubobject() throws BGPParsingException {
    ...
    @Test
    public void testRROUnnumberedSubobject() throws BGPParsingException {
    ...
    @Test
    public void testRROPathKey32Subobject() throws BGPParsingException {
    ...
    @Test
    public void testRROPathKey128Subobject() throws BGPParsingException {
    ...
    public void testRROLabelSubobject() throws Exception {
        final SimpleBGPExtensionProviderContext ctx = new SimpleBGPExtensionProviderContext();
        try (BGPRsvpActivator a = new BGPRsvpActivator()) {
            a.start(ctx);

...
public class GracefulCapabilityHandlerTest {
    ...
    public void testGracefulCapabilityHandler() throws BGPDocumentedException, BGPParsingException {
        final GracefulCapabilityHandler handlerSerializer = new GracefulCapabilityHandler(
    ...
    public void testUnhandledAfi() {
        final GracefulCapabilityHandler handlerSerializer = new GracefulCapabilityHandler(this.ctx.getAddressFamilyRegistry(),

...
public class AddPathCapabilityHandlerTest {
    private final static Class<Ipv6AddressFamily> AFI = Ipv6AddressFamily.class;
    private final static Class<UnicastSubsequentAddressFamily> SAFI = UnicastSubsequentAddressFamily.class;

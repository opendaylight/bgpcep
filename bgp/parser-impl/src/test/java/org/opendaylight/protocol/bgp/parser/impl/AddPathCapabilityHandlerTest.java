...
class AddPathCapabilityHandlerTest {
    ...
    void testAfiException() {
        ...
        assertThrows(BGPParsingException.class, () -> handler.parseCapability(bytes));
    }

    @Test
    void testSafiException() {
        doReturn(AddPathCapabilityHandlerTest.AFI).when(this.afiRegistry).classForFamily(260);
    ...
    @Test
    void testSendReceiveIgnored() throws BGPDocumentedException, BGPParsingException {
        doReturn(AddPathCapabilityHandlerTest.AFI).when(this.afiRegistry).classForFamily(260);
        doReturn(AddPathCapabilityHandlerTest.SAFI).when(this.safiRegistry).classForFamily(4);

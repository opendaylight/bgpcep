...
public class VpnIpv6NlriParserTest {
    ...
    public void testMpReachNlri() throws BGPParsingException {
        ...
        mpBuilder.setAdvertizedRoutes(new AdvertizedRoutesBuilder().setDestinationType(
            new DestinationVpnIpv6CaseBuilder().setVpnDestination(Lists.newArrayList(VPN)).build()).build()).build();
    ...
    public void testMpUnreachNlri() throws BGPParsingException {
        ...
        mpBuilder.setWithdrawnRoutes(new WithdrawnRoutesBuilder().setDestinationType(
            new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.vpn.ipv6.rev160331.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.DestinationVpnIpv6CaseBuilder().setVpnDestination(Lists.newArrayList(VPN)).build()).build()).build();

...
public class L3vpnMcastIpv6RIBSupportTest extends AbstractRIBSupportTest<L3vpnMcastRoute> {
    ...
    private static final L3vpnMcastRouteKey ROUTE_KEY
            = new L3vpnMcastRouteKey(PATH_ID, "AAEBAgMEAQIgAQ24AAEAAQAAAAAAAAAAQA==");

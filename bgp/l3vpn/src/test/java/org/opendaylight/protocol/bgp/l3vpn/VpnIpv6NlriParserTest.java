...
public class VpnIpv6NlriParserTest {
    ...
    private static final IpPrefix IPv6_PREFIX = new IpPrefix(new Ipv6Prefix("2001::1234:5678:90ab:cdef/64"));
    ...
    private static final VpnIpv6Destination VPN = new VpnIpv6DestinationBuilder().setRouteDistinguisher(DISTINGUISHER).setPrefix(IPv6_PREFIX).setLabelStack(LABEL_STACK).build();
    ...
    public void testMpReachNlri() throws BGPParsingException {
        ...
        mpBuilder.setAdvertizedRoutes(new AdvertizedRoutesBuilder().setDestinationType(
            new DestinationVpnIpv6CaseBuilder().setDestinationVpnIpv6(
                new DestinationVpnIpv6Builder().setVpnIpv6Destination(Lists.newArrayList(VPN)).build()).build()).build());
    ...
    public void testMpUnreachNlri() throws BGPParsingException {
        ...
        mpBuilder.setWithdrawnRoutes(new WithdrawnRoutesBuilder().setDestinationType(
            new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.vpn.ipv6.rev160331.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.DestinationVpnIpv6CaseBuilder().setDestinationVpnIpv6(
                new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.vpn.ipv6.rev160331.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.destination.vpn.ipv6._case.DestinationVpnIpv6Builder().setVpnIpv6Destination(Lists.newArrayList(VPN)).build()).build()).build());

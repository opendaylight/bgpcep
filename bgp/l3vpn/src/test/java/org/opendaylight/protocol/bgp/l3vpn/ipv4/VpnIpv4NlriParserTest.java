...
public class VpnIpv4NlriParserTest {
    ...
    public void testMpReachNlri() throws BGPParsingException {
        ...
        mpBuilder.setAdvertizedRoutes(new AdvertizedRoutesBuilder().setDestinationType(
            new DestinationVpnIpv4CaseBuilder().setVpnDestination(Lists.newArrayList(VPN)).build()).build()).build();
    ...
    public void testMpUnreachNlri() throws BGPParsingException {
        ...
        mpBuilder.setWithdrawnRoutes(new WithdrawnRoutesBuilder().setDestinationType(
            new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.vpn.ipv4.rev160210.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.DestinationVpnIpv4CaseBuilder().setVpnDestination(Lists.newArrayList(VPN)).build()).build()).build();

...
final class VpnIpv4RIBSupport extends AbstractRIBSupport {
    ...
    protected VpnIpv4RIBSupport(final Class<? extends AddressFamily> afiType) {
    ...
    private NodeIdentifierWithPredicates createRouteKey(final UnkeyedListEntryNode labeledUnicast) {
        ...
        final VpnIpv4Destination dest = extractCLabeledUnicastDestination(labeledUnicast);
    ...
    private static VpnIpv4Destination extractCLabeledUnicastDestination(final DataContainerNode<? extends PathArgument> route) {
        final LabeledUnicastRIBSupport luSupport = new LabeledUnicastRIBSupport(Ipv4AddressFamily.class);
        final VpnIpv4DestinationBuilder builder = new VpnIpv4DestinationBuilder();
        builder.setPrefix(luSupport.extractPrefix(route, PREFIX_TYPE_NID));
        builder.setLabelStack(luSupport.extractLabel(route));

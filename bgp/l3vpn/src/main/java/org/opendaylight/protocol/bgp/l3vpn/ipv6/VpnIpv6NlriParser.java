...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.vpn.ipv6.rev180323.L3vpnIpv6Destination;
...
class VpnIpv6NlriParser extends AbstractVpnNlriParser {
    ...
    protected List<VpnDestination> getWithdrawnVpnDestination(DestinationType dstType) {
        return getVpnDestination(dstType,
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.vpn.ipv6.rev180323.update.attributes

            ...
            if (maybeRoutes.isPresent()) {
                ...
                if (routes instanceof UnkeyedListNode) {
                    ...
                    for (final UnkeyedListEntryNode e : routeListNode.getValue()) {
                        final NodeIdentifierWithPredicates routeKeyNodeId = createRouteKey(e);
                        LOG.debug("Route {} is processed.", routeKeyNodeId);
                        function.apply(tx, base, routeKeyNodeId, e, attributes);
                    }
                } else {

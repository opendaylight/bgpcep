...
public class LinkstateAdjRIBsInTest extends AbstractDataBrokerTest {
    ...
    public void testAddAdvertisement() {
        ...
        assertEquals(NlriType.Ipv4Prefix, NlriUtil.getNlriType(dests.get(0)));
        ...
        assertEquals(NlriType.Node, NlriUtil.getNlriType(dests.get(1)));
        ...
        assertEquals(NlriType.Link, NlriUtil.getNlriType(dests.get(2)));
    }

/*
 * Copyright (c) 2015 Cisco diffs, Inc. and others.  All rights reserved.
 *
...
public class SrAttributeParserTest {
    ...
    private static final byte[] fecIpv6Bytes = { 0x20, 1, 0, 0, 0, 0, 0, 0 };
    private static final Ipv6Prefix fecIpv6 = new Ipv6Prefix("2001::/64");

...
public class SrAttributeParserTest {
    ...
    private static final Ipv6Prefix fecIpv6 = new Ipv6Prefix("2001::1/8");
    ...
    public void testSidLabelBindingv4() {
        ...
        final byte[] expectedBytes = { (byte)0x95, 41, (byte)0xC0, 24,
            0, 42,
            32, 127, 0, 0, 0,
            1, 4, 1, 2, 3, 4,
            2, 1, 8,
            ...
            5, 7, (byte)0x80, 1, 2, 3, 4, 1, (byte)0xF4};
        ...
        assertEquals(srSidLabelToSerialize.toString(), parsedSrSidLabel.toString());
    }
    ...
    public void testSidLabelBindingv6() {
        ...
        final byte[] expectedBytes = Bytes.concat(new byte[] {
            (byte)0x95, 41, (byte)0xC0, 24,
            0, 42,
            64 }, fecIpv6Bytes, new byte[] {

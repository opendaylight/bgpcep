...
public class LinkstateAttributeParserTest {
    ...
    private static final byte[] LINK_ATTR = {0x04, 0x04, 0, 0x04, 0x2a, 0x2a, 0x2a, 0x2a, 0x04, 0x06, 0, 0x04, 0x2b, 0x2b, 0x2b, 0x2b,
        ...
        0x04, 0x4f, 0, 0x08, 0, 0x04, 0, 0, 0x0a, 0x0b, 0x0c, 0x0f, // peer-set-sid
    ...
    public void testPositiveLinks() throws BGPParsingException {
        ...
        assertNull(ls.getPeerSetSids().get(1).getFlags());
        ...
        assertEquals(new Long(168496143L), ((SidCase) ls.getPeerSetSids().get(1).getSidLabelIndex()).getSid());
        assertEquals(new Short("4"), ls.getPeerSetSids().get(1).getWeight().getValue());

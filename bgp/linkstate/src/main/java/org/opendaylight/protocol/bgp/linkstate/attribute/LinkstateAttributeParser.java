...
public class LinkstateAttributeParser implements AttributeParser, AttributeSerializer {
    ...
    public LinkstateAttributeParser(final boolean isIanaAssignedType, final TeLspRegistry teLspRegistry) {
        this.type = (isIanaAssignedType) ? TYPE : LEGACY_TYPE;
        teLspAttributesParser = new TeLspAttributesParser(teLspRegistry);
    }

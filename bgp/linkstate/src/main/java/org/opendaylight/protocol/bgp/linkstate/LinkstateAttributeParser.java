    ...
    private static LinkStateAttribute parseLinkAttributes(final Multimap<Integer, ByteBuf> attributes) {
        ...
        for (final Entry<Integer, ByteBuf> entry : attributes.entries()) {
            ...
            case TlvCode.UNRESERVED_BANDWIDTH:
                final List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev131125.link.state.UnreservedBandwidth> unreservedBandwidth = new ArrayList<>();
            ...
            case TlvCode.TE_METRIC:
                builder.setTeMetric(new TeMetric(value.readUnsignedInt()));

...
public abstract class AbstractNlriTypeCodec implements NlriTypeCaseParser, NlriTypeCaseSerializer {
    ...
    protected final SimpleNlriTypeRegistry registry;

    protected AbstractNlriTypeCodec(final SimpleNlriTypeRegistry registry) {
        this.registry = registry;
    }

    @Override
    public final CLinkstateDestination parseTypeNlri(final ByteBuf nlri) throws BGPParsingException {

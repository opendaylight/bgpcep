...
public final class Ipv6IFaceAddTlvParser implements NlriSubTlvObjectParser, NlriSubTlvObjectSerializer, SubTlvLinkBuilder {
    ...
    public void buildLinkDescriptor(final Object subTlvObject, final Builder<?> tlvBuilder) {
        ((LinkDescriptorsBuilder) tlvBuilder).setIpv6InterfaceAddress((Ipv6InterfaceIdentifier) subTlvObject);
    }
}

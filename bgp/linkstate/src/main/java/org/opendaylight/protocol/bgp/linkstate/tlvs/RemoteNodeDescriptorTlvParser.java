...
public final class RemoteNodeDescriptorTlvParser extends AbstractNodeDescriptorTlvCodec implements LinkstateTlvParser<RemoteNodeDescriptors>, LinkstateTlvSerializer<RemoteNodeDescriptors> {

    public RemoteNodeDescriptorTlvParser(final SimpleNlriTypeRegistry tlvReg) {
        super(tlvReg);
    }
    ...
    public void serializeTlvBody(final RemoteNodeDescriptors tlv, final ByteBuf body) {
        ...
        this.tlvReg.serializeTlv(BgpRouterIdTlvParser.BGP_ROUTER_ID_QNAME, tlv.getBgpRouterId(), body);
        this.tlvReg.serializeTlv(MemAsNumTlvParser.MEMBER_AS_NUMBER_QNAME, tlv.getMemberAsn(), body);
    }

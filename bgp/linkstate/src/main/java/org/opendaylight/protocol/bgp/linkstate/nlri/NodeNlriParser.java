...
public final class NodeNlriParser {
    ...
    private static CRouterIdentifier serializeRouterId(final ChoiceNode routerId) {
    ...
    public static org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev150210.NodeIdentifier serializeDescriptors(final ContainerNode descriptorsData, final Builder<? extends org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev150210.NodeIdentifier> builder) {
        if (builder instanceof LocalNodeDescriptorsBuilder) {
            final LocalNodeDescriptorsBuilder localNodeBuilder = (LocalNodeDescriptorsBuilder) builder;
            final Optional<DataContainerChild<? extends PathArgument, ?>> asNumber = descriptorsData.getChild(AS_NUMBER_NID);
            if (asNumber.isPresent()) {
                localNodeBuilder.setAsNumber(new AsNumber((Long)asNumber.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> domainId = descriptorsData.getChild(DOMAIN_NID);
            if (domainId.isPresent()) {
                localNodeBuilder.setDomainId(new DomainIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> areaId = descriptorsData.getChild(AREA_NID);
            if (areaId.isPresent()) {
                localNodeBuilder.setAreaId(new AreaIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> routerId = descriptorsData.getChild(ROUTER_NID);
            if (routerId.isPresent()) {
                final CRouterIdentifier cRouterId = serializeRouterId((ChoiceNode)routerId.get());
                if (cRouterId != null) {
                    localNodeBuilder.setCRouterIdentifier(cRouterId);
                }
            }
            return localNodeBuilder.build();
        } else if (builder instanceof RemoteNodeDescriptorsBuilder) {
            final RemoteNodeDescriptorsBuilder remoteNodeBuilder = (RemoteNodeDescriptorsBuilder) builder;
            final Optional<DataContainerChild<? extends PathArgument, ?>> asNumber = descriptorsData.getChild(AS_NUMBER_NID);
            if (asNumber.isPresent()) {
                remoteNodeBuilder.setAsNumber(new AsNumber((Long)asNumber.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> domainId = descriptorsData.getChild(DOMAIN_NID);
            if (domainId.isPresent()) {
                remoteNodeBuilder.setDomainId(new DomainIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> areaId = descriptorsData.getChild(AREA_NID);
            if (areaId.isPresent()) {
                remoteNodeBuilder.setAreaId(new AreaIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> routerId = descriptorsData.getChild(ROUTER_NID);
            if (routerId.isPresent()) {
                final CRouterIdentifier cRouterId = serializeRouterId((ChoiceNode)routerId.get());
                if (cRouterId != null) {
                    remoteNodeBuilder.setCRouterIdentifier(cRouterId);
                }
            }
            return remoteNodeBuilder.build();
        } else if (builder instanceof AdvertisingNodeDescriptorsBuilder) {
            final AdvertisingNodeDescriptorsBuilder advertisingNodeBuilder = (AdvertisingNodeDescriptorsBuilder) builder;
            final Optional<DataContainerChild<? extends PathArgument, ?>> asNumber = descriptorsData.getChild(AS_NUMBER_NID);
            if (asNumber.isPresent()) {
                advertisingNodeBuilder.setAsNumber(new AsNumber((Long)asNumber.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> domainId = descriptorsData.getChild(DOMAIN_NID);
            if (domainId.isPresent()) {
                advertisingNodeBuilder.setDomainId(new DomainIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> areaId = descriptorsData.getChild(AREA_NID);
            if (areaId.isPresent()) {
                advertisingNodeBuilder.setAreaId(new AreaIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> routerId = descriptorsData.getChild(ROUTER_NID);
            if (routerId.isPresent()) {
                final CRouterIdentifier cRouterId = serializeRouterId((ChoiceNode)routerId.get());
                if (cRouterId != null) {
                    advertisingNodeBuilder.setCRouterIdentifier(cRouterId);
                }
            }
            return advertisingNodeBuilder.build();
        } else if (builder instanceof NodeDescriptorsBuilder) {
            final NodeDescriptorsBuilder nodeDescriptorsBuilder = (NodeDescriptorsBuilder) builder;
            final Optional<DataContainerChild<? extends PathArgument, ?>> asNumber = descriptorsData.getChild(AS_NUMBER_NID);
            if (asNumber.isPresent()) {
                nodeDescriptorsBuilder.setAsNumber(new AsNumber((Long)asNumber.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> domainId = descriptorsData.getChild(DOMAIN_NID);
            if (domainId.isPresent()) {
                nodeDescriptorsBuilder.setDomainId(new DomainIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> areaId = descriptorsData.getChild(AREA_NID);
            if (areaId.isPresent()) {
                nodeDescriptorsBuilder.setAreaId(new AreaIdentifier((Long)domainId.get().getValue()));
            }
            final Optional<DataContainerChild<? extends PathArgument, ?>> routerId = descriptorsData.getChild(ROUTER_NID);
            if (routerId.isPresent()) {
                final CRouterIdentifier cRouterId = serializeRouterId((ChoiceNode)routerId.get());
                if (cRouterId != null) {
                    nodeDescriptorsBuilder.setCRouterIdentifier(cRouterId);
                }
            }
            return nodeDescriptorsBuilder.build();
        }
        throw new IllegalStateException("Type of NodeDescriptors wasn't recognized.");
    }
}

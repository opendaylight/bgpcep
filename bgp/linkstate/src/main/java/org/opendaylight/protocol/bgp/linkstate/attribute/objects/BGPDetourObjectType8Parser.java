...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.detour.object.detour.object.address.family.Ipv6Case;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.detour.object.detour.object.address.family.Ipv6CaseBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.detour.object.detour.object.address.family.ipv6._case.AvoidNode;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.detour.object.detour.object.address.family.ipv6._case.AvoidNodeBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.detour.object.detour.object.address.family.ipv6._case.PlrId;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.detour.object.detour.object.address.family.ipv6._case.PlrIdBuilder;

public final class BGPDetourObjectType8Parser extends AbstractBGPObjectParser  {
    ...
    public void localSerializeObject(final TeLspObject teLspObject, final ByteBuf byteAggregator) {
        ...
        serializeAttributeHeader((pList.size() * IPV6_BYTES_LENGTH) + (aList.size() * IPV6_BYTES_LENGTH),
            detourObject.getClassNum(), detourObject.getCType(), byteAggregator);

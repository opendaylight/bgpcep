...
public final class BGPProtectionObjectType2Parser extends AbstractBGPObjectParser {
    ...
    protected TeLspObject localParseObject(final ByteBuf byteBuf) throws BGPParsingException {
        ...
        return builder.setCommonProtectionObject(BGPCommonExplicitRouteObjectParser.parseCommonProtectionBodyType2(byteBuf)).build();
    }
    ...
    public void localSerializeObject(final TeLspObject teLspObject, final ByteBuf output) {
        ...
        serializeAttributeHeader(BGPCommonRecordRouteObjectParser.PROTECTION_TYPE2_BODY_SYZE, protectionObject.getClassNum(),
            protectionObject.getCType(), output);
        BGPCommonExplicitRouteObjectParser.serializeBodyType2(protectionObject.getCommonProtectionObject(), output);
    }
}

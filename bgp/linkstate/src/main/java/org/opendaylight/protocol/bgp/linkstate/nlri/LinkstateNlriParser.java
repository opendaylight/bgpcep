        ...
        while (nlri.isReadable()) {
            ...
            if (!type.equals(NlriType.Ipv4TeLsp) && !type.equals(NlriType.Ipv6TeLsp)) {
                ...
                if (localtype == LOCAL_NODE_DESCRIPTORS_TYPE) {
                    localDescriptor = nlriTypeReg.parseTlv(nlri.readSlice(locallength), localtype, type);
                }
            ...
            builder.setObjectType(nlriTypeReg.parseNlriType(nlri, type, localDescriptor, rest));

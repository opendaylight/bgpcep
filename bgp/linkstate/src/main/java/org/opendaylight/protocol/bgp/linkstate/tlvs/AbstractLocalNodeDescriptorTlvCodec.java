...
abstract class AbstractLocalNodeDescriptorTlvCodec<T extends NodeIdentifier> extends AbstractNodeDescriptorTlvCodec implements LinkstateTlvParser<LocalNodeDescriptors>, LinkstateTlvSerializer<T> {

    private static final int LOCAL_NODE_DESCRIPTORS_TYPE = 256;

    AbstractLocalNodeDescriptorTlvCodec(final SimpleNlriTypeRegistry tlvReg) {
        super(tlvReg);
    }

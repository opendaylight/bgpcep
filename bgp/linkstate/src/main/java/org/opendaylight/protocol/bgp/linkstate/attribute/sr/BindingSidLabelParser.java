...
public class BindingSidLabelParser {
    ...
    public static SrBindingSidLabel parseBindingSidLabel(final ByteBuf buffer, final ProtocolId protocol) {
        ...
        bindingSid.setFlags(parseBindingSidFlags(flags, protocol));
        buffer.skipBytes(RESERVED_BINDING_SID);
        bindingSid.setBindingSubTlvs(parseBindingSubTlvs(buffer, protocol));
    ...
    private static List<BindingSubTlvs> parseBindingSubTlvs(final ByteBuf buffer, final ProtocolId protocol) {
        ...
        while (buffer.isReadable()) {
            ...
            switch (type) {
                ...
                case PrefixAttributesParser.PREFIX_SID:
                    final SrPrefix prefix = SrPrefixAttributesParser.parseSrPrefix(buffer, protocol);
    ...
    public static void serializeBindingSidLabel(final SrBindingSidLabel bindingSid, final ByteBuf aggregator) {
        ...
        final BitArray flags = serializeBindingSidFlags(bindingSid.getFlags(), buffer);
    ...
    private static BitArray serializeBindingSidFlags(final Flags flags, final ByteBuf buffer) {

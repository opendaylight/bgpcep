...
public final class SrPrefixAttributesParser {
    ...
    public static SrPrefix parseSrPrefix(final ByteBuf buffer) {
        ...
        builder.setFlags(buffer.readUnsignedByte());
    ...
    public static ByteBuf serializePrefixAttributes(final Short flags, final Algorithm algorithm, final SidLabelIndex sidLabelIndex) {

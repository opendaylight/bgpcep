...
public class SrPrefixAttributesParser {
    ...
    /* Prefix-SID flags */
    private static int READVERTISEMENT_FLAG = 0;
    private static int NODE_SID_FLAG = 1;
    private static int NO_PHP_FLAG = 2;
    private static int EXPLICIT_NULL_FLAG = 3;
    private static int VALUE_FLAG = 4;
    private static int LOCAL_FLAG = 5;

...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.te.lsp.rev150706.admin.status.object.AdminStatusObjectBuilder;

public final class BGPAdminStatusObjectParser extends AbstractBGPObjectParser {
    ...
    @Override
    protected void localSerializeObject(final TeLspObject teLspObject, final ByteBuf output) {
        ...
        serializeAttributeHeader(BODY_SIZE, addObject.getClassNum(), addObject.getCType(), output);

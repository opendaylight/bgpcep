...
public final class Ipv6NeighborAddTlvParser implements LinkstateTlvParser<Ipv6InterfaceIdentifier>, LinkstateTlvSerializer<Ipv6InterfaceIdentifier> {
    ...
    public void serializeTlvBody(Ipv6InterfaceIdentifier tlv, ByteBuf body, final QName qName) {
        if (tlv != null) {
            TlvUtil.writeTLV(IPV6_NEIGHBOR_ADDRESS, Ipv6Util.byteBufForAddress(tlv), body);
        }
    }

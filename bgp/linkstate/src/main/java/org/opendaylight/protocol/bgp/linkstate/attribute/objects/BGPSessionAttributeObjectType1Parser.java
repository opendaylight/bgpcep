...
public final class BGPSessionAttributeObjectType1Parser extends AbstractBGPObjectParser {
    ...
    protected TeLspObject localParseObject(final ByteBuf byteBuf) throws BGPParsingException {
        ...
        BGPSessionAttributeObjectType7Parser.parseSessionAttributeObject(builder, byteBuf);
    ...
    public void localSerializeObject(final TeLspObject teLspObject, final ByteBuf output) {
        ...
        serializeAttributeHeader(BODY_SIZE_C1 + sessionObject.getNameLength(), sessionObject.getClassNum(),
        ...
        BGPSessionAttributeObjectType7Parser.serializeSessionObject(sessionObject, output);
    }
}

...
final class TestingListener implements BGPSessionListener {
    ...
    @Override
    public void advertizeCapabilities(final int holdTimerValue, final Channel remoteAddress,
        final Set<BgpTableType> tableTypes, final List<BgpParameters> bgpParameters) {

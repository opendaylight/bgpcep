...
final class PrefixesBuilder {
    private static Ipv4NextHopCase NEXT_HOP;
    ...
    private static Attributes createAttributes(final List<String> extCom, final boolean multiPathSupport, final Ipv4Prefix addressPrefix) {
        ...
        if(multiPathSupport) {
            prefixes.setPathId(new PathId(1L));
        }
                ...
                new MpReachNlriBuilder()
                    ...
                    .setAdvertizedRoutes(new AdvertizedRoutesBuilder().setDestinationType(
                        new DestinationIpv4CaseBuilder().setDestinationIpv4(
                            new DestinationIpv4Builder().setIpv4Prefixes(Collections.singletonList(prefixes.build())).build())
                            .build()).build())
                    .build()).build());

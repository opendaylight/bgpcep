...
public class BGPSpeakerMock {
    ...
    public void createServer(final InetSocketAddress address) {
        disp.createServer(address,
            BGPDispatcherImpl.ChannelInizializator.createChannelPipelineInitializer(BGPSpeakerMock.this.factory.getDecoders(), BGPSpeakerMock.this.negotiatorFactory, this.factory.getEncoders()));
    }

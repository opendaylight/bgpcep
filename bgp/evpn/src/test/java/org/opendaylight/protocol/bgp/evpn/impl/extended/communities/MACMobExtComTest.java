...
public class MACMobExtComTest {
    ...
    private static final Long SEQ_NUMBER = 33686018L;
    ...
    public void parserTest() throws BGPParsingException, BGPDocumentedException {
        ...
        final MacMobilityExtendedCommunityCase acb = new MacMobilityExtendedCommunityCaseBuilder().setMacMobilityExtendedCommunity(
            new MacMobilityExtendedCommunityBuilder().setStatic(true).setSeqNumber(SEQ_NUMBER).build()).build();

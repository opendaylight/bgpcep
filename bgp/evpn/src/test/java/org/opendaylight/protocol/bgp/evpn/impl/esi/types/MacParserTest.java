...
public final class MacParserTest extends AbstractParserTest {
    ...
    public void parserTest() {
        ...
        final ContainerNode cont = createContBuilder(MacParser.MAC_AUTO_NID)
            .addChild(createValueBuilder(MAC, MacParser.MAC_NID).build())
            .addChild(createValueBuilder(UINT24_LD, AbstractEsiType.LD_NID).build())
            .build();

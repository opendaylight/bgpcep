...
public class LanParserTest extends AbstractParserTest {
    ...
    public void parserTest() {
        ...
        final LanAutoGeneratedCase acb = new LanAutoGeneratedCaseBuilder().setLanAutoGenerated(new LanAutoGeneratedBuilder()
        ...
        final ContainerNode cont = createContBuilder(LanParser.LAN_NID)
            .addChild(createValueBuilder(MAC, LanParser.MAC_NID).build())
            .addChild(createValueBuilder(PRIORITY, LanParser.BP_NID).build())
            .build();

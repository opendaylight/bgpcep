...
public class PeerSpecificParserConstraintImpl implements PeerSpecificParserConstraintProvider {
    ...
    private static final AtomicReferenceFieldUpdater<PeerSpecificParserConstraintImpl,
        ImmutableClassToInstanceMap> CONSTRAINTS_UPDATER = AtomicReferenceFieldUpdater.newUpdater(
            PeerSpecificParserConstraintImpl.class, ImmutableClassToInstanceMap.class, "constraints");
    ...
    public <T extends PeerConstraint> boolean addPeerConstraint(final Class<T> classType, final T peerConstraint) {
        ...
        while (!local.containsKey(peerConstraint)) {

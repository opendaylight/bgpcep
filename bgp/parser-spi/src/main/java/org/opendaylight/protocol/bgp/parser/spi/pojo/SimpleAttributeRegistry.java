...
final class SimpleAttributeRegistry implements AttributeRegistry {
    ...
    private static final List<UnrecognizedAttributes> unrecognizedAttributes = Lists.<UnrecognizedAttributes>newArrayList();

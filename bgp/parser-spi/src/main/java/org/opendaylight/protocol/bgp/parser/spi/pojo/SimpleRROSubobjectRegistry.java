...
final class SimpleRROSubobjectRegistry implements RROSubobjectRegistry {
    ...
    @Override
    public SubobjectContainer parseSubobject(final int type, final ByteBuf buffer) throws BGPParsingException {

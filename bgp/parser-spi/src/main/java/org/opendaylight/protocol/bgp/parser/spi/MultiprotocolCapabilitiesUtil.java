...
public final class MultiprotocolCapabilitiesUtil {
    ...
    public static BgpTableTypeImpl parseMPAfiSafi(final ByteBuf buffer, final AddressFamilyRegistry afiReg, final SubsequentAddressFamilyRegistry safiReg) throws BGPParsingException {

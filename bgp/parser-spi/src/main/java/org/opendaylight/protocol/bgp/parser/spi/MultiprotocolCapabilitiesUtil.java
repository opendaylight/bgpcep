...
public final class MultiprotocolCapabilitiesUtil {
    ...
    public static AfiSafiKey parseMPAfiSafi(final ByteBuf buffer, final AddressFamilyRegistry afiReg, final SubsequentAddressFamilyRegistry safiReg) throws BGPParsingException {
        ...
        return new AfiSafiKey(afi, safi);
    }
}

...
public interface BGPExtensionProviderContext extends BGPExtensionConsumerContext {
	 ...
	 * 
	 * @param objectClass class of the object being created
	 * @return An object cache instance for the selected class.
	 */
	<T> ReferenceCache<T> getReferenceCache(Class<T> objectClass);
}

...
public class SimpleExtendedCommunityRegistryTest {
    ...
    public void setup() throws BGPDocumentedException, BGPParsingException {
        ...
        Mockito.doNothing().when(this.serializer)
                .serializeExtendedCommunity(any(ExtendedCommunity.class), any(ByteBuf.class));
        Mockito.doReturn(null).when(this.parser).parseExtendedCommunity(any(ByteBuf.class));
    ...
    public void testExtendedCommunityRegistry() throws BGPDocumentedException, BGPParsingException {
        ...
        Mockito.verify(this.serializer).serializeExtendedCommunity(any(ExtendedCommunity.class), any(ByteBuf.class));
        ...
        Mockito.verify(this.parser).parseExtendedCommunity(any(ByteBuf.class));
    ...
    public void testExtendedCommunityRegistryUnknown() throws BGPDocumentedException, BGPParsingException {
        ...
        Mockito.verify(this.serializer, Mockito.never()).serializeExtendedCommunity(any(ExtendedCommunity.class), any(ByteBuf.class));
        ...
        Mockito.verify(this.parser, Mockito.never()).parseExtendedCommunity(any(ByteBuf.class));
    }

...
public class MultiPathSupportImplTest {
    ...
    public void testIsTableTypeSupported() {
        ...
        final MultiPathSupport multiPathSupport = MultiPathSupportImpl.createReceiveMultiPathSupport(supportedTables);

        Assert.assertFalse(multiPathSupport.isTableTypeSupported(ipv4Unicast));
        Assert.assertTrue(multiPathSupport.isTableTypeSupported(ipv6Unicast));
        Assert.assertTrue(multiPathSupport.isTableTypeSupported(ipv4L3vpn));

...
abstract class AbstractIPRibSupport<
    ...
    private final @NonNull ImmutableSet<Class<? extends DataContainer>> cacheableNlriObjects;
    private final NodeIdentifier prefixNid;
    private final NodeIdentifier nlriRoutesList;

    AbstractIPRibSupport(
            final BindingNormalizedNodeSerializer mappingService,
            final Class<? extends DataContainer> prefixClass,
    ...
    @Override
    public final ImmutableSet<Class<? extends DataContainer>> cacheableNlriObjects() {

...
public class LabeledUnicastIpv4RIBSupportTest extends AbstractRIBSupportTest<LabeledUnicastRoutesCase,
    ...
    static {
        ...
        ROUTES = new LabeledUnicastRoutesBuilder().setLabeledUnicastRoute(Map.of(ROUTE.key(), ROUTE)).build();
    }
    ...
    public void testDeleteRoutes() {
        ...
        assertEquals(ROUTE_KEY, deletedRoutes.getFirst().firstKeyOf(LabeledUnicastRoute.class));
    }
    ...
    public void testRouteAttributesIdentifier() {
        assertEquals(new NodeIdentifier(QName.create(LabeledUnicastRoutes.QNAME,
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.rib.rev260420.rib.tables

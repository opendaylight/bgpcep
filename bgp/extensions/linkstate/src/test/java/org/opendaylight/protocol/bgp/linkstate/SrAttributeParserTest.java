...
public class SrAttributeParserTest {
    ...
    public void testSrAlgorithm() {
        ...
        final Set<Algorithm> alg = algos.build();
        final Set<Algorithm> empty = Set.of();
    ...
    public void testSrLocalBlock() {
        ...
        srlbs.add(new SrlbBuilder()
                ...
                .build());
        assertEquals(srlbs, SrNodeAttributesParser.parseSrLocalBlock(Unpooled.wrappedBuffer(bytesSrlb)));
        final ByteBuf encodedSrlb = Unpooled.buffer();
        SrNodeAttributesParser.serializeSrLocalBlock(srlbs, encodedSrlb);
    ...
    public void testMSD() {
        ...
        assertEquals(msds, SrNodeAttributesParser.parseSrNodeMsd(Unpooled.wrappedBuffer(bytesMSD)));
        final ByteBuf encodedNodeMsd = Unpooled.buffer();
        SrNodeAttributesParser.serializeSrNodeMsd(msds, encodedNodeMsd);
    ...
    public void testFlexAlgo() {
        ...
        final FlexAlgoDefinition fad = new FlexAlgoDefinitionBuilder()
                .setFlexAlgoDefinitionTlv(List.of(fadTlv)).build();

...
public class SRv6SidStructureTlvParser implements LinkstateTlvParser<Srv6SidStructure>,
    ...
    public Srv6SidStructure parseTlvBody(final ByteBuf value) {
        final Srv6SidStructureBuilder builder = new Srv6SidStructureBuilder();
        builder.setLocatorBlockLength(readUint8(value));
        builder.setLocatorNodeLength(readUint8(value));
        builder.setFunctionLength(readUint8(value));
        builder.setArgumentLength(readUint8(value));

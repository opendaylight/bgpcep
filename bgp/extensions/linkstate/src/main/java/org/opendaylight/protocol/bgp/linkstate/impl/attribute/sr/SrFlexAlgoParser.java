...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.segment.routing.rev200120.flex.algo.definition.tlv.FlexAlgoSubtlvs;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.segment.routing.rev200120.flex.algo.definition.tlv.FlexAlgoSubtlvsBuilder;
...
public final class SrFlexAlgoParser {
    ...
    public static void serializeSrFlexAlgoDefinition(final FlexAlgoDefinition fad, final ByteBuf fadBuffer) {
        ...
        writeUint8(fadBuffer, fad.getFlexAlgo().getValue());
        fadBuffer.writeByte(fad.getMetricType().getIntValue());
        writeUint8(fadBuffer, fad.getCalcType());
        writeUint8(fadBuffer, fad.getPriority());

        /* Then, serialize SubTlvs if present */
        FlexAlgoSubtlvs fas = fad.getFlexAlgoSubtlvs();
        if (fas != null) {

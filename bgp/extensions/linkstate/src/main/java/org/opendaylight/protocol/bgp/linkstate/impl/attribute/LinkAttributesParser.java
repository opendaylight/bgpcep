...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.asla.tlv.StandardBitMaskBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.AslaMetric;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.AslaMetricBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.EgressPeerEngineering;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.EgressPeerEngineeringBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.PerformanceMetricBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.Srv6Builder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.peer.engineering.PeerAdjSid;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.peer.engineering.PeerAdjSidBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.peer.engineering.PeerNodeSid;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.peer.engineering.PeerNodeSidBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.peer.engineering.PeerSetSids;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.peer.engineering.PeerSetSidsBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.performance.attributes.LinkMinMaxDelay;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.performance.attributes.LinkMinMaxDelayBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.sr.attributes.LinkMsd;
...
public final class LinkAttributesParser {
        ...
        for (final Entry<Integer, ByteBuf> entry : attributes.entries()) {
            ...
            switch (key) {
                case LinkIdTlvParser.LINK_LR_IDENTIFIERS:
                    builder.setLinkLocalIdentifier(ByteBufUtils.readUint32(value));
                    builder.setLinkRemoteIdentifier(ByteBufUtils.readUint32(value));
    ...
    private static AslaMetric parseAsla(final ByteBuf buffer) {
        ...
        if (alength == FLAGS_FOUR_SIZE || alength == FLAGS_EIGHT_SIZE) {
            ...
            final BitArray flags = BitArray.valueOf(buffer, alength * FLAGS_SIZE);
    ...
    static void serializeLinkAttributes(final LinkAttributesCase linkAttributesCase, final ByteBuf output) {
        ...
        ifPresentApply(linkAttributes.getRemoteIpv6RouterId(), value -> TlvUtil.writeTLV(REMOTE_IPV6_ROUTER_ID,
            Ipv6Util.byteBufForAddress((Ipv6AddressNoZone) value), output));
        if (linkAttributes.getStandardMetric() != null) {
            final StandardMetric sm = linkAttributes.getStandardMetric();
        ...
        // Segment Routing
        if (linkAttributes.getSrAttribute() != null) {
            final SrAttribute sr = linkAttributes.getSrAttribute();
            ifPresentApply(sr.getSrAdjIds(),
                value -> SrLinkAttributesParser.serializeAdjacencySegmentIdentifiers((List<SrAdjIds>) value,
                    SR_ADJ_SID, output));
            ...
            ifPresentApply(sr.getLinkMsd(), value -> TlvUtil.writeTLV(SR_LINK_MSD,
                SrLinkAttributesParser.serializeSrLinkMsd((List<LinkMsd>) value), output));
        }
        // EPE Peer Node
        if (linkAttributes.getEgressPeerEngineering() != null) {
            final EgressPeerEngineering epe = linkAttributes.getEgressPeerEngineering();
        ...
        // SRv6
        if (linkAttributes.getSrv6() != null) {
            serializedSrv6EndXSID(linkAttributes.getSrv6().getSrv6EndXSid(), output);
            serializedSrv6LanEndXSID(linkAttributes.getSrv6().getSrv6LanEndXSid(), output);
        }
        // Performance Metrics
        if (linkAttributes.getPerformanceMetric() != null) {
            final PerformanceMetric pm = linkAttributes.getPerformanceMetric();

...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.Srv6EndXSidBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.linkstate.attribute.Srv6LanEndXSidBuilder;
...
public final class SRv6AttributesParser {
    ...
    public static Srv6Locator parseSrv6Locator(final ByteBuf buffer) {
        ...
        srv6LocatorBuilder.setFlags(new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp
                .segment.routing.rev241219.srv6.locator.FlagsBuilder().setUpDown(flags.get(D_BIT_FLAG)).build());

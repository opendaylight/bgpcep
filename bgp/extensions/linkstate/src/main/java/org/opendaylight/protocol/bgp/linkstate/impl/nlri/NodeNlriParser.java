...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev241219.node.identifier.c.router.identifier.ospf.node._case.OspfNode;
...
public final class NodeNlriParser extends AbstractNlriTypeCodec {
    ...
    protected ObjectType parseObjectType(final ByteBuf buffer) {
        ...
        builder.setNodeDescriptors(new NodeDescriptorsBuilder((org.opendaylight.yang.gen.v1.urn.opendaylight.params
                .xml.ns.yang.bgp.linkstate.rev241219.NodeIdentifier) SimpleNlriTypeRegistry.getInstance()

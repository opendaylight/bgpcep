...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.route.target.rev180618.route.target.constrain.route.target.constrain.choice.RouteTargetConstrainDefaultCaseBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.route.target.rev180618.route.target.constrain.route.target.constrain.choice.RouteTargetConstrainIpv4RouteCaseBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.route.target.rev180618.route.target.constrain.route.target.constrain.choice.RouteTargetConstrainRouteCaseBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.route.target.rev180618.route.target.constrain.route.target.constrain.choice.route.target.constrain._default._case.RouteTargetConstrainDefaultRouteBuilder;
...
public class SimpleRouteTargetConstrainNlriRegistryTest {
    ...
    private final SimpleRouteTargetConstrainNlriRegistry nlriRegistry = SimpleRouteTargetConstrainNlriRegistry.getInstance();
    private final Integer type;
    private final byte[] expectedBuffer;
    private RouteTargetConstrainChoice expected;

    public SimpleRouteTargetConstrainNlriRegistryTest(final RouteTargetConstrainChoice RouteTargetConstrainChoice,
            final Integer type, final byte[] expectedBuffer) {

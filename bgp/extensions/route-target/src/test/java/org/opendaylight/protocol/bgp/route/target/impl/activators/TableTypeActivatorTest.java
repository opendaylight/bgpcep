...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.openconfig.extensions.rev180329.ROUTETARGET;
...
public final class TableTypeActivatorTest {
    ...
    public void testActivator() {
        ...
        assertEquals(ROUTETARGET.class, afiSafiType4.get());

        final Optional<BgpTableType> tableType4 = registry.getTableType(ROUTETARGET.class);

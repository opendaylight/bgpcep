...
public class RIBActivatorTest extends AbstractRIBActivatorTest {
    ...
    public void testRIBActivator() {
        ...
        assertNull(context.getRIBSupport(Ipv4AddressFamily.class, RouteTargetConstrainsSubsequentAddressFamily.class));
        ribAct.startRIBExtensionProvider(context, this.mappingService);
        assertNotNull(context.getRIBSupport(Ipv4AddressFamily.class, RouteTargetConstrainsSubsequentAddressFamily.class));
        ribAct.close();
    }
}
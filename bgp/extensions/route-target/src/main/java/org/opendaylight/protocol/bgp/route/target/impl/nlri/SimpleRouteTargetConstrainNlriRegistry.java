...
import org.opendaylight.protocol.bgp.route.target.spi.nlri.RouteTargeConstraintNlriRegistry;
...
public final class SimpleRouteTargetConstrainNlriRegistry implements RouteTargeConstraintNlriRegistry {
    ...
    public ByteBuf serializeRouteTargetConstrain(final RouteTargetConstrainChoice rtc) {
        final RouteTargetConstrainSerializer serializer = this.handlers.getSerializer(rtc.getImplementedInterface());
        ...
        body.writeBytes(serializer.serializeRouteTargetConstrain(rtc));
        return body;
    }
}

...
import org.opendaylight.protocol.bgp.route.target.impl.nlri.RouteTargetAS4OctetRouteHandler;
import org.opendaylight.protocol.bgp.route.target.impl.nlri.RouteTargetASRouteHandler;
import org.opendaylight.protocol.bgp.route.target.impl.nlri.RouteTargetIpv4RouteHandler;
import org.opendaylight.protocol.bgp.route.target.impl.nlri.SimpleRouteTargetConstrainNlriRegistry;
...
public final class NlriActivator {
    ...
    public static void registerNlriParsers(final List<AutoCloseable> regs) {
        final SimpleRouteTargetConstrainNlriRegistry nlriRegistry = SimpleRouteTargetConstrainNlriRegistry.getInstance();

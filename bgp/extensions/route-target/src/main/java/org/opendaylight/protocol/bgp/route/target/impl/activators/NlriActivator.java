...
import org.opendaylight.protocol.bgp.route.target.impl.nlri.SimpleRouteTargetNlriRegistry;
...
public final class NlriActivator {
    ...
    public static void registerNlriParsers(final List<AutoCloseable> regs) {
        final SimpleRouteTargetNlriRegistry nlriRegistry = SimpleRouteTargetNlriRegistry.getInstance();

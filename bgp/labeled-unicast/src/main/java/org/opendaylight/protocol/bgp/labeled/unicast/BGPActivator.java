...
public final class BGPActivator extends AbstractBGPExtensionProviderActivator {
    ...
    protected List<AutoCloseable> startImpl(final BGPExtensionProviderContext context) {
        ...
        regs.add(context.registerBgpPrefixSidTlvParser(LabelIndexTlvParser.LABEL_INDEX_TYPE, labelHandler));
        regs.add(context.registerBgpPrefixSidTlvParser(OriginatorSrgbTlvParser.ORIGINATOR_SRGB_TYPE, originatorHandler));

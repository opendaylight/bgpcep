...
public final class BGPActivator extends AbstractBGPExtensionProviderActivator {
    ...
    protected List<AutoCloseable> startImpl(final BGPExtensionProviderContext context) {
        ...
        final LuBgpPrefixSidParser bgpPrefixSidHandler = new LuBgpPrefixSidParser();
        regs.add(context.registerBgpPrefixSidTlvParser(LuBgpPrefixSidParser.LABEL_INDEX_TYPE, bgpPrefixSidHandler));
        regs.add(context.registerBgpPrefixSidTlvParser(LuBgpPrefixSidParser.ORIGINATOR_SRGB_TYPE, bgpPrefixSidHandler));
        regs.add(context.registerBgpPrefixSidTlvSerializer(LuLabelIndexTlv.class, bgpPrefixSidHandler));
        regs.add(context.registerBgpPrefixSidTlvSerializer(LuOriginatorSrgbTlv.class, bgpPrefixSidHandler));

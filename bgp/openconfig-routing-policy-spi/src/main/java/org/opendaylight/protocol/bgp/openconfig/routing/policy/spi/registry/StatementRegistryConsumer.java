...
public interface StatementRegistryConsumer {
     ...
     */
    RouteAttributeContainer applyExportStatement(OpenconfigPolicyConsumer policyConsumer, long localAs,
        Ipv4Address originatorId, ClusterIdentifier clusterId, PathArgument key, PeerId fromPeerId,
        PeerRole fromPeerRole, PeerId toPeer, PeerRole toPeerRole, RouteAttributeContainer attributes,
        Statement statement);
     ...
     * @return modified Route attributes
     */
    RouteAttributeContainer applyImportStatement(OpenconfigPolicyConsumer policyConsumer, long localAs,
        Ipv4Address originatorId, ClusterIdentifier clusterId, PathArgument key, PeerId fromPeerId,
        PeerRole fromPeerRole, RouteAttributeContainer attributes, Statement statement);
}

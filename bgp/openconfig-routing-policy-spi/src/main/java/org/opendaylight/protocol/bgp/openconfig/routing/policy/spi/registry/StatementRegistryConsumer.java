...
public interface StatementRegistryConsumer {
     ...
     * @param conditionSatisfied flag to be updated if any condition is satisfied per any condition
     * @return modified Route attributes
     */
    ContainerNode applyExportStatement(OpenconfigPolicyConsumer policyConsumer, long localAs, Ipv4Address
        originatorId, ClusterIdentifier clusterId, PathArgument key, PeerId fromPeerId, PeerRole fromPeerRole,
        PeerId toPeer, PeerRole toPeerRole, ContainerNode attributes, Statement statement,
     ...
     * @return modified Route attributes
     */
    ContainerNode applyImportStatement(OpenconfigPolicyConsumer policyConsumer, long localAs, Ipv4Address originatorId,
        ClusterIdentifier clusterId, PathArgument key, PeerId fromPeerId, PeerRole fromPeerRole,
        ContainerNode attributes, Statement statement, boolean conditionSatisfied);
}

...
final class ConditionsRegistryImpl {
    ...
    boolean matchExportConditions(
        ...
        final IpPrefix prefix = extractPrefix(baseExportParameters.getRouteKey());
        ...
        for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : igpAug.entrySet()) {
            ...
            if (!handler.matchExport(basePolicyParameters, baseExportParameters, attributes,
        ...
        for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : conditionsAug.entrySet()) {
            ...
            if (!handler.matchExportCondition(basePolicyParameters, baseExportParameters, attributes,
    ...
    boolean matchImportConditions(
        ...
        final ContainerNode attributes,
        final Conditions conditions) {
        if (!matchPrefix(policyProvider, routeBaseParameters.getRouteKey(), conditions.getMatchPrefixSet())) {
            return false;
        }
        ...
        if (igpConditions != null) {
            ...
            for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : igpAug.entrySet()) {
                ...
                if (!handler.matchImport(basePolicyParameters, routeBaseParameters, attributes,
                    (Augmentation<IGPConditionPolicy>) entry.getValue())) {
                    return false;
                }
            }
        ...
        if (conditionsAug != null && attributes != null) {
            for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : conditionsAug.entrySet()) {
                ...
                if (handler != null) {
                    ...
                    if (!handler.matchImportCondition(basePolicyParameters, routeBaseParameters, attributes,
                        conditionConfig)) {
                        return false;
                    }
                }

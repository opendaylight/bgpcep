...
public final class StatementRegistry implements StatementRegistryConsumer, StatementRegistryProvider {
    ...
    public AbstractRegistration registerGenericConditionPolicy(
            final GenericConditionPolicy conditionPolicy) {
    ...
    @Nonnull
    @Override
    public AbstractRegistration registerBgpConditionPolicy(
            final Class<? extends Augmentation<BgpConditions>> conditionPolicyClass,
            final BGPConditionPolicy conditionPolicy) {
        return this.conditionsRegistry.registerBGPConditionPolicy(conditionPolicyClass, conditionPolicy);
    }

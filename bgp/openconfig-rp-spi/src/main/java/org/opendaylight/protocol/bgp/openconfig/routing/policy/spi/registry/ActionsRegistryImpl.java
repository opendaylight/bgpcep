...
final class ActionsRegistryImpl {
    ...
    ContainerNode applyExportAction(
        ...
        ContainerNode attributesUpdated = applyExportIGPActions(basePolicyParameters, routeEntryExportParameters,
        ...
        for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : conditionsAug.entrySet()) {
            ...
            attributesUpdated = handler.applyExportAction(basePolicyParameters, routeEntryExportParameters,
    ...
    private ContainerNode applyExportIGPActions(
            final PolicyRIBBaseParameters baseExportParameters,
            final BGPRouteEntryExportParameters routeEntryExportParameters,
            final ContainerNode attributes,
        ...
        for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : conditionsAug.entrySet()) {
            ...
            attributesUpdated = handler.applyExportAction(baseExportParameters, routeEntryExportParameters,

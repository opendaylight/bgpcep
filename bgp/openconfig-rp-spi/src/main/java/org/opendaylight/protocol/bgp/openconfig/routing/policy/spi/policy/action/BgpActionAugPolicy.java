 ...
 */
public interface BgpActionAugPolicy<T extends Augmentation<BgpActions>> {
    /**
     * Applies bgp action to Route Attributes container (Import Policy).
     *
     ...
     * @param bgpActions                 bgp Actions   @return modified Route attributes
    ...
    Attributes applyImportAction(
            ...
            @Nonnull T bgpActions);

    /**
     * Applies bgp action to Route Attributes container (Export Policy).
     *
     * @param routeEntryInfo             contains route Entry Info(AS, ClusterId, OriginatorId)
     * @param routeEntryExportParameters contains route basic export information
     * @param attributes                 attributes
     * @param bgpActions                 bgp Actions
     * @return modified Route attributes
     */

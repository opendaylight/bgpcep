...
public interface StatementRegistryProvider {
    ...
    AbstractRegistration registerGenericConditionPolicy(
            @Nonnull GenericConditionPolicy genericConditionPolicy);
    ...
    AbstractRegistration registerBgpConditionPolicy(
            @Nonnull Class<? extends Augmentation<BgpConditions>> conditionPolicyClass,
            @Nonnull BGPConditionPolicy conditionPolicy);

...
public final class RouteAttributeContainer {
    ...
    private RouteAttributeContainer(final ContainerNode attributes, final boolean anyConditionSatisfied) {
        this.anyConditionSatisfied = anyConditionSatisfied;
        this.attributes = attributes;
    }

    public static RouteAttributeContainer routeAttributeContainerFalse(final ContainerNode attributes) {
        return new RouteAttributeContainer(attributes, false);
    }

    public static RouteAttributeContainer routeAttributeContainerTrue(final ContainerNode attributes) {

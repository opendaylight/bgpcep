...
final class ConditionsRegistryImpl {
    ...
    boolean matchExportConditions(
        ...
        final MatchPrefixSet prefixConditions = conditions.getMatchPrefixSet();
        if (prefixConditions != null) {
            if (!policyProvider.matchPrefix(prefixConditions.getPrefixSet(), prefix)) {
                return false;
            }
        }
    ...
    private boolean matchPrefix(
        ...
        final boolean found = policyProvider.matchPrefix(matchPrefixSet.getPrefixSet(), prefix);

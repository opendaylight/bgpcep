...
final class ConditionsRegistryImpl {
    ...
    boolean matchExportConditions(
        ...
        for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : igpAug.entrySet()) {
            ...
            if (!handler.matchExport(basePolicyParameters, routeEntryExportParameters, attributes,
        ...
        for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : conditionsAug.entrySet()) {
            ...
            if (!handler.matchExportCondition(basePolicyParameters, routeEntryExportParameters, attributes,
    ...
    boolean matchImportConditions(
        ...
        if (igpConditions != null) {
            ...
            for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : igpAug.entrySet()) {
                ...
                if (!handler.matchImport(basePolicyParameters, routeEntryImportParameters, attributes,
                        (Augmentation<IGPConditionPolicy>) entry.getValue())) {
                    return false;
                }
            }
        ...
        if (conditionsAug != null && attributes != null) {
            for (final Map.Entry<Class<? extends Augmentation<?>>, Augmentation<?>> entry : conditionsAug.entrySet()) {
                ...
                if (handler != null) {
                    ...
                    if (!handler.matchImportCondition(basePolicyParameters, routeEntryImportParameters, attributes,
                            conditionConfig)) {
                        return false;
                    }
                }

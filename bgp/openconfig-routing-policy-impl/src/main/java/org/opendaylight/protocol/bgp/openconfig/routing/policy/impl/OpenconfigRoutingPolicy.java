...
public final class OpenconfigRoutingPolicy implements ClusteredDataTreeChangeListener<RoutingPolicy>,
    ...
    private synchronized void handlePolicyDefinitions(final List<PolicyDefinition> policyDefinitions) {

...
public final class MatchCommunitySetHandler extends AbstractCommunityHandler implements BgpConditionsPolicy<MatchCommunitySet> {
    ...
    private boolean matchCondition(
            final List<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.message.rev171207.path

 ...
 */
public final class MatchAfiSafiNotIn implements
        BgpConditionsAugmentationPolicy<MatchAfiSafiNotInCondition, Void> {

    private static final MatchAfiSafiNotIn INSTANCE = new MatchAfiSafiNotIn();

    private MatchAfiSafiNotIn() {

    }

    public static MatchAfiSafiNotIn getINSTANCE() {
        return INSTANCE;
    }

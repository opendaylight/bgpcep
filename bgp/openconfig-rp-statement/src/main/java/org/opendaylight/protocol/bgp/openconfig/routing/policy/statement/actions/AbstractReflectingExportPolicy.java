...
abstract class AbstractReflectingExportPolicy extends AbstractExportAction {
     ...
     * @param routeEntryInfo contains RibBaseParameters(AS, ClusterId, OriginatorId)
    ...
    protected final ContainerNode reflectedAttributes(@Nonnull final ContainerNode attributes,
        ...
        return AttributeOperations.getInstance(attributes).reflectedAttributes(attributes, routeEntryInfo);
    }

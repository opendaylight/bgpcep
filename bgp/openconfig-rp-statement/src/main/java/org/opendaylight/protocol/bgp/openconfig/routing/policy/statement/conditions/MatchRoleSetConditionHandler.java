...
public final class MatchRoleSetConditionHandler implements BgpConditionsAugmentationPolicy<MatchRoleSetCondition> {
    ...
    private boolean matchRoleCondition(final MatchRoleSet roleMatch, final PeerRole role) {

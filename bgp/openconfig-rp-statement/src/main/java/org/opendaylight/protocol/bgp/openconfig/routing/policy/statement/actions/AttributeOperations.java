...
final class AttributeOperations {
    ...
    ContainerNode reflectedAttributes(final ContainerNode attributes, final PolicyRIBBaseParameters policyRIBBaseParameters) {
        ...
        final ClusterIdentifier clusterId = policyRIBBaseParameters.getClusterId();
        ...
        final Ipv4Address originatorId = policyRIBBaseParameters.getOriginatorId();

...
public final class NeighborAnnounced implements ConditionPolicy {
    ...
    public boolean matchExportCondition(
        ...
        final MatchRoleSet neighCond = ((NeighborAnnouncedCondition) conditions).getNeighborAnnouncedCondition()
                .getMatchRoleSet();
        return matchRoleCondition(neighCond, routeEntryExportParameters.getToPeerRole());
    }
}

...
public final class MatchClusterIdSetConditionHandler
    ...
    public MatchClusterIdSetConditionHandler(final DataBroker dataBroker) {
    ...
    private boolean matchClusterIdCondition(
        ...
        if (attributes.getClusterId() != null) {
            ...
            final boolean anyCommon = Collections.disjoint(matchClusterList, newList);

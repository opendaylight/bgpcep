...
public abstract class AbstractOperandParser<T> {
     ...
     * @param endOfList if this operand is at end of the list
     * @param buffer where the operand will be serialized to
     */
    protected abstract void serialize(final T op, final int length, final boolean endOfList, final ByteBuf buffer);

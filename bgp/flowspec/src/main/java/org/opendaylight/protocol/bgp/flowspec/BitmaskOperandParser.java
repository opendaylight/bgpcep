 ...
 */
public class BitmaskOperandParser extends AbstractOperandParser<BitmaskOperand> {
    ...
    @Override
    public final void serialize(final BitmaskOperand op, final int length, final ByteBuf buffer) {
    ...
    @Override
    public final BitmaskOperand parse(final byte op) {

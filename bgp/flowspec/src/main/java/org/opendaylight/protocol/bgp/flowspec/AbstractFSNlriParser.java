...
public abstract class AbstractFSNlriParser {
    ...
    protected abstract byte serializeFragment(final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.Fragment fragment);

    protected abstract org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.Fragment parseFragment(final byte fragment);

    public abstract Flowspec extractFlowspec(final MapEntryNode route);

    abstract String stringNlri(final Flowspec flow);
     ...
     */
    public void serializeNlri(final List<Flowspec> flows, final ByteBuf buffer) {
     ...
     */
    protected static <T extends NumericTwoByteValue> void serializeNumericTwoByteValue(final List<T> list, final ByteBuf nlriByteBuf) {
     ...
     * @param nlriByteBuf where the items will be serialized
     */
    protected static <T extends NumericOneByteValue> void serializeNumericOneByteValue(final List<T> list, final ByteBuf nlriByteBuf) {
    ...
    protected static void serializeNumericOperand(final NumericOperand op, final int length, final ByteBuf buffer) {
    ...
    protected static void serializeBitmaskOperand(final BitmaskOperand op, final int length, final ByteBuf buffer) {
        final BitArray bs = new BitArray(OPERAND_LENGTH);
        bs.set(END_OF_LIST, op.isEndOfList());
        bs.set(AND_BIT, op.isAndBit());
    ...
    protected static void serializeTcpFlags(final List<TcpFlags> flags, final ByteBuf nlriByteBuf) {
    ...
    protected static void serializeDscps(final List<Dscps> dscps, final ByteBuf nlriByteBuf) {
     ...
     */
    public List<Flowspec> parseNlri(final ByteBuf nlri) throws BGPParsingException {
        if (!nlri.isReadable()) {
            return null;
        }
    ...
    protected static NumericOperand parseNumeric(final byte op) {
    ...
    protected static BitmaskOperand parseBitmask(final byte op) {
        final BitArray bs = BitArray.valueOf(op);
    ...
    protected void extractFlowspec(final ChoiceNode fsType, final FlowspecBuilder fsBuilder) {
    ...
    protected static Fragment createFragment(final Set<String> data) {
    ...
    protected static NumericOperand createNumericOperand(final Set<String> opValues) {
    ...
    protected static BitmaskOperand createBitmaskOperand(final Set<String> opValues) {
    ...
    protected void stringNlri(final FlowspecType value, final StringBuilder buffer) {
        if (value instanceof PortCase) {
    ...
    protected static <T extends NumericTwoByteValue> String stringNumericTwo(final List<T> list) {
    ...
    protected static <T extends NumericOneByteValue> String stringNumericOne(final List<T> list) {
        final StringBuilder buffer = new StringBuilder();
        boolean isFirst = true;
        for (final T item : list) {
            buffer.append(stringNumericOperand(item.getOp(), isFirst));
    ...
    protected static String stringNumericOperand(final NumericOperand op, final boolean isFirst) {
        final StringBuilder buffer = new StringBuilder();
    ...
    protected static String stringTcpFlags(final List<TcpFlags> flags) {
    ...
    protected static String stringBitmaskOperand(final BitmaskOperand op, final boolean isFirst) {
        final StringBuilder buffer = new StringBuilder();
        if (!op.isAndBit() && !isFirst) {
            buffer.append("or ");
        }
    ...
    protected static String stringDscp(final List<Dscps> dscps) {
    ...
    protected static String stringFragment(final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.Fragment fragment) {
        final StringBuilder buffer = new StringBuilder();
        if (fragment.isDoNot()) {

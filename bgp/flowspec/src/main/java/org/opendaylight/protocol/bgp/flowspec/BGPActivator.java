...
public final class BGPActivator extends AbstractBGPExtensionProviderActivator {
    ...
    protected List<AutoCloseable> startImpl(final BGPExtensionProviderContext context) {
        ...
        final FlowspecL3vpnIpv4NlriParser fsL3vpnIpv4Handler = new FlowspecL3vpnIpv4NlriParser(this.flowspecContext.getFlowspecL3vpnIpv4TypeRegistry());
        final FlowspecL3vpnIpv6NlriParser fsL3vpnIpv6Handler = new FlowspecL3vpnIpv6NlriParser(this.flowspecContext.getFlowspecL3vpnIpv6TypeRegistry());

...
public final class BGPActivator extends AbstractBGPExtensionProviderActivator {
    ...
    private final FlowspecExtensionProviderContext flowspecContext;
    private final FlowspecActivator fsActivator;

    public BGPActivator(final FlowspecExtensionProviderContext fsc, FlowspecActivator fsa) {
    ...
    protected List<AutoCloseable> startImpl(final BGPExtensionProviderContext context) {
        ...
        final FlowspecIpv4NlriParser fsIpv4Handler = new FlowspecIpv4NlriParser(this.flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV4, FlowspecExtensionProviderContext.SAFI.FLOWSPEC));
        final FlowspecIpv6NlriParser fsIpv6Handler = new FlowspecIpv6NlriParser(this.flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV6, FlowspecExtensionProviderContext.SAFI.FLOWSPEC));
        ...
        // register handlers for flowspec l3vpn starts -------------------------------------
        final FlowspecL3vpnIpv4NlriParser fsL3vpnIpv4Handler = new FlowspecL3vpnIpv4NlriParser(this.flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV4, FlowspecExtensionProviderContext.SAFI.FLOWSPEC_VPN));
        final FlowspecL3vpnIpv6NlriParser fsL3vpnIpv6Handler = new FlowspecL3vpnIpv6NlriParser(this.flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV6, FlowspecExtensionProviderContext.SAFI.FLOWSPEC_VPN));
        ...
        // register handlers for flowspec l3vpn ends -------------------------------------

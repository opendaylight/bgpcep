...
public abstract class AbstractFlowspecRIBSupport extends AbstractRIBSupport {
    ...
    private final void processDestination(final DOMDataWriteTransaction tx, final YangInstanceIdentifier routesPath,
        ...
        if (destination != null) {
            ...
            if (maybeRoutes.isPresent()) {
                ...
                if (routes instanceof UnkeyedListNode) {
                    ...
                    getLogger().warn("Routes {} are not a map", routes);
                }
            }
        }
    }

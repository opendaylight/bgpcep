...
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv4.FSIpProtocolHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv4.FSIpv4DestinationPrefixHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv4.FSIpv4FragmentHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv4.FSIpv4SourcePrefixHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv6.FSIpv6DestinationPrefixHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv6.FSIpv6FlowLabelHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv6.FSIpv6FragmentHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv6.FSIpv6NextHeaderHandler;
import org.opendaylight.protocol.bgp.flowspec.handlers.ipv6.FSIpv6SourcePrefixHandler;
...
public final class FlowspecActivator implements AutoCloseable {
    ...
    public FlowspecActivator(final FlowspecExtensionProviderContext context) {
        for (FlowspecExtensionProviderContext.SAFI safi : FlowspecExtensionProviderContext.SAFI.values()) {
            registerCommonFlowspecTypeHandlers(
                FlowspecExtensionProviderContext.AFI.IPV4,
                safi,
                registrations,
                context
            );
            ...
            registerCommonFlowspecTypeHandlers(
                FlowspecExtensionProviderContext.AFI.IPV6,
                safi,
                registrations,
                context
            );
    ...
    private void registerCommonFlowspecTypeHandlers(
        final FlowspecExtensionProviderContext.AFI afi,
        final FlowspecExtensionProviderContext.SAFI safi,
        final List<AutoCloseable> regs,
        final FlowspecExtensionProviderContext context
    ) {
        final FlowspecTypeRegistry flowspecTypeRegistry = context.getFlowspecTypeRegistry(afi, safi);

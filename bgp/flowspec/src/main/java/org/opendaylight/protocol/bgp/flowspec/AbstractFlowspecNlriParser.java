...
public abstract class AbstractFlowspecNlriParser implements NlriParser, NlriSerializer {
     ...
     */
    protected final void serializeNlri(final List<Flowspec> flows, @Nullable final PathId pathId, final ByteBuf buffer) {
     ...
     */
    protected List<Flowspec> parseNlri(final ByteBuf nlri) throws BGPParsingException {
        if (!nlri.isReadable()) {
            return null;
        }
     ...
     * @param nlri
     */
    protected void verifyNlriLength(final ByteBuf nlri) {
    ...
    protected PathId readPathId(final ByteBuf nlri, final Class<? extends AddressFamily> afi, final Class<? extends SubsequentAddressFamily> safi,

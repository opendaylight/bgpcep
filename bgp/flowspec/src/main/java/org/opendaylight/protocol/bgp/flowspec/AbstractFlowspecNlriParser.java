...
public abstract class AbstractFlowspecNlriParser implements NlriParser, NlriSerializer {
     ...
     * @param dst a list of flowspec to be included in the destination type
     * @param pathId associated path id with given NLRI
     * @param args additional parameters that are used to create this destination type
     * @return created destination type
     */
    protected abstract DestinationType createWithdrawnDestinationType(final List<Flowspec> dst, @Nullable final PathId pathId, final Object... args);
     ...
     * @return created destination type
     */
    protected abstract DestinationType createAdvertizedRoutesDestinationType(final List<Flowspec> dst, @Nullable final PathId pathId, final Object... args);
    ...
    protected final PathId readPathId(final ByteBuf nlri, final Class<? extends AddressFamily> afi, final Class<? extends SubsequentAddressFamily> safi,

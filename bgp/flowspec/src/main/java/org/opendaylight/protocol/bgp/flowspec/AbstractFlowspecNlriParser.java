...
public abstract class AbstractFlowspecNlriParser implements NlriParser, NlriSerializer {
     ...
     */
    protected final List<Flowspec> parseNlriFlowspecList(final ByteBuf nlri) throws BGPParsingException {
        if (!nlri.isReadable()) {
            return null;
        }
     ...
     * @param nlri
     */
    private final void verifyNlriLength(final ByteBuf nlri) {
    ...
    protected
    @Nonnull
    Object[] parseNlri(@Nonnull final ByteBuf nlri) throws BGPParsingException {

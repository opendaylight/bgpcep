...
//    @VisibleForTesting
    static final NodeIdentifier RD_NID = new NodeIdentifier(FlowspecL3vpnRd.QNAME);
    @VisibleForTesting
    ...
    private RouteDistinguisher readRouteDistinguisher(final ByteBuf nlri, final Class<? extends SubsequentAddressFamily> safi) {
        ...
        Preconditions.checkArgument(nlri != null && nlri.isReadable(RouteDistinguisherUtil.RD_LENGTH));

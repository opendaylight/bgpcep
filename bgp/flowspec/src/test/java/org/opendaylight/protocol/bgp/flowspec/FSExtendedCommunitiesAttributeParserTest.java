...
public class FSExtendedCommunitiesAttributeParserTest {
    ...
    public void testExtendedCommunitiesParser() {
        ...
        final RouteTargetExtendedCommunityCase expected2 = new RouteTargetExtendedCommunityCaseBuilder().setRouteTargetExtendedCommunity(
        ...
        final RouteTargetExtendedCommunityCase result2 = (RouteTargetExtendedCommunityCase) ex.getExtendedCommunity();
        assertEquals(expected2.getRouteTargetExtendedCommunity().getGlobalAdministrator(),
                result2.getRouteTargetExtendedCommunity().getGlobalAdministrator());
        assertArrayEquals(expected2.getRouteTargetExtendedCommunity().getLocalAdministrator(),
                result2.getRouteTargetExtendedCommunity().getLocalAdministrator());
        ...
        assertArrayEquals(new byte[]{ (byte)192, 16, 8, (byte)128, 6, 0, 72, 0, 1, 2, 3,
            ...
            (byte)192, 16, 8, (byte)128, 9, 0, 0, 0, 0, 0, 63,
            }, ByteArray.readAllBytes(serializedBuffer));

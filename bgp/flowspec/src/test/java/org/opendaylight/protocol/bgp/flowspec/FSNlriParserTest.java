...
public class FSNlriParserTest {
    ...
    private static final byte[] REACHED_NLRI = new byte[] { 0x23,
        01, 0x18, 0, 0x0a, 00, 01,
        02, 0x28, 0, 1, 2, 3, 4, 5,
        03, (byte) 0x81, 06,
    ...
    private static final byte[] UNREACHED_NLRI = new byte[] { 0x21,
        07, 4, 2, (byte) 0x84, 3,
    ...
    public void testParseMpReachNlri() throws BGPParsingException {
        ...
        final DestinationPrefixCase destinationPrefix = new DestinationPrefixCaseBuilder().setDestinationPrefix(new IpPrefix(new Ipv4Prefix("10.0.1.0/24"))).build();
        builder.setFlowspecType(destinationPrefix);
        fs.add(builder.build());
        builder.setComponentType(ComponentType.SourcePrefix);
        final SourcePrefixCase sourcePrefix = new SourcePrefixCaseBuilder().setSourcePrefix(new IpPrefix(new Ipv6Prefix("102:304:500::/40"))).build();
        ...
        assertEquals("all packets from 102:304:500::/40", FSNlriParser.stringNlri(flows.get(1)));

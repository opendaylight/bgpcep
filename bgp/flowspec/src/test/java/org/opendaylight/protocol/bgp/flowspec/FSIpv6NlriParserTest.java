...
public class FSIpv6NlriParserTest {
    ...
    public void testParseMpReachNlri() throws BGPParsingException {
        ...
        final List<NextHeaders> nextheaders = Lists.newArrayList(new NextHeadersBuilder().setOp(new NumericOperand(false, true, true, false, false)).setValue(6).build());
    ...
    public void testParseMpUnreachNlri() throws BGPParsingException {
        ...
        final FragmentIpv6Case fragment = new FragmentIpv6CaseBuilder().setFragments(fragments).build();
    ...
    public void testExtractFlowspecFragments() {
        ...
        expected.setFlowspecType(new FragmentIpv6CaseBuilder().setFragments(Lists.<Fragments>newArrayList(new FragmentsBuilder().setValue(new Fragment(true, true, true, true)).setOp(new BitmaskOperand(true, true, true, true)).build())).build());
        ...
        entry.withChild(Builders.choiceBuilder().withNodeIdentifier(new NodeIdentifier(FlowspecType.QNAME))
            .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FSIpv6NlriParser.NEXT_HEADER_NID)
                .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FSIpv6NlriParser.NEXT_HEADER_NID)
                        ...
                        .withChild(Builders.leafBuilder().withNodeIdentifier(FSIpv6NlriParser.VALUE_NID).withValue(100).build()).build())
                .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FSIpv6NlriParser.NEXT_HEADER_NID)
                        ...
                        .withChild(Builders.leafBuilder().withNodeIdentifier(FSIpv6NlriParser.VALUE_NID).withValue(200).build()).build())
                .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FSIpv6NlriParser.NEXT_HEADER_NID)
                        ...
                        .withChild(Builders.leafBuilder().withNodeIdentifier(FSIpv6NlriParser.VALUE_NID).withValue(300).build()).build())
                .build()).build());

        final FlowspecBuilder expected = new FlowspecBuilder();
        expected.setFlowspecType(new NextHeaderCaseBuilder().setNextHeaders(Lists.<NextHeaders>newArrayList(
                new NextHeadersBuilder().setValue(100).setOp(new NumericOperand(true, true, false, false, false)).build(),
                new NextHeadersBuilder().setValue(200).setOp(new NumericOperand(true, false, false, false, false)).build(),
                new NextHeadersBuilder().setValue(300).setOp(new NumericOperand(true, true, true, false, false)).build())).build());
        assertEquals(expected.build(), FS_PARSER.extractFlowspec(entry.build()));
    }

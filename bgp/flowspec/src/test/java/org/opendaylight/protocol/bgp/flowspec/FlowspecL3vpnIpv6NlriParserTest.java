...
public class FlowspecL3vpnIpv6NlriParserTest {
    ...
    private final FlowspecL3vpnIpv6NlriParser FS_PARSER = new FlowspecL3vpnIpv6NlriParser(flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV6, FlowspecExtensionProviderContext.SAFI.FLOWSPEC));
    ...
    public void testParseMpReachNlri() throws BGPParsingException {
        ...
        final List<Flowspec> flows = ((org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.update.attributes.mp.reach.nlri.advertized.routes.destination.type.DestinationFlowspecL3vpnIpv6Case) (result.getAdvertizedRoutes().getDestinationType()))
            .getDestinationFlowspecL3vpnIpv6().getFlowspec();
    ...
    public void testParseMpUnreachNlri() throws BGPParsingException {
        ...
        final List<Flowspec> flows = ((org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.DestinationFlowspecL3vpnIpv6Case) (result.getWithdrawnRoutes().getDestinationType()))
            .getDestinationFlowspecL3vpnIpv6().getFlowspec();

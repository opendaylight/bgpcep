...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.flowspec.destination.ipv4.DestinationFlowspecIpv4Builder;
...
public class FlowspecIpv4NlriParserTest {
    ...
    private final FlowspecExtensionProviderContext flowspecContext = new FlowspecExtensionProviderContext();
    private final FlowspecActivator fsa = new FlowspecActivator(flowspecContext);
    private final FlowspecIpv4NlriParser FS_PARSER = new FlowspecIpv4NlriParser(flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV4, FlowspecExtensionProviderContext.SAFI.FLOWSPEC));
    ...
    public void testParseMpReachNlri() throws BGPParsingException {
        ...
        mp.setAdvertizedRoutes(
            new AdvertizedRoutesBuilder().setDestinationType(
                new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.update.attributes.mp.reach.nlri.advertized.routes.destination.type.DestinationFlowspecIpv4CaseBuilder()
        ...
        final FlowspecIpv4NlriParser parser = new FlowspecIpv4NlriParser(flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV4, FlowspecExtensionProviderContext.SAFI.FLOWSPEC));
        ...
        final List<Flowspec> flows = ((org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.update.attributes.mp.reach.nlri.advertized.routes.destination.type.DestinationFlowspecIpv4Case) (result.getAdvertizedRoutes().getDestinationType()))
    ...
    public void testParseMpUnreachNlri() throws BGPParsingException {
        ...
        mp.setAfi(Ipv4AddressFamily.class).setWithdrawnRoutes(new WithdrawnRoutesBuilder().setDestinationType(
            new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.DestinationFlowspecIpv4CaseBuilder()
                .setDestinationFlowspecIpv4(
                    new DestinationFlowspecIpv4Builder()
                        .setFlowspec(fs)
                        .build()
        ...
        final List<Flowspec> flows = ((org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.update.attributes.mp.unreach.nlri.withdrawn.routes.destination.type.DestinationFlowspecIpv4Case) (result.getWithdrawnRoutes().getDestinationType()))
            .getDestinationFlowspecIpv4()
            .getFlowspec();
        checkUnreachFlows(flows, icmpType, icmpCode, tcp, packet, dscp, fragment);

        final ByteBuf buffer = Unpooled.buffer();
        parser.serializeNlri(flows, null, null, buffer);
    ...
    public void testParseMpUnreachNlriConstraint() throws BGPParsingException {
        ...
        final ByteBuf buffer = Unpooled.buffer();
        parser.serializeNlri(flows, null, PATH_ID, buffer);
    ...
    public void testExtractFlowspecProtocolIps() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PROTOCOL_IP_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PROTOCOL_IP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractOperandParser.AND_BIT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue((short) 100).build()).build())
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PROTOCOL_IP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue((short) 200).build()).build())
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PROTOCOL_IP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractOperandParser.AND_BIT_VALUE, AbstractNumericOperandParser.EQUALS_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue((short) 240).build()).build())
    ...
    public void testExtractFlowspecPorts() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PORTS_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PROTOCOL_IP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractOperandParser.AND_BIT_VALUE, AbstractNumericOperandParser.LESS_THAN_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue(100).build()).build())
                        .build()).build()).build()).build());
    ...
    public void testExtractFlowspecDestinationPorts() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.DEST_PORT_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractNumericOperandParser.EQUALS_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue(1024).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecSourcePorts() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.SOURCE_PORT_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractOperandParser.END_OF_LIST_VALUE, AbstractNumericOperandParser.EQUALS_VALUE, AbstractNumericOperandParser.GREATER_THAN_VALUE, AbstractNumericOperandParser.LESS_THAN_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue(8080).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecSourceTypes() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.ICMP_TYPE_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractOperandParser.END_OF_LIST_VALUE, AbstractNumericOperandParser.EQUALS_VALUE, AbstractNumericOperandParser.GREATER_THAN_VALUE, AbstractNumericOperandParser.LESS_THAN_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue((short) 22).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecSourceCodes() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.ICMP_CODE_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet()).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue((short) 23).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecSourceTcpFlags() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.TCP_FLAGS_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractOperandParser.END_OF_LIST_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue(99).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecPacketLengths() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.PACKET_LENGTHS_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractNumericOperandParser.GREATER_THAN_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue(101).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecDscps() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.DSCP_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractOperandParser.END_OF_LIST_VALUE, AbstractNumericOperandParser.GREATER_THAN_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue((short) 15).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecFragments() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.FRAGMENT_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractOperandParser.END_OF_LIST_VALUE, BitmaskOperandParser.MATCH_VALUE, BitmaskOperandParser.NOT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.VALUE_NID).withValue(Sets.newHashSet(FlowspecIpv4NlriParser.DO_NOT_VALUE, FlowspecIpv4NlriParser.FIRST_VALUE, FlowspecIpv4NlriParser.IS_A_VALUE, FlowspecIpv4NlriParser.LAST_VALUE)).build()).build())
                        .build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();

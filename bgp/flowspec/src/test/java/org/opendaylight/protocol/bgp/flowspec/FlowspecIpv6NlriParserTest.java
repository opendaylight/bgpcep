...
import static org.opendaylight.protocol.bgp.flowspec.FlowspecIpv4NlriParserTest.PATH_ID;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.flowspec.rev150807.flowspec.destination.ipv6.DestinationFlowspecIpv6Builder;
...
public class FlowspecIpv6NlriParserTest {
    @Mock
    ...
    private final FlowspecIpv6NlriParser FS_PARSER = new FlowspecIpv6NlriParser(flowspecContext.getFlowspecTypeRegistry(FlowspecExtensionProviderContext.AFI.IPV6, FlowspecExtensionProviderContext.SAFI.FLOWSPEC));
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    ...
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.FRAGMENT_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE, AbstractOperandParser.END_OF_LIST_VALUE, BitmaskOperandParser.MATCH_VALUE, BitmaskOperandParser.NOT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.VALUE_NID).withValue(Sets.newHashSet(FlowspecIpv6NlriParser.DO_NOT_VALUE, FlowspecIpv6NlriParser.FIRST_VALUE, FlowspecIpv6NlriParser.IS_A_VALUE, FlowspecIpv6NlriParser.LAST_VALUE)).build()).build())
    ...
    public void testExtractFlowspecNextHeaders() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.NEXT_HEADER_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.NEXT_HEADER_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractOperandParser.AND_BIT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.VALUE_NID).withValue((short) 100).build()).build())
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.NEXT_HEADER_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.VALUE_NID).withValue((short) 200).build()).build())
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.NEXT_HEADER_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractOperandParser.AND_BIT_VALUE, AbstractNumericOperandParser.EQUALS_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.VALUE_NID).withValue((short) 210).build()).build())
                        .build()).build()).build()).build());
    ...
    public void testExtractFlowspecFlowLabels() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.unkeyedListBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.FLOW_LABEL_NID)
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.FLOW_LABEL_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.END_OF_LIST_VALUE, AbstractOperandParser.AND_BIT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.VALUE_NID).withValue(100L).build()).build())
                        .withChild(Builders.unkeyedListEntryBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.FLOW_LABEL_NID)
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.OP_NID).withValue(Sets.<String>newHashSet(AbstractOperandParser.AND_BIT_VALUE)).build())
                            .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.VALUE_NID).withValue(200L).build()).build())
                        .build()).build()).build()).build());
    ...
    public void testExtractFlowspecDestPrefix() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv6NlriParser.DEST_PREFIX_NID).withValue("102:304:500::/40").build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();
    ...
    public void testExtractFlowspecSourcePrefix() {
        ...
        entry.withChild(Builders.unkeyedListBuilder()
            ...
            .withChild(Builders.unkeyedListEntryBuilder()
                ...
                .withChild(Builders.choiceBuilder()
                    .withNodeIdentifier(AbstractFlowspecNlriParser.FLOWSPEC_TYPE_NID)
                    .withChild(Builders.leafBuilder().withNodeIdentifier(FlowspecIpv4NlriParser.SOURCE_PREFIX_NID).withValue("102:304:600::/40").build()).build()).build()).build());
        final FlowspecBuilder expectedFS = new FlowspecBuilder();

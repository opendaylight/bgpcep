...
public class FlowspecL3vpnIpv4NlriParserTest {
    ...
    private final FlowspecL3vpnIpv4NlriParser FS_PARSER = new FlowspecL3vpnIpv4NlriParser(flowspecContext.getFlowspecL3vpnIpv4TypeRegistry());
    ...
    public void testParseMpReachNlri() throws BGPParsingException {
        ...
        final FlowspecL3vpnIpv4NlriParser parser = new FlowspecL3vpnIpv4NlriParser(flowspecContext.getFlowspecL3vpnIpv4TypeRegistry());

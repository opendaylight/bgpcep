...
public class FlowspecL3vpnIpv4NlriParserTest {
    ...
    private static final String ROUTER_DISTINGUISHER = "1.2.3.4:10";
    ...
    private void testFlows(
        ...
        assertEquals(ROUTER_DISTINGUISHER, new String(rd.getValue()));
    ...
    public void testParseMpUnreachNlri() throws BGPParsingException {
        ...
        final ByteBuf buffer = Unpooled.buffer();
        parser.serializeNlri(flows, rd, null, buffer);
    ...
    public void testParseMpUnreachNlriConstraint() throws BGPParsingException {
        ...
        final ByteBuf buffer = Unpooled.buffer();
        parser.serializeNlri(flows, rd, PATH_ID, buffer);

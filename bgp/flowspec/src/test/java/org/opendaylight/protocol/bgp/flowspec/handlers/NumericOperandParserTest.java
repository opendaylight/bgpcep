...
public class NumericOperandParserTest {
    private static final byte[] ONE_BYTE_PORT_LIST = new byte[]{
            0x01, 0x64,
            0x01, 0x65,
    ...
    @Test
    public void testSerializeTwoByte() throws Exception {
        ...
        assertArrayEquals(ONE_BYTE_PORT_LIST, ByteArray.readAllBytes(nlriByteBuf));
    }

    @Test
    public void testSerializeOneByte() throws Exception {
        final ByteBuf nlriByteBuf = Unpooled.buffer();

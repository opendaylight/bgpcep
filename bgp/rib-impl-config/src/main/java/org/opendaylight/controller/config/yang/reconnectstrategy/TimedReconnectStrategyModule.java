...
public final class TimedReconnectStrategyModule
	...
	public TimedReconnectStrategyModule(
			org.opendaylight.controller.config.api.ModuleIdentifier identifier,
			org.opendaylight.controller.config.api.DependencyResolver dependencyResolver,
			TimedReconnectStrategyModule oldModule,
	...
	public java.lang.AutoCloseable createInstance() {
		ReconnectStrategy reconnectStrategy = new TimedReconnectStrategy(
				GlobalEventExecutor.INSTANCE, getConnectTime(), getMinSleep(),

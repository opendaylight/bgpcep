...
public final class BGPPeerModule extends org.opendaylight.controller.config.yang.bgp.rib.impl.AbstractBGPPeerModule {
    ...
    protected void customValidation() {
        ...
        JmxAttributeValidationException.checkCondition(getPeerRegistryBackwards().isPeerConfigured(getHost()), "Peer " + getHost() + " already configured", hostJmxAttribute);
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final BGPPeer bgpClientPeer = new BGPPeer(peerName(getHost()), r);

        getPeerRegistryBackwards().addPeer(getHost(), bgpClientPeer, prefs);

        final AutoCloseable peerCloseable = new AutoCloseable() {
            @Override
            public void close() throws Exception {
                bgpClientPeer.close();
                getPeerRegistryBackwards().removePeer(getHost());
            }
        };

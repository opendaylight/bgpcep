...
public final class BGPPeerModule extends org.opendaylight.controller.config.yang.bgp.rib.impl.AbstractBGPPeerModule
{
	...
	protected void customValidation(){
		...
		if (getHost().getIpAddress() == null || getHost().getIpAddress().getIpv4Address() == null) {
	...
	private InetSocketAddress createAddress() {
		if (getHost().getDomainName() != null) {
			return new InetSocketAddress(getHost().getDomainName().getValue(), getPort().getValue());
		}

		final IpAddress ip = getHost().getIpAddress();
	...
	private static String peerName(final Host host) {
		if (host.getDomainName() != null) {
			return host.getDomainName().getValue();
		}
		if (host.getIpAddress().getIpv4Address() != null) {
			return host.getIpAddress().getIpv4Address().getValue();
		}
		if (host.getIpAddress().getIpv6Address() != null) {
			return host.getIpAddress().getIpv6Address().getValue();
		}
	...
	public java.lang.AutoCloseable createInstance() {
		...
		if (bgpId == null) {
			...
			bgpId = getHost().getIpAddress().getIpv4Address();
		}

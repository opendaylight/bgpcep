...
public class BGPPeerModuleTest extends RIBImplModuleTest {
	...
	private static ObjectName createAdvertisedTable(ConfigTransactionJMXClient transaction, String tableTypeModuleName) throws InstanceAlreadyExistsException {
	...
	@Ignore("Cleanup throws exception")
	@Test

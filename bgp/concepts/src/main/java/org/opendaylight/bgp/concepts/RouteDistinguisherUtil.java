...
public final class RouteDistinguisherUtil {
    ...
    private static void serialize(final ByteBuf buf, final RdAs as) {
        ...
        ByteBufUtils.write(buf, Uint32.valueOf(value.substring(0, first)));
        ByteBufUtils.write(buf, Uint16.valueOf(value.substring(first + 1)));
    }
    ...
    private static void serialize(final ByteBuf buf, final RdTwoOctetAs as) {
        ...
        ByteBufUtils.write(buf, Uint16.valueOf(value.substring(first, second)));
        ByteBufUtils.write(buf, Uint32.valueOf(value.substring(second + 1)));
    }

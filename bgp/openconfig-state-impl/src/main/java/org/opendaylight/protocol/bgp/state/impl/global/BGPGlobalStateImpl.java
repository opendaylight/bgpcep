...
public final class BGPGlobalStateImpl implements BGPGlobalState, BGPStateConsumer {
    ...
    @Override
    public synchronized void increaseAfiSafiPrefixes(final Class<? extends AfiSafiType> afiSafiType) {
        this.totalPrefixes.get(afiSafiType).increaseCount();
    }

    @Override
    public synchronized void increaseAfiSafiPaths(final Class<? extends AfiSafiType> afiSafiType) {
        this.totalPaths.get(afiSafiType).increaseCount();
    }

    @Override
    public synchronized void decreaseAfiSafiPrefixes(final Class<? extends AfiSafiType> afiSafiType) {
        this.totalPrefixes.get(afiSafiType).decreaseCount();
    }

    @Override
    public synchronized void decreaseAfiSafiPaths(final Class<? extends AfiSafiType> afiSafiType) {
        this.totalPaths.get(afiSafiType).decreaseCount();
    }

...
public final class NeighborStateUtil {
     ...
     * @return Transport State
     */
    public static NeighborTransportStateAugmentation buildTransportState(@Nonnull final PortNumber localPort,
        @Nonnull final IpAddress remoteAddress, @Nonnull final PortNumber remotePort) {
        return new NeighborTransportStateAugmentationBuilder()
            .setLocalPort(localPort).setRemoteAddress(remoteAddress)
            .setRemotePort(remotePort).build();
    }

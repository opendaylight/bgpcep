...
final class BGPNeighborStateImpl implements BGPNeighborState {
    ...
    @Override
    public synchronized UnsignedInt32Counter getPrefixesInstalledCounter(final Class<? extends AfiSafiType> afiSafiType) {
        return this.prefixesInstalled.get(afiSafiType);
    }
    ...
    @Override
    public UnsignedInt32Counter getPrefixesReceivedCounter(final Class<? extends AfiSafiType> afiSafiType) {
        return this.prefixesReceived.get(afiSafiType);
    }

    @Override
    public UnsignedInt32Counter getErroneousUpdateReceivedCounter() {
        return this.erroneousUpdate;
    }

    @Override
    public BGPCountersMessagesTypesCommon getMessagesSentCounter() {
        return this.messagesSentCounter;
    }

    @Override
    public BGPCountersMessagesTypesCommon getMessagesReceivedCounter() {
        return this.messagesReceivedCounter;
    }

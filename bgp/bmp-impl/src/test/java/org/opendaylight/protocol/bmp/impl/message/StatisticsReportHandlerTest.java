...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.adj.ribs.in.routes.tlv.AdjRibsInRoutesTlvBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.duplicate.prefix.advertisements.tlv.DuplicatePrefixAdvertisementsTlvBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.duplicate.withdraws.tlv.DuplicateWithdrawsTlvBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.invalidated.as.path.loop.tlv.InvalidatedAsPathLoopTlvBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.invalidated.cluster.list.loop.tlv.InvalidatedClusterListLoopTlvBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.invalidated.originator.id.tlv.InvalidatedOriginatorIdTlvBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.loc.rib.routes.tlv.LocRibRoutesTlvBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.rejected.prefixes.tlv.RejectedPrefixesTlvBuilder;
...
public class StatisticsReportHandlerTest {
    ...
    public void init() {
        ...
        final BmpActivator act = new BmpActivator(context.getMessageRegistry());
        act.start(ctx);
    ...
    public void testSerializeStatsReportMessage() throws BmpDeserializationException {
        ...
        this.messageRegistry.serializeMessage(createStatsReportMsg(), buffer);
    ...
    public void testParseStatsReportMessage() throws BmpDeserializationException {
        final StatsReportsMessage parsedInitMsg = (StatsReportsMessage) this.messageRegistry.parseMessage(Unpooled.copiedBuffer(STATS_REPORT));
        assertEquals(createStatsReportMsg(), parsedInitMsg);
    }

    private static final StatsReportsMessage createStatsReportMsg() {

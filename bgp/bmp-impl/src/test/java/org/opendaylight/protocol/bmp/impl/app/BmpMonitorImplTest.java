...
public class BmpMonitorImplTest extends AbstractDataBrokerTest {
    ...
    public void testMonitoringStation() throws InterruptedException {
        final Channel channel = connectTestClient(this.msgRegistry);
        try {
            ...
            final ChannelFuture futureClose = channel.close();
            waitFutureSuccess(futureClose);
    ...
    private static void waitFutureSuccess(final ChannelFuture future) throws InterruptedException {
    ...
    private Channel connectTestClient(final BmpMessageRegistry msgRegistry) throws InterruptedException {
        ...
        final ChannelFuture future = b.connect(CLIENT_REMOTE);

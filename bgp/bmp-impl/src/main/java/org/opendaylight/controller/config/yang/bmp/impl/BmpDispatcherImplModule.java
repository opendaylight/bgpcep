...
public class BmpDispatcherImplModule extends org.opendaylight.controller.config.yang.bmp.impl.AbstractBmpDispatcherImplModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        return new BmpDispatcherImpl(getBossGroupDependency(), getWorkerGroupDependency(),
                getBmpExtensionsDependency().getBmpMessageRegistry(), new DefaultBmpSessionFactory(),Optional.<MD5ChannelFactory<?>>fromNullable(getMd5ChannelFactoryDependency()), Optional.<MD5ServerChannelFactory<?>>fromNullable(getMd5ServerChannelFactoryDependency()));
    }

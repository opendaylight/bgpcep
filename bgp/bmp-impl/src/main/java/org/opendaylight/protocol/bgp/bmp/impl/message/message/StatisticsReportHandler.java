...
public class StatisticsReportHandler extends AbstractBmpPerPeerMessageParser {
    ...
    private static final int REJECT_PREFIX_TYPE = 0;
    private static final int DUPLICATE_PREFIX_ADV_TYPE = 1;
    private static final int DUPLICATE_WITHDRAWS_TYPE = 2;
    private static final int INVALIDATE_CLUSTER_TYPE = 3;
    private static final int AS_PATH_TYPE = 4;
    private static final int INVALIDATE_ORIGINATOR_ID_TYPE = 5;
    private static final int INVALIDATE_AS_CONFED_TYPE = 6;
    private static final int ADJ_RIBS_IN_ROUTES_TYPE = 7;
    private static final int LOC_RIB_ROUTES_TYPE = 8;

...
public class BmpRibInWriter {
    ...
    private Map<TablesKey, TableContext> tablesPre;
    private Map<TablesKey, TableContext> tablesPost;
    private YangInstanceIdentifier tablesRootPre;
    private YangInstanceIdentifier tablesRootPost;


    public BmpRibInWriter(final YangInstanceIdentifier ribPath, final DOMTransactionChain chain,

...
final class BmpRibInWriter {
    ...
    public static BmpRibInWriter create(@Nonnull final YangInstanceIdentifier ribPath, @Nonnull final DOMTransactionChain chain,
        ...
        return new BmpRibInWriter(ribPath, chain, extensions, tableTypes, tree);
    }
    ...
    private void markTableUptodated(final TablesKey tableTypes) {
        ...
        tx.merge(LogicalDatastoreType.OPERATIONAL, ctxPre.getTableId().node(Attributes.QNAME).node(ATTRIBUTES_UPTODATE_TRUE.getNodeType()),

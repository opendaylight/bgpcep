...
public class StatisticsReportHandler extends AbstractBmpPerPeerMessageParser {
    ...
    public void serializeMessageBody(final Notification message, final ByteBuf buffer) {
        ...
        ByteBufWriteUtil.writeUnsignedInt(tlvsCount, buffer);
    ...
    private void parseTlv(final int type, final ByteBuf value, final StatsReportsMessageBuilder statReport) throws BMPDeserializationException {
        ...
        case LOC_RIB_ROUTES_TYPE:
            ...
            break;
        default:
            LOG.warn("Could not parse TLV Type on Statistis Report Message");
        }
    }

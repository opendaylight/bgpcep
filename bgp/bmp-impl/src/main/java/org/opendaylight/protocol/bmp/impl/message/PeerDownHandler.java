...
public class PeerDownHandler extends AbstractBmpPerPeerMessageParser {
    ...
    private org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.peer.down.data.Notification parsePDU(final ByteBuf bytes) {

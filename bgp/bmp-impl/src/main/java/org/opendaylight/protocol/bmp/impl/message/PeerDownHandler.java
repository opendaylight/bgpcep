...
public class PeerDownHandler extends AbstractBmpPerPeerMessageParser {
    ...
    public Notification parseMessageBody(final ByteBuf bytes) throws BMPDeserializationException {
        ...
        case REASON_FOUR:
            ...
            break;
        default:
            throw new BMPDeserializationException("Could not parse Initiation Message type");
        }
    ...
    private org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bmp.message.rev150512.peer.down.data.Notification parsePDU(final ByteBuf bytes) throws BMPDeserializationException {
        ...
        try {
            final Notification not = this.getBmpMessageRegistry().parseMessage(bytes);
            ...
            throw new BMPDeserializationException("Error on Parse PDU", e);
        }

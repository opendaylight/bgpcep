...
public final class InitiationHandler extends AbstractBmpMessageParser {
    ...
    @Override
    public void serializeMessageBody(final Notification message, final ByteBuf buffer) throws BMPDocumentedException {
        ...
        LOG.trace("Initiation message serialized to: {}", ByteBufUtil.hexDump(buffer));
    }
    ...
    public Notification parseMessageBody(final ByteBuf bytes) throws BMPDocumentedException {
        ...
        while (bytes.isReadable()) {
            ...
            LOG.debug("BMP Initiation message was parsed: err = {}, data = {}.", initiationBuilder.getDescription(),
                initiationBuilder.getName(), initiationBuilder.getStringInfo());
        }

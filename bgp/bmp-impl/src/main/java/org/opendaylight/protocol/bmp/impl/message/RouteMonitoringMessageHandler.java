...
public class RouteMonitoringMessageHandler extends AbstractBmpPerPeerMessageParser {
    ...
    public Notification parseMessageBody(final ByteBuf bytes) throws BMPDeserializationException {
        ...
        try {
            final Notification message = this.getBmpMessageRegistry().parseMessage(bytes);
            Preconditions.checkNotNull(message, "updateMessage may not be null");
            Preconditions.checkArgument(message instanceof UpdateMessage, "An instance of UpdateMessage notification is required");

...
public class RouteMonitoringMessageHandler extends AbstractBmpPerPeerMessageParser {
    ...
    public Notification parseMessageBody(final ByteBuf bytes) throws BMPDocumentedException {
        ...
        try {
            ...
            throw new BMPDocumentedException("Error on Parse Update Message", BMPError.UNSPECIFIC_UPDATE_ERROR);
        }

        LOG.debug("Peer Up notification was parsed: err = {}, data = {}.", routeMonitor.getUpdate());

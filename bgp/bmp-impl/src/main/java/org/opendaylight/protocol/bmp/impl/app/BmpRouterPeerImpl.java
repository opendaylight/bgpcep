...
public class BmpRouterPeerImpl implements BmpRouterPeer {
    ...
    private BmpRouterPeerImpl(final DOMTransactionChain domTxChain, final YangInstanceIdentifier peersYangIId, final PeerId peerId,
        ...
        wTx.submit();
        this.prePolicyWriter = BmpRibInWriter.create(this.peerYangIId.node(PrePolicyRib.QNAME).node(Tables.QNAME),
                this.domTxChain, extensions, peerTables, tree);
        this.postPolicyWriter = BmpRibInWriter.create(this.peerYangIId.node(PostPolicyRib.QNAME).node(Tables.QNAME),
                this.domTxChain, extensions, peerTables, tree);
    ...
    public static BmpRouterPeer createRouterPeer(final DOMTransactionChain domTxChain,
        ...
        return new BmpRouterPeerImpl(domTxChain, peersYangIId, new PeerId(peerUp.getReceivedOpen().getBgpIdentifier().getValue()), extensions,
                peerUp, tree);
    }
    ...
    private MapEntryNode createPeerEntry(final PeerUpNotification peerUp) {
        ...
        final DataContainerNodeAttrBuilder<NodeIdentifierWithPredicates, MapEntryNode> mapEntryBuilder = Builders.mapEntryBuilder()
                ...
                .withChild(
                        ...
                        .withChild(ImmutableNodes.mapNodeBuilder(Tables.QNAME).build()).build())
                .withChild(

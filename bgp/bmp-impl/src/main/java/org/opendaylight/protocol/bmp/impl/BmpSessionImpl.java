...
public final class BmpSessionImpl extends AbstractProtocolSession<Notification> implements BmpSession {
    ...
    public synchronized void close() {
        ...
        // TODO Check whether it should be send or not termination message to the Router

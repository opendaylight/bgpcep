...
public interface BGPSessionListener extends EventListener {
     ...
     */
    void onSessionUp(BGPSession remoteParams);
     ...
     */
    void onSessionTerminated(BGPSession var1, BGPTerminationReason reason);
     ...
     */
    void onMessage(BGPSession var1, Notification message);
}

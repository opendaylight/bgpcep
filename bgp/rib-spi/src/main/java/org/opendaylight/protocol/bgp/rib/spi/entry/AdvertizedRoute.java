...
public final class AdvertizedRoute extends AbstractAdvertizedRoute {
    ...
    public AdvertizedRoute(final RIBSupport<?, ?> ribSupport, final MapEntryNode route,
    ...
    public AdvertizedRoute(final RIBSupport<?, ?> ribSupport, final boolean isFirstBestPath,

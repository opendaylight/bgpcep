...
public interface RIBSupport {
     ...
     *
     * @param routes Collection of MapEntryNode routes in DOM format
     ...
     */
    @Nonnull Update buildUpdate(@Nonnull final Collection<MapEntryNode> routes, @Nonnull final Attributes attr);
}

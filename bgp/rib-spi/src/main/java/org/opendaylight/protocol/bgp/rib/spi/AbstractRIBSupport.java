...
public abstract class AbstractRIBSupport implements RIBSupport {
     ...
     * @return MpReachNlri
     */
    protected abstract MpReachNlri buildMp(Collection<MapEntryNode> routes, CNextHop hop);

    @Override
    public Update buildUpdate(final Collection<MapEntryNode> routes, final Attributes attr) {
        ...
        final MpReachNlri mb = buildMp(routes, hop);

...
public abstract class AbstractRIBSupport<
    ...
    @Override
    public R fromNormalizedNode(final YangInstanceIdentifier routerId, final NormalizedNode<?, ?> normalizedNode) {
        return (R) this.mappingService.fromNormalizedNode(routerId, normalizedNode).getValue();
    }

    @Override
    public Attributes attributeFromContainerNode(final YangInstanceIdentifier routeId, final ContainerNode advertisedAttrs) {

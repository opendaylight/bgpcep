...
public final class ExportPolicyPeerTracker extends AbstractPeerRoleTracker {
    ...
    public ExportPolicyPeerTracker(final PolicyDatabase policyDatabase, final TablesKey localTablesKey) {
    ...
    public boolean isAddPathSupported(final PeerId peerId) {

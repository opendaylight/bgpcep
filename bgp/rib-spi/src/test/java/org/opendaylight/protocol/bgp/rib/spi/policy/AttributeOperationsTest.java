...
public class AttributeOperationsTest {
    ...
    static final NodeIdentifier ORIGIN_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, Origin.QNAME.getLocalName()).intern());
    static final NodeIdentifier ORIGIN_VALUE_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, "value").intern());
    static final NodeIdentifier AS_PATH_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, AsPath.QNAME.getLocalName()).intern());
    static final NodeIdentifier ATOMIC_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, AtomicAggregate.QNAME.getLocalName()));
    static final NodeIdentifier CLUSTER_C_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, ClusterId.QNAME.getLocalName()));
    static final NodeIdentifier CLUSTER_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, "cluster"));
    static final NodeIdentifier ORIGINATOR_C_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, OriginatorId.QNAME.getLocalName()));
    static final NodeIdentifier ORIGINATOR_NID = new NodeIdentifier(QName.create(ExportPolicyTest.ATTRS_EXTENSION_Q, "originator"));

    @Test
    public void testExportedAttributesSetFirst() {
        final Long ourAs = 72L;
        final ContainerNode attributesSetBefore = Builders.containerBuilder().withNodeIdentifier(new NodeIdentifier(ExportPolicyTest.ATTRS_EXTENSION_Q))
            .addChild(Builders.containerBuilder().withNodeIdentifier(AS_PATH_NID)
                .addChild(Builders.unkeyedListBuilder().withNodeIdentifier(ExportPolicyTest.SEGMENTS_NID)
                    .addChild(ExportPolicyTest.SET_SEGMENT)
                    .addChild(ExportPolicyTest.SEQ_SEGMENT)
                    .build())
            .build())
            .build();
    ...
    public void testExportedAttributesListFirst() {
        final Long ourAs = 72L;
        final ContainerNode attributesListBefore = Builders.containerBuilder().withNodeIdentifier(new NodeIdentifier(ExportPolicyTest.ATTRS_EXTENSION_Q))
            .addChild(Builders.containerBuilder().withNodeIdentifier(AS_PATH_NID)
                .addChild(Builders.unkeyedListBuilder().withNodeIdentifier(ExportPolicyTest.SEGMENTS_NID)
                    .addChild(ExportPolicyTest.SEQ_SEGMENT)
                    .addChild(ExportPolicyTest.SET_SEGMENT)
    ...
    public void testExportedAttributesEmptyWithTransitive() {
        ...
        final ContainerNode attributesSetBefore = Builders.containerBuilder().withNodeIdentifier(new NodeIdentifier(ExportPolicyTest.ATTRS_EXTENSION_Q))
            ...
            .build())
            .addChild(Builders.containerBuilder().withNodeIdentifier(AS_PATH_NID)
                .addChild(Builders.unkeyedListBuilder().withNodeIdentifier(ExportPolicyTest.SEGMENTS_NID).build())
            .build())
    ...
    private LeafSetNode<?> checkFirstLeafList(final ContainerNode exportedAttributes) {
        assertTrue(NormalizedNodes.findNode(exportedAttributes, AS_PATH_NID, ExportPolicyTest.SEGMENTS_NID).isPresent());
        final UnkeyedListNode segments = (UnkeyedListNode) NormalizedNodes.findNode(exportedAttributes, AS_PATH_NID, ExportPolicyTest.SEGMENTS_NID).get();
    ...
    public void testReflectedAttributesOriginatorAndClusterNotPresent() {
        ...
        final ContainerNode attributes = Builders.containerBuilder().withNodeIdentifier(new NodeIdentifier(ExportPolicyTest.ATTRS_EXTENSION_Q))
            .addChild(Builders.containerBuilder().withNodeIdentifier(ORIGIN_NID)
                .addChild(Builders.leafBuilder().withNodeIdentifier(ORIGIN_VALUE_NID).withValue(BgpOrigin.Egp).build())
            .build())
            .build();

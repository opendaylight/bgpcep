...
public abstract class AbstractRIBSupportTest {
    ...
    private static final InstanceIdentifier<MpUnreachNlri> MP_UNREACH_IID = ATTRIBUTES_IID.child((Class) Attributes2.class).child(MpUnreachNlri.class);
    private static final InstanceIdentifier<MpReachNlri> MP_REACH_IID = ATTRIBUTES_IID.child((Class) Attributes1.class).child(MpReachNlri.class);

...
public abstract class AbstractRIBSupportTest<C extends CaseObject<Tables, ? extends Routes, C>,
        S extends ChildOf<? super C>, R extends Route & EntryObject<? super S, ?, ?>>

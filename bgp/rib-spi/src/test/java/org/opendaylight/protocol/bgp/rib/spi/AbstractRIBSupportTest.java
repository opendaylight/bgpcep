...
public abstract class AbstractRIBSupportTest<C extends Routes & DataObject & ChoiceIn<Tables>,
        ...
        R extends Route, X extends EntryObject<?, ?> & ChildOf<? super S>> extends AbstractConcurrentDataBrokerTest {
    ...
    protected List<InstanceIdentifier<X>> deletedRoutes;
    protected List<Map.Entry<InstanceIdentifier<?>, DataObject>> insertedRoutes;

    protected AdapterContext adapter;
    private AbstractRIBSupport<C, S, R, X> abstractRIBSupport;

    protected final void setUpTestCustomizer(final AbstractRIBSupport<C, S, R, X> ribSupport) throws Exception {

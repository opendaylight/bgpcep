...
public abstract class AbstractRIBSupportTest {
    ...
    protected final ChoiceNode createEmptyRoutes(final Routes emptyRoutes) {
        final Tables tables = new TablesBuilder().setKey(getTablesKey()).setRoutes(emptyRoutes).build();

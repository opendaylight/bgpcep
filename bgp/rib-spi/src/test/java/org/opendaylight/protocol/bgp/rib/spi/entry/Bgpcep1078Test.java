 ...
 * the AdjRibsOut entry once per route key and reuse it while the same effective attributes instance is passed.
 */
public class Bgpcep1078Test extends AbstractConcurrentDataBrokerTest {
    ...
    /*
     * The same effective attributes instance on the same key returns the cached entry instead of rebuilding it.
     */
    @Test
    public void testSameAttributesReuseEntry() {

...
import org.opendaylight.yang.svc.v1.urn.opendaylight.params.xml.ns.yang.bgp.test.rev180515.YangModuleInfoImpl;
...
public final class RIBSupportTestImp
        extends AbstractRIBSupport<Ipv4RoutesCase, Ipv4Routes, Ipv4Route, Ipv4Route, Ipv4Route> {
    ...
    public RIBSupportTestImp(final BindingNormalizedNodeSerializer mappingService) {
        super(mappingService, Ipv4RoutesCase.class, Ipv4RoutesCase.QNAME, Ipv4Routes.class, Ipv4Routes.QNAME,
            ...
            UnicastSubsequentAddressFamily.VALUE, UnicastSubsequentAddressFamily.QNAME, QNAME);
    }

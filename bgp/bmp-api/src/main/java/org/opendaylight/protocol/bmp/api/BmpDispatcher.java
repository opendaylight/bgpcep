...
public interface BmpDispatcher {
     ...
     * @param slf to create listeners for clients
    ...
    Future<Void> createReconnectingClient(InetSocketAddress address, ReconnectStrategyFactory connectStrategyFactory,
            ReconnectStrategyFactory reestablishStrategyFactory, SessionListenerFactory<BmpSessionListener> slf);

    Future<Void> createReconnectingClient(InetSocketAddress address, ReconnectStrategyFactory connectStrategyFactory,
            ReconnectStrategyFactory reestablishStrategyFactory, KeyMapping keys, SessionListenerFactory<BmpSessionListener> slf);
}

...
final class BGPConfigHolderImpl<V extends DataObject> implements BGPConfigHolder<V> {
    ...
    private final BiMap<ModuleKey, Identifier> moduleToOpenConfig = Maps.synchronizedBiMap(HashBiMap.<ModuleKey, Identifier>create());
    private final Map<Identifier, V> bgpOpenConfigConfig = Collections.synchronizedMap(new HashMap<Identifier, V>());
    ...
    @Override
    public synchronized ModuleKey getModuleKey(final Identifier key) {

...
final class BGPRibImplProvider {
    ...
    private static final Function<String, LocalTable> LOCAL_TABLE_FUNCTION = new ToLocalTableFunction();
    ...
    public synchronized void onGlobalRemoved(final Global removedGlobal, final DataBroker dataBroker) {
    ...
    public synchronized void onGlobalModified(final Global modifiedGlobal, final DataBroker dataBroker) {
        final ModuleKey moduleKey = globalState.getModuleKey(GlobalIdentifier.GLOBAL_IDENTIFIER);
        if (moduleKey != null) {
    ...
    private static final class ToLocalTableFunction implements Function<String, LocalTable> {
        @Override

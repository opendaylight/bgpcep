...
final class BGPPeerProvider {
    ...
    private static final Function<String, AdvertizedTable> ADVERTIZED_TABLE_FUNCTION = new ToAdvertizedTableFunction();
    private static final Function<String, Rib> TO_RIB_FUNCTION = new ToRibFunction();
    ...
    public synchronized void onNeighborRemoved(final Neighbor removedNeighbor, final DataBroker dataBroker) {
        ...
        if (moduleKey != null) {
            try {
                ...
                LOG.warn("Failed to remove a configuration module: {}", moduleKey, e);
            }
        }
    }

    public synchronized void onNeighborModified(final Neighbor modifiedNeighbor, final DataBroker dataBroker) {
        ...
        if (moduleKey != null) {
            ...
            try {
                ...
                LOG.warn("Failed to update a configuration module: {}", moduleKey, e);
            }
        } else {
            ...
            if (ribImplKey != null) {
                try {
                    ...
                    LOG.warn("Failed to create a configuration module: {}", moduleKey, e);
                }
            }
        }
    }

    private static final class ToAdvertizedTableFunction implements Function<String, AdvertizedTable> {
        @Override
    ...
    private static final class ToRibFunction implements Function<String, Rib> {
        @Override

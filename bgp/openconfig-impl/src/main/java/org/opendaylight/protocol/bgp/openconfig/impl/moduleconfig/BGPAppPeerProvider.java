...
final class BGPAppPeerProvider {
    ...
    private static final Function<String, TargetRib> TO_RIB_FUNCTION = new ToTargetRib();
    ...
    public synchronized void onNeighborModified(final Neighbor modifiedAppNeighbor, final DataBroker dataBroker) {
    ...
    private static final class ToTargetRib implements Function<String, TargetRib> {
        @Override

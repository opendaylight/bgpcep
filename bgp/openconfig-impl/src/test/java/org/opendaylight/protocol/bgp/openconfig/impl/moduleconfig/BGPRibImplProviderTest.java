...
public class BGPRibImplProviderTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(Boolean.TRUE).when(globalState).remove(this.moduleKey, createGlobal());
    ...
    public void testGlobalRemoved() throws TransactionCommitFailedException {
        this.ribProvider.onGlobalRemoved(createGlobal());
    ...
    public void testGlobalModified() {
        this.ribProvider2.onGlobalModified(createGlobal());
    }

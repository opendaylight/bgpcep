...
public class BGPPeerProviderTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(Boolean.TRUE).when(this.globalState).remove(mKey);
        this.peerProvider = new BGPPeerProvider(configHolders, moduleProvider);
    ...
    public void testRemoved() {
        this.peerProvider.onNeighborRemoved(this.neighbor, this.dataBroker);
...
//        TODO: problem with advertizedTablesFuture on line 95, it won't run and finish successfuly

...
public class BGPAppPeerProviderTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(Boolean.TRUE).when(this.globalState).remove(Mockito.any(ModuleKey.class));
        ...
        this.appPeerProvider = new BGPAppPeerProvider(configHolders, moduleProvider);
    ...
    public void testRemove() {
        this.appPeerProvider.onNeighborRemoved(this.neighbor, this.dataBroker);
        Mockito.verify(this.globalState).remove(Mockito.any(ModuleKey.class));
        Mockito.verify(this.wTx).delete(Mockito.any(LogicalDatastoreType.class), Mockito.any(InstanceIdentifier.class));
    }

    @Test
    public void testModified() {
        this.appPeerProvider.onNeighborModified(this.neighbor, this.dataBroker);

...
public interface BGPNeighborState {
     ...
     */
    void increasePrefixesInstalled(@Nonnull Class<? extends AfiSafiType> afiSafiType);
     ...
     * @param afiSafiType afi Safi Type
     */
    void decreasePrefixesInstalled(@Nonnull Class<? extends AfiSafiType> afiSafiType);
     ...
     * @param afiSafiType afi Safi Type
     */
    void increasePrefixesSent(@Nonnull Class<? extends AfiSafiType> afiSafiType);
     ...
     */
    void increasePrefixesReceived(@Nonnull Class<? extends AfiSafiType> afiSafiType, long numberOfRoutesInstalled);

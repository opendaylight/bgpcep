...
public interface BGPNeighborState {
    ...
    /**
     * Prefixed installed Counter (Effective-rib-in)
     * Its only valid for non Additional path, when additional path supported this won't be
     ...
     * @return Prefixes installed Counter
     */
    @Nullable
    UnsignedInt32Counter getPrefixesInstalledCounter(@Nonnull Class<? extends AfiSafiType> afiSafiType);

    /**
     * Prefixed sent Counter
     *
     * @param afiSafiType afi Safi Type
     * @return Prefixes sent Counter
     */
    @Nullable
    UnsignedInt32Counter getPrefixesSentCounter(@Nonnull Class<? extends AfiSafiType> afiSafiType);

    /**
     * Prefixed received Counter
     *
     * @param afiSafiType afi Safi Type
     * @return Prefixed received Counter
     */
    @Nullable
    UnsignedInt32Counter getPrefixesReceivedCounter(@Nonnull Class<? extends AfiSafiType> afiSafiType);

    /**
     * Erroneous Update Received Counter
     *
     * @return Counter
     */
    @Nullable
    UnsignedInt32Counter getErroneousUpdateReceivedCounter();
     ...
     */
    @Nullable
    BGPCountersMessagesTypesCommon getMessagesSentCounter();
     ...
     */
    @Nullable
    BGPCountersMessagesTypesCommon getMessagesReceivedCounter();

...
public interface BGPGlobalState {
    ...
    /**
     * Prefixes counter per Afi Safi Type
     *
     * @param afiSafiType Prefixes Counter
     */
    @Nonnull UnsignedInt32Counter getPathCounter(@Nonnull Class<? extends AfiSafiType> afiSafiType);
     ...
     * @param afiSafiType Prefixes Counter
     */
    @Nonnull UnsignedInt32Counter getPrefixesCounter(@Nonnull Class<? extends AfiSafiType> afiSafiType);
}

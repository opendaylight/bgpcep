...
public interface BGPGlobalState {
     ...
     */
    void increaseAfiSafiPrefixes(@Nonnull Class<? extends AfiSafiType> afiSafiType);
     ...
     * @param afiSafiType afi Safi
     */
    void increaseAfiSafiPaths(@Nonnull Class<? extends AfiSafiType> afiSafiType);

    /**
     * Decrease Prefixes counter per Afi Safi Type
     *
     * @param afiSafiType afi Safi
     */
    void decreaseAfiSafiPrefixes(@Nonnull Class<? extends AfiSafiType> afiSafiType);

    /**
     * Decrease paths counter per Afi Safi Type
     *
     * @param afiSafiType afi Safi
     */
    void decreaseAfiSafiPaths(@Nonnull Class<? extends AfiSafiType> afiSafiType);
}

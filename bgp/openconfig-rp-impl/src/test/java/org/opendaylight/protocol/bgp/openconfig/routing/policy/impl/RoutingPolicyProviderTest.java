...
public class RoutingPolicyProviderTest extends AbstractConcurrentDataBrokerTest {
    ...
    private Conditions buildConditions() {
        return new ConditionsBuilder()
                ...
                .setMatchNeighborSet(new MatchNeighborSetBuilder()
                        ...
                        .setNeighborSet("neighbor-set-test").build())

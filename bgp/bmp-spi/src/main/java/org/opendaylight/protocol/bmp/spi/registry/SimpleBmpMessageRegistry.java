...
public class SimpleBmpMessageRegistry implements BmpMessageRegistry {
    ...
    @Override
    public Notification parseMessage(final ByteBuf buffer) throws BMPDocumentedException {
    ...
    @Override
    public void serializeMessage(final Notification message, final ByteBuf buffer) throws BMPDocumentedException {
    ...
    private int parseMessageHeader(final ByteBuf buffer) {
        //TODO precondition messages
        ...
        Preconditions.checkArgument(buffer.readableBytes() == messageLength - COMMON_HEADER_LENGTH);
        return msgType;
    }

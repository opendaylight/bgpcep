...
public class TlvUtilTest {
    ...
    private static final byte[] TLV_INT_OUT = {(byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x02, (byte) 0x00, (byte) 0x05};
    ...
    @Test
    public void testFormatTlvUnsignedInt() throws Exception {
        final ByteBuf out = Unpooled.buffer(TLV_INT_OUT.length);
        TlvUtil.formatTlvUnsignedInt(1, 5, out);
        Assert.assertArrayEquals(TLV_INT_OUT, ByteArray.getAllBytes(out));
    }

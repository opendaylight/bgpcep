...
public final class BGPSessionStats {
    ...
    private static final Map<String, BGPSessionStatistics> BGPSessionStats = new HashMap<>();
    ...
    public static void addBgpSession(BGPSessionStatistics bgpSessionStatistics){
        BGPSessionStats.put(bgpSessionStatistics.getBgpSesionState().getPeerPreferences().getBgpId(), bgpSessionStatistics);
    }

    public static void removeBgpSession(String ip){
        BGPSessionStats.remove(ip);
    }

    public static BGPSessionStatistics getBgpSession(String ip){
        return BGPSessionStats.get(ip);
    }

    public static void resetStats(String ipAddress) {
        BGPSessionStatistics statistics = BGPSessionStats.get(ipAddress);

...
import org.opendaylight.protocol.bgp.rib.impl.BGPServerSessionNegotiator;
...
public final class BGPServerSessionNegotiatorFactory implements SessionNegotiatorFactory<Notification, BGPSessionImpl, BGPSessionListener> {
    ...
    public BGPServerSessionNegotiatorFactory(final Timer timer, final BGPSessionPreferences initialPrefs, final BGPSessionValidator sessionValidator, final BGPPeerRegistry registry) {
    ...
    public SessionNegotiator<BGPSessionImpl> getSessionNegotiator(final SessionListenerFactory<BGPSessionListener> factory,
        ...
        return new BGPServerSessionNegotiator(this.timer, promise, channel, this.initialPrefs, registry, validator);
    }
}

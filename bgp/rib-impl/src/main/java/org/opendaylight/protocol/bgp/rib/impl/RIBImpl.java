...
public final class RIBImpl extends DefaultRibReference implements AutoCloseable, RIB, TransactionChainListener, SchemaContextListener {
    ...
    private final EffectiveRibInWriter efRibWriter;
    ...
    public RIBImpl(final RibId ribId, final AsNumber localAs, final Ipv4Address localBgpId, final RIBExtensionConsumerContext extensions,
        ...
        this.yangRibId = YangInstanceIdentifier.builder().node(BgpRib.QNAME).nodeWithKey(Rib.QNAME, RIB_ID_QNAME, ribId).build();
        ...
        // put clusterId
        this.efRibWriter = EffectiveRibInWriter.create((DOMDataTreeChangeService)this.dataBroker,
            this.createPeerChain(this), getYangRibId(), localAs, localBgpId, null, this.ribContextRegistry);
    }

...
public final class BGPApplicationPeerClusterSingletonService implements ClusterSingletonService, AutoCloseable {
    ...
    public BGPApplicationPeerClusterSingletonService(final ApplicationRibId applicationRibId,
        ...
        final BGPConfigModuleTracker appPeerMT = new AppPeerModuleTracker(this.rib.getOpenConfigProvider());
        this.appPeer = new ApplicationPeer(this.appRibId, this.bgpPeerId, this.rib, appPeerMT);
        LOG.info("Application Peer Singleton Service {} registered", this.getIdentifier());
    ...
    private final class AppPeerModuleTracker implements BGPConfigModuleTracker {
        ...
        AppPeerModuleTracker(final Optional<BGPOpenConfigProvider> openConfigProvider) {
            ...
            this.bgpAppPeerInstanceConfiguration = new BGPAppPeerInstanceConfiguration(identifier, appRibId.getValue(), bgpPeerId);
        }

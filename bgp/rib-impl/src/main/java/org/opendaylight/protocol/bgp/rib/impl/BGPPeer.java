 ...
 * RIB actions.
 */
public class BGPPeer extends BGPPeerStateImpl implements BGPPeerSessionListener, Peer, AutoCloseable,
    ...
    public BGPPeer(final IpAddress neighborAddress, final RIB rib, final PeerRole role, final SimpleRoutingPolicy peerStatus,
        ...
        super(neighborAddress, afiSafisAdvertized, afiSafisGracefulAdvertized);
        this.peerRole = role;
        ...
        this.stateRegistration = this.rib.registerNeighborState(this, null);
    ...
    public synchronized void onSessionUp(final BGPSession session) {
        ...
        if(!isLearnNone(this.simpleRoutingPolicy)) {
            ...
            registerPrefixesCounters(this.effRibInWriter.getPrefixesReceived(),
                this.effRibInWriter.getPrefixesInstalled());
        }
    ...
    private void createAdjRibOutListener(final PeerId peerId, final TablesKey key, final boolean mpSupport) {
        ...
        if (context != null && this.session instanceof BGPSessionImpl) {
            ...
            registerPrefixesSentCounter(key, adjRibOut.getPrefixesSentCounter());
        }
    }

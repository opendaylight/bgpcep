...
public class BGPPeer implements BGPSessionListener, Peer, AutoCloseable, BGPPeerRuntimeMXBean, TransactionChainListener {
    ...
    private BgpPeerRpc rrRpc;
    private final RpcProviderRegistry rpcRegistry;
    private final RoutedRpcRegistration<BgpPeerRpcService> rpcRegistration = null;
    ...
    public synchronized void onSessionUp(final BGPSession session) {
        ...
        this.rpcRegistration = this.rpcRegistry.addRoutedRpcImplementation(BgpPeerRpcService.class, new BgpPeerRpc(session, this.adjRibOutListenerSet));
        final InstanceIdentifier<BgpRib> path = InstanceIdentifier.builder(NetworkTopology.class).child(BgpRib.class,
            new RibId(this.rib)).build(); // TODO

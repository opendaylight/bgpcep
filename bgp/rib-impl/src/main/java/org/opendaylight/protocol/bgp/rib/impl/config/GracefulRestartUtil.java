...
public final class GracefulRestartUtil {
    ...
    static Map<TablesKey, @Nullable Uint24> getGracefulTables(final Collection<AfiSafi> afiSafis,
    ...
    private static @Nullable Uint24 staleTimeOf(final @NonNull Config config) {

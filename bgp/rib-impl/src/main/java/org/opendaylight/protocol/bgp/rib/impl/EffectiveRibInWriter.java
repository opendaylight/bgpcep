    ...
    private final class AdjInTracker implements AutoCloseable, DOMDataTreeChangeListener {
        ...
        public void onDataTreeChanged(final Collection<DataTreeCandidate> changes) {
            ...
            for (final DataTreeCandidate tc : changes) {
                ...
                if (root.getModifiedChild(AbstractPeerRoleTracker.PEER_ROLE_NID) != null) {
                    EffectiveRibInWriter.this.peerPolicyTracker.onDataTreeChanged(root.getModifiedChild(AbstractPeerRoleTracker.PEER_ROLE_NID), IdentifierUtils.peerPath(rootPath));
                }
                // filter out any change outside AdjRibsIn
                if (root.getModifiedChild(ADJRIBIN_NID) == null) {

...
final class RibTableResyncContext<T> {
    private final ConcurrentMap<T, RibTableEntry<T>> uncheckedEntries;
    private final UnsignedInteger routerId;

    RibTableResyncContext(final UnsignedInteger routerId, final ConcurrentMap<T, RibTableEntry<T>> uncheckedEntries) {
     ...
     */
    boolean isStaleEntry(final T nlri, final RibTableEntry<T> entry) {
        /*

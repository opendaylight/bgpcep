...
public enum InstanceType {
    ...
    RIB("ribImpl", Lists.newArrayList(RIB.class, RibReference.class, BGPRIBStateConsumer.class)),

    PEER("bgpPeer", Lists.newArrayList(BGPPeerRuntimeMXBean.class, BGPPeerStateConsumer.class)),

...
final class TableContext {
    ...
    YangInstanceIdentifier routesPath(final YangInstanceIdentifier routesPath) {
        return tableSupport.getRibSupport().routesPath(routesPath);
    }

    YangInstanceIdentifier routePath(final YangInstanceIdentifier routesPath, final PathArgument routeId) {
        return tableSupport.getRibSupport().routePath(routesPath, routeId);
    }
}

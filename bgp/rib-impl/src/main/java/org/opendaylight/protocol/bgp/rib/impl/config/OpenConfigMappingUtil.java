...
public final class OpenConfigMappingUtil {
    ...
    public static Set<Class<? extends AfiSafiType>> toAfiSafiTypeSet(final Set<TablesKey> advertizedTables,
        final BGPTableTypeRegistryConsumer bgpTableTypeRegistryConsumer) {
        return advertizedTables.stream()
            .map(tablesKey -> OpenConfigMappingUtil.toAfiSafi(tablesKey, bgpTableTypeRegistryConsumer))

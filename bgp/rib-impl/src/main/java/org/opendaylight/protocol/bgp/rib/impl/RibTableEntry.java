...
final class RibTableEntry<T> {
    ...
    private synchronized boolean addRoute(final UnsignedInteger routerId, final PathAttributes attributes) {
    ...
    private synchronized boolean removeRoute(final UnsignedInteger routerId) {

...
final class LocRibWriter<C extends Routes & DataObject & ChoiceIn<Tables>, S extends ChildOf<? super C>,
    ...
    private static final LeafNode<Boolean> ATTRIBUTES_UPTODATE_TRUE =
        ImmutableNodes.leafNode(QName.create(Attributes.QNAME, "uptodate"), Boolean.TRUE);
    ...
    public static <C extends Routes & DataObject & ChoiceIn<Tables>, S extends ChildOf<? super C>,
        ...
        @Nonnull final YangInstanceIdentifier yangRibId,
    ...
    private synchronized void init() {
        ...
        final YangInstanceIdentifier tableId = this.yangRibId.node(Peer.QNAME).node(Peer.QNAME)
            .node(EffectiveRibIn.QNAME).node(Tables.QNAME)

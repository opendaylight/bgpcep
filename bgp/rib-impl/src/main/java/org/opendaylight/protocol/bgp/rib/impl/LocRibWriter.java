...
final class LocRibWriter implements AutoCloseable, DOMDataTreeChangeListener {
    ...
    private AbstractRouteEntry createEntry(PathArgument routeId) {
        final AbstractRouteEntry ret = ribSupport.isComplexRoute() ? new ComplexRouteEntry() : new SimpleRouteEntry();

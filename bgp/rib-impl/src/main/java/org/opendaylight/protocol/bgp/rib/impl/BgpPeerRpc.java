...
public class BgpPeerRpc {
    ...
    private ListenableFuture<RpcResult<ResetSessionOutput>> resetSession(final ResetSessionInput input) {
    ...
    private ListenableFuture<RpcResult<RestartGracefullyOutput>> restartGracefully(final RestartGracefullyInput input) {
    ...
    private ListenableFuture<RpcResult<RouteRefreshRequestOutput>> routeRefreshRequest(

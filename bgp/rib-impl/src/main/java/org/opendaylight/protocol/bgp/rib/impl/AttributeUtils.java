...
final class AttributeUtils {
    ...
    private static final LoadingCache<QNameModule, AttributeUtils> ATTRIBUTES_CACHE =
            CacheBuilder.newBuilder().weakKeys().weakValues().build(new CacheLoader<QNameModule, AttributeUtils>() {
        @Override

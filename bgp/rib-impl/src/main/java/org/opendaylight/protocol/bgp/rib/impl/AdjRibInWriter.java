...
final class AdjRibInWriter {
    ...
    private static final ChoiceNode EMPTY_ROUTES = ImmutableNodes.choiceNode(Routes.QNAME);
    ...
    void updateRoutes(final MpReachNlri nlri, final PathAttributes attributes) {
        ...
        if (ctx == null) {
            LOG.debug("No table for {}, not accepting NLRI", key);
            return;
        }
        ...
        final ContainerNode domNlri = null;
        final ContainerNode domAttributes = null;

...
final class AdjRibInWriter {
    ...
    private AdjRibInWriter(final YangInstanceIdentifier ribPath, final DOMTransactionChain chain, final String role, final YangInstanceIdentifier peerPath, final Map<TablesKey, TableContext> tables) {

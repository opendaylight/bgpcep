...
final class RibTable<T> {
     ...
     * hit.
     */
    private final Collection<ConsumingRouter> connectedSinks = new CopyOnWriteArrayList<>();
    ...
    void selectBestPath(final AsNumber localAs, final T route, final RibTableEntry<T> entry) {
        ...
        entry.selectRoute(this, route, localAs);
    }

    Collection<ConsumingRouter> getPotentialSinks() {

...
public final class BGPClusterSingletonService implements ClusterSingletonService, AutoCloseable {
    ...
    private synchronized void registerRibInstance(final RibImpl newRibImpl, final String ribInstanceName) {
        ...
        final ServiceRegistration<?> serviceRegistration = this.bundleContext.registerService(
                InstanceType.RIB.getServices(), newRibImpl, properties);
        newRibImpl.setServiceRegistration(serviceRegistration);
    }

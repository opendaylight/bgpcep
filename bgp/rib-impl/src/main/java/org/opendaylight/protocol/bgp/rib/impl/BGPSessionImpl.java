            ...
            for (final BgpParameters param : remoteOpen.getBgpParameters()) {
                for (final OptionalCapabilities optCapa : param.getOptionalCapabilities()) {
                    ...
                    if(cParam.getAugmentation(CParameters1.class) !=null && cParam.getAugmentation(CParameters1.class)
                        ...
                        final TablesKey tt = new TablesKey(cParam.getAugmentation(CParameters1.class)
                            .getMultiprotocolCapability().getAfi(), cParam.getAugmentation(CParameters1.class)
                            .getMultiprotocolCapability().getSafi());

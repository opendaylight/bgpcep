...
final class BestPathState {
    ...
    BestPathState(final ContainerNode attributes, final QName extension) {
        ...
        this.asPath = ImmutableList.<PathArgument>of(new NodeIdentifier(QName.create(this.extension, "as-path")), new NodeIdentifier(QName.create(this.extension, "segments")));
        this.locPref = ImmutableList.<PathArgument>of(new NodeIdentifier(QName.create(this.extension, "local-pref")), new NodeIdentifier(QName.create(this.extension, "pref")));
        this.med = ImmutableList.<PathArgument>of(new NodeIdentifier(QName.create(this.extension, "multi-exit-disc")), new NodeIdentifier(QName.create(this.extension, "med")));
        this.orig = ImmutableList.<PathArgument>of(new NodeIdentifier(QName.create(this.extension, "origin")), new NodeIdentifier(QName.create(this.extension, "value")));
    }

...
public final class BGPServerSessionNegotiatorFactory implements BGPSessionNegotiatorFactory {
    ...
    @Override
    public SessionNegotiator<BGPSessionImpl> getSessionNegotiator(final BGPSessionListenerFactory factory, final Channel channel, final Promise<BGPSessionImpl> promise) {

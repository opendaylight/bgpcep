...
public final class BGPClientSessionNegotiatorFactory implements BGPSessionNegotiatorFactory {
    ...
    @Override
    public SessionNegotiator getSessionNegotiator(final BGPSessionListenerFactory factory,
            final Channel channel, final Promise<BGPSession> promise) {

...
final class OffsetMap {
    ...
    <T> T[] reformat(final OffsetMap oldOffsets, final T[] oldArray, final int offset) {
        ...
        final int mid = oldArray.length - 2 * offset;

        System.arraycopy(oldArray, 0, ret, 0, offset);
        System.arraycopy(oldArray, offset, ret, offset + 1, mid);
        System.arraycopy(oldArray, offset + mid, ret, offset + 2 + mid, oldArray.length - mid);
    ...
    Ipv4Address getRouterId(final int offset) {

...
public abstract class RIBSupportContext {
    ...
    public abstract ContainerNode serializeAttributes (final Attributes attributes);

    public abstract Attributes deserializeAttributes (final NormalizedNode<?,?> attributes);
}

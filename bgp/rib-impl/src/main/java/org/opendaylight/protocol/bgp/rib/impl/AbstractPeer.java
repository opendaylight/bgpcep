...
abstract sealed class AbstractPeer extends BGPPeerStateImpl
    ...
    @Override
    public final synchronized @NonNull PeerId getPeerId() {
        return peerId;
    }

    @Override
    public final @NonNull PeerRole getRole() {
        return role;
    }

    @Override
    public final @NonNull PeerRole getFromPeerRole() {
        return getRole();
    }

    @Override
    public final @NonNull PeerId getFromPeerId() {
        return getPeerId();
    }
    ...
    @Override
    public final @NonNull BGPErrorHandlingState getBGPErrorHandlingState() {
        return this;
    }

    @Override
    public final @NonNull BGPAfiSafiState getBGPAfiSafiState() {
        return this;
    }

...
public final class RibImpl implements RIB, AutoCloseable {
    ...
    Boolean isGlobalEqual(final Global global) {
        ...
        final Long globalAs = global.getConfig().getAs().getValue();
        final String globalRouterId = global.getConfig().getRouterId().getValue();
    ...
    private RIBImpl createRib(final ClusterSingletonServiceProvider provider, final Global global, final String bgpInstanceName,
        ...
        this.asNumber = global.getConfig().getAs().getValue();
        this.routerId = global.getConfig().getRouterId().getValue();
        ...
        return new RIBImpl(provider, new RibId(bgpInstanceName), new AsNumber(this.asNumber), new BgpId(this.routerId), new ClusterIdentifier(this.routerId),

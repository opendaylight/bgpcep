...
public final class RibImpl implements RIB, AutoCloseable {
    ...
    public RibImpl(final ClusterSingletonServiceProvider provider, final RIBExtensionConsumerContext contextProvider,
        ...
        final SchemaService schemaService, final BGPStateFactory bgpStateFactory) {
    ...
    void start(final Global global, final String instanceName, final BGPTableTypeRegistryConsumer tableTypeRegistry,
        final BgpDeployer.WriteConfiguration configurationWriter, final BGPStateProvider bgpStateProvider, final InstanceIdentifier<Bgp> bgpIId) {
        Preconditions.checkState(this.ribImpl == null, "Previous instance %s was not closed.", this);
        this.ribImpl = createRib(global, instanceName, tableTypeRegistry, configurationWriter, bgpStateProvider, bgpIId);
    ...
    public AbstractRegistration registerNeighbor(final BGPNeighborState neighborState, final String groupId) {
        return this.ribImpl.registerNeighbor(neighborState, groupId);
    }
    ...
    private RIBImpl createRib(final Global global, final String bgpInstanceName,
        ...
        final BGPStateProvider bgpStateProvider, final InstanceIdentifier<Bgp> bgpIId) {
        ...
        return new RIBImpl(this.provider, new RibId(bgpInstanceName), this.asNumber, new BgpId(this.routerId), this.clusterId,
                ...
                this.extensions.getClassLoadingStrategy(), configurationWriter, tableTypeRegistry, bgpStateProvider,
            this.bgpStateFactory, bgpIId);
    }

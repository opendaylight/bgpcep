...
public final class RibImpl implements RIB, AutoCloseable {
    ...
    private ServiceRegistration<RibImpl> serviceRegistration;
    private ListenerRegistration<SchemaContextListener> schemaContextReistration;
    ...
    void start(final Global global, final String instanceName, final BGPOpenConfigMappingService mappingService) {
        ...
        this.schemaContextReistration = this.schemaService.registerSchemaContextListener(this.ribImpl);
    }
    ...
    public void close() {
        this.ribImpl.close();
        if (this.schemaContextReistration != null) {
            this.schemaContextReistration.close();
        }
    ...
    public void setServiceRegistration(final ServiceRegistration<RibImpl> serviceRegistration) {

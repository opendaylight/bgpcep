...
public final class RibImpl implements RIB, BGPRIBState, AutoCloseable {
    ...
    @Override
    public AbstractRegistration registerNeighborState(final BGPPeerState neighborState, final String groupId) {
        return this.ribImpl.registerNeighborState(neighborState, groupId);
    }
    ...
    private RIBImplImpl createRib(final Global global, final String bgpInstanceName,
        ...
        return new RIBImplImpl(this.provider, new RibId(bgpInstanceName), this.asNumber, new BgpId(this.routerId), this.clusterId,
    ...
    @Nonnull
    @Override
    public Map<TablesKey, Long> getPrefixesCount() {
        return this.ribImpl.getPrefixesCount();
    }

    @Nonnull
    @Override
    public Map<TablesKey, Long> getPathsCount() {
        return this.ribImpl.getPathsCount();
    }

    @Override
    public long getTotalPathsCount() {
        return this.ribImpl.getTotalPathsCount();
    }

    @Override
    public long getTotalPrefixesCount() {
        return this.ribImpl.getTotalPrefixesCount();
    }

    @Override
    public long getPathCount(final TablesKey tablesKey) {
        return this.ribImpl.getPathCount(tablesKey);
    }

    @Override
    public long getPrefixesCount(final TablesKey tablesKey) {
        return this.ribImpl.getPrefixesCount(tablesKey);
    }

    @Override
    public AsNumber getAs() {
        return this.ribImpl.getAs();
    }

    @Override
    public BgpId getRouteId() {
        return this.ribImpl.getRouteId();
    }

    @Override
    public List<BGPPeerGroupState> getPeerGroupsState() {
        return this.ribImpl.getPeerGroupsState();
    }
}

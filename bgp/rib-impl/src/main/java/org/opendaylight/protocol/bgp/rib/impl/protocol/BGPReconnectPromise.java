...
public class BGPReconnectPromise extends DefaultPromise<Void> {
    ...
    public synchronized void connect() {
        ...
        pending = this.dispatcher.createClient(this.address, cs, b, new BGPDispatcherImpl.ChannelPipelineInitializer() {
            @Override
            public void initializeChannel(final SocketChannel channel, final Promise<BGPSession> promise) {

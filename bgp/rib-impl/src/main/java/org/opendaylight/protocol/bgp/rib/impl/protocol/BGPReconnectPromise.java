...
public class BGPReconnectPromise extends DefaultPromise<Void> {
    ...
    public BGPReconnectPromise(final EventExecutor executor, final BGPAbstractDispatcher dispatcher, final InetSocketAddress address,
                               final ReconnectStrategyFactory connectStrategyFactory, final Bootstrap b, final BGPAbstractDispatcher.PipelineInitializer initializer) {
        super(executor);
        this.b = b;
    ...
    synchronized void connect() {
        ...
        pending = this.dispatcher.createClient(this.address, cs, b, new BGPAbstractDispatcher.PipelineInitializer() {
            @Override

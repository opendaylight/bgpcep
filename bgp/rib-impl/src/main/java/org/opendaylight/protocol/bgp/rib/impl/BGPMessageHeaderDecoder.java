...
final class BGPMessageHeaderDecoder extends LengthFieldBasedFrameDecoder {
    ...
    private static final RecvByteBufAllocator RECV_ALLOCATOR =
            new AdaptiveRecvByteBufAllocator().maxMessagesPerRead(1);
    // FIXME: constrain this allocator to 19-65536 range
    private static final RecvByteBufAllocator EXTENDED_RECV_ALLOCATOR =
            new AdaptiveRecvByteBufAllocator().maxMessagesPerRead(1);
    ...
    static RecvByteBufAllocator getRecvAllocator() {
        return RECV_ALLOCATOR;
    }

    static RecvByteBufAllocator getExtendedRecvAllocator() {

 ...
 */
public abstract class AbstractBGPSessionNegotiator extends ChannelInboundHandlerAdapter implements ChannelInboundHandler {
    ...
    protected void negotiationFailed(final Throwable e) {
        ...
        LOG.debug("Negotiation on channel {} failed", this.channel, e);
        this.channel.close();

...
final class AdjRibOutListener implements ClusteredDOMDataTreeChangeListener {
    ...
    public void close() {
        ...
        this.prefixesSentCounter.reset();
    }
    ...
    LongAdder getPrefixesSentCounter(){
        return this.prefixesSentCounter;
    }
}

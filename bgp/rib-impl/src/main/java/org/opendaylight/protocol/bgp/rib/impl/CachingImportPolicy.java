...
>>>>>>> c72215a... BUG-4808: Improve caching of effective attributes
 ...
 * attributes using a weak cache for fast lookup and reuse of resulting objects.
 */
@NotThreadSafe
final class CachingImportPolicy extends AbstractImportPolicy {
    ...
    ContainerNode effectiveAttributes(final ContainerNode attributes) {
        final ContainerNode cached = cache.get(attributes);
        if (cached != null) {

...
final class BGPMessageToByteEncoder extends MessageToByteEncoder<Notification<?>> {
    ...
    /**
     * Serialize a message into a new buffer. The caller hands that buffer to the channel, so netty counts the
     * real size of the message towards the watermark instead of an estimate.
     *

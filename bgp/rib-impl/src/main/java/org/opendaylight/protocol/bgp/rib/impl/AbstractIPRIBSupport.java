...
import org.opendaylight.controller.config.yang.bgp.rib.spi.RIBSupportUtil;
...
abstract class AbstractIPRIBSupport implements RIBSupport {
    ...
    public final void putRoutes(final DOMDataWriteTransaction tx, final YangInstanceIdentifier tableId, final ContainerNode nlri, final ContainerNode attributes) {
        final ContainerNode destination = RIBSupportUtil.getAdvertizedDestination(nlri, destinationIdentifier());
    ...
    public final void deleteRoutes(final DOMDataWriteTransaction tx, final YangInstanceIdentifier tableId, final ContainerNode nlri) {
        final ContainerNode destination = RIBSupportUtil.getWithdrawnDestination(nlri, destinationIdentifier());

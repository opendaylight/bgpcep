...
abstract class AbstractIPRIBSupport extends AbstractRIBSupport {
    ...
    @Override
    protected void putDestinationRoutes(final DOMDataWriteTransaction tx, final YangInstanceIdentifier routesPath, final ContainerNode destination, final ContainerNode attributes) {
        processDestination(tx, routesPath, destination, attributes, this.putRoute);
    }

    @Override
    protected void deleteDestinationRoutes(final DOMDataWriteTransaction tx, final YangInstanceIdentifier routesPath, final ContainerNode destination) {

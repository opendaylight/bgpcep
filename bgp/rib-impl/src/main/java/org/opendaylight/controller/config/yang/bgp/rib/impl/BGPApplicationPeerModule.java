...
public class BGPApplicationPeerModule extends org.opendaylight.controller.config.yang.bgp.rib.impl.AbstractBGPApplicationPeerModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        this.listenerRegistration = service.registerDataTreeChangeListener(new DOMDataTreeIdentifier(LogicalDatastoreType.CONFIGURATION, id), new ApplicationPeer(getApplicationRibId(), getBgpPeerId(), (RIBImpl) getTargetRibDependency(), new AppPeerModuleTracker(getTargetRibDependency().getOpenConfigProvider())));
    ...
    private void addToPeerRegistry() {
        ...
        final AsNumber remoteAs = r.getLocalAs();
        final List<BgpParameters> tlvs = new ArrayList<>();
        final BGPSessionPreferences prefs = new BGPSessionPreferences(r.getLocalAs(), 0, r.getBgpIdentifier(), remoteAs, tlvs);

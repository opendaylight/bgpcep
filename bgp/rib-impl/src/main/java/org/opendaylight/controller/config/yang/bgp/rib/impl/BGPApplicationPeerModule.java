...
public class BGPApplicationPeerModule extends org.opendaylight.controller.config.yang.bgp.rib.impl.AbstractBGPApplicationPeerModule {
    ...
    private final class AppPeerModuleTracker implements BGPConfigModuleTracker {
        ...
        private final BGPAppPeerInstanceConfiguration appPeerConfiguration;
        ...
        public AppPeerModuleTracker(final Optional<BGPOpenConfigProvider> openConfigProvider) {
            if (openConfigProvider.isPresent()) {
                ...
                appPeerConfiguration = new BGPAppPeerInstanceConfiguration(getIdentifier().getInstanceName(), getApplicationRibId().getValue(), getBgpPeerId());
            } else {
                appProvider = null;
                appPeerConfiguration = null;
            }
        }
        ...
        public void onInstanceCreate() {
            if (appProvider != null) {
                appProvider.writeConfiguration(appPeerConfiguration);
            }
        }
        ...
        public void onInstanceClose() {
            if (appProvider != null) {
                appProvider.removeConfiguration(appPeerConfiguration);
            }
        }

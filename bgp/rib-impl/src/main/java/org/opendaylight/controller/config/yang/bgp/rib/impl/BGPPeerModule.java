...
public final class BGPPeerModule extends org.opendaylight.controller.config.yang.bgp.rib.impl.AbstractBGPPeerModule {
    ...
    protected void customValidation() {
        ...
        final boolean iskeyConfiguredOnNonNativeTrans=getPassword().getValue() != null && Epoll.isAvailable();
        JmxAttributeValidationException.checkCondition(iskeyConfiguredOnNonNativeTrans,
                "Peer is configured with password but native transport is not available", passwordJmxAttribute);
    }

...
public class BGPPSMImplModule extends AbstractBGPPSMImplModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        return new AutoCloseableBestPathSelectionStrategy(getPathAddressFamilyDependency(), getStrategyFactoryDependency());
    }
}

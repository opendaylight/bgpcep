...
public class TestClientDispatcher {
    ...
    public synchronized Future<BGPSessionImpl> createClient(final InetSocketAddress remoteAddress,
        ...
        return disp.createClient(remoteAddress, strategy, BGPDispatcherImpl.Channelinitialization.createChannelPipelineInitializer(TestClientDispatcher.this.hf.getDecoders(), snf, TestClientDispatcher.this.hf.getEncoders()));
    }
    ...
    public synchronized Future<Void> createReconnectingClient(final InetSocketAddress address,
        ...
        final Future<Void> ret = disp.createReconnectingClient(address, reconnectStrategyFactory,
            BGPDispatcherImpl.Channelinitialization.createChannelPipelineInitializer(TestClientDispatcher.this.hf.getDecoders(), snf, TestClientDispatcher.this.hf.getEncoders()));
        return ret;
    }

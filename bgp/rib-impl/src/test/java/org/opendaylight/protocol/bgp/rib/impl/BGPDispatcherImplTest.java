...
public class BGPDispatcherImplTest {
    ...
    public void setUp() throws BGPDocumentedException {
        ...
        Mockito.doReturn(this.sessionListener).when(this.registry).getPeer(Mockito.any(IpAddress.class), Mockito.any(Ipv4Address.class), Mockito.any(Ipv4Address.class), Mockito.any(AsNumber.class));

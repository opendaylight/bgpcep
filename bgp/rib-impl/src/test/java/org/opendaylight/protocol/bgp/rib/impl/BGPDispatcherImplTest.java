...
public class BGPDispatcherImplTest {
    ...
    private static final InetSocketAddress ADDRESS = new InetSocketAddress("127.0.0.10", 1790);
    private static final Ipv4Address IPV4_ADDRESS = new Ipv4Address("127.0.0.1");
    ...
    public void setUp() {
        ...
        this.registry.addPeer(new IpAddress(new Ipv4Address(ADDRESS.getAddress().getHostAddress())), sessionListener, prefs);
        this.registry.addPeer(new IpAddress(IPV4_ADDRESS), new SimpleSessionListener(), new BGPSessionPreferences(AS_NUMBER, (short) 90, new Ipv4Address(IPV4_ADDRESS), tlvs));
    ...
    public void testCreateClient() throws InterruptedException, ExecutionException {
        ...
        Assert.assertEquals(IPV4_ADDRESS, session.getBgpId());

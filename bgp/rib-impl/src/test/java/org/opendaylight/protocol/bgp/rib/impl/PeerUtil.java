...
final class PeerUtil {
    ...
    static MpReachNlri createMpReachNlri(final IpAddress nextHop, final long pathId,
                                                final List<IpPrefix> prefixes) {
    ...
    static Update createUpdate(final BgpOrigin bgpOrigin, final List<Segments> pathSegments,

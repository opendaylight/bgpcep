...
import static org.opendaylight.protocol.bgp.rib.impl.BGPDispatcherImplTest.waitFutureSuccess;
...
public class AddPathNPathsTest extends AbstractAddPathTest {
    ...
    public void testUseCase1() throws Exception {
        ...
        final Channel session3 =createPeerSession(PEER3, PeerRole.Ibgp, nonAddPathParams, ribImpl, hf);

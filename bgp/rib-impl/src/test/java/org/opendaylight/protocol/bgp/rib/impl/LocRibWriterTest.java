...
public class LocRibWriterTest {
    ...
    @Test
    public void testFillAdjRibsOut() {
        // test simple route entries
        final NodeIdentifierWithPredicates routekey = new NodeIdentifierWithPredicates(Ipv4Route.QNAME, IPv4RIBSupport.PREFIX_QNAME, "127.0.0.1/32");
        ...
        this.locRibWriter.fillAdjRibsOut(this.domTransWrite, new SimpleRouteEntry(), DataTreeCandidateNodes.fromNormalizedNode(b.build()).getDataAfter().get(), new RouteUpdateKey(new PeerId("127.0.0.1"), YangInstanceIdentifier.of(QName.create("ipv4-route")).getLastPathArgument()));

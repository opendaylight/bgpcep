...
import org.opendaylight.protocol.bgp.state.impl.BGPStateFactoryImpl;
...
public abstract class AbstractBgpStateHandler extends AbstractDataBrokerTest {
    ...
    protected final BGPStateFactory bgpStateFactory = new BGPStateFactoryImpl();
    protected BGPNeighborState neighborState;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        this.neighborState = this.bgpStateFactory.createBGPNeighborState(NEIGHBOR_ADDRESS, AFI_SAFI, Collections.emptySet());

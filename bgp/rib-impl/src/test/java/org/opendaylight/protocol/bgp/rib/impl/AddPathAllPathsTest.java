...
public class AddPathAllPathsTest extends AbstractAddPathTest {
    ...
    public void testUseCase1() throws Exception {
        final BgpParameters nonAddPathParams = createParameter(false, false, null);
        final BgpParameters addPathParams = createParameter(true, false, null);
        ...
        final BGPPeer peer4 = configurePeer(this.tableRegistry, PEER4, this.ribImpl, nonAddPathParams,
                PeerRole.RrClient, this.serverRegistry, AFI_SAFIS_ADVERTIZED, Collections.emptySet());

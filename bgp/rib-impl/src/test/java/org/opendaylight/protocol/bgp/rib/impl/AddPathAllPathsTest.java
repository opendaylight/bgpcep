...
public class AddPathAllPathsTest extends AbstractAddPathTest {
    ...
    public void testUseCase1() throws Exception {
        ...
        assertNull(peer4State.getBGPErrorHandlingState());
        ...
        checkEquals(()-> assertEquals(1L, peer1State.getBGPSessionState().getUpdateMessagesReceivedCount()));
        checkEquals(()-> assertEquals(0L, peer1State.getBGPSessionState().getUpdateMessagesSentCount()));
        ...
        final BGPSessionState sessionState = peer4State.getBGPSessionState();
        assertEquals(0L, sessionState.getNotificationMessagesReceivedCount());
        assertEquals(0L, sessionState.getNotificationMessagesSentCount());
        assertEquals(State.UP, sessionState.getSessionState());
        assertEquals(0L, sessionState.getUpdateMessagesReceivedCount());
        assertEquals(2L, sessionState.getUpdateMessagesSentCount());

        assertFalse(sessionState.isAddPathCapabilitySupported());
        assertFalse(sessionState.isAsn32CapabilitySupported());
        assertFalse(sessionState.isGracefulRestartCapabilitySupported());
        assertTrue(sessionState.isMultiProtocolCapabilitySupported());
        assertFalse(sessionState.isRouterRefreshCapabilitySupported());

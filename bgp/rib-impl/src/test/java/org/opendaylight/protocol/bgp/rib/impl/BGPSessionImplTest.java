...
public class BGPSessionImplTest {
    ...
    public void testBGPSession() throws BGPDocumentedException {
        ...
        assertEquals(BGP_ID.getValue(), state.getLocalPeerPreferences().getBgpId());
        ...
        assertEquals(1, state.getMessagesStats().getErrorMsgs().getErrorSent().getCount().getValue().longValue());
        ...
        assertEquals(0, state.getMessagesStats().getTotalMsgs().getReceived().getCount().getValue().longValue());
        assertEquals(0, state.getMessagesStats().getTotalMsgs().getSent().getCount().getValue().longValue());
        assertEquals(0, state.getMessagesStats().getErrorMsgs().getErrorSent().getCount().getValue().longValue());
    }
    ...
    public void testHandleNotifyMsg() throws BGPDocumentedException {
        ...
        assertEquals(1, this.bgpSession.getBgpSessionState().getMessagesStats().getErrorMsgs().getErrorReceived().getCount().getValue().longValue());
        assertEquals(BGPError.BAD_BGP_ID.getCode(), this.bgpSession.getBgpSessionState().getMessagesStats().getErrorMsgs().getErrorReceived().getCode().shortValue());
        assertEquals(BGPError.BAD_BGP_ID.getSubcode(), this.bgpSession.getBgpSessionState().getMessagesStats().getErrorMsgs().getErrorReceived().getSubCode().shortValue());
        Assert.assertEquals(BGPSessionImpl.State.IDLE, this.bgpSession.getState());
        Mockito.verify(this.speakerListener).close();
    }

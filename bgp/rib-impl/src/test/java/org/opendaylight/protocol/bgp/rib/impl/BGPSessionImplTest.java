...
public class BGPSessionImplTest {
    ...
    public void testBGPSession() throws BGPDocumentedException {
        ...
        assertEquals(BGP_ID.getValue(), new String(state.getPeerPreferences().getHost().getValue()));
        ...
        assertEquals(HOLD_TIMER, state.getPeerPreferences().getHoldtimer().intValue());
        ...
        assertEquals(LOCAL_IP, new String(state.getSpeakerPreferences().getHost().getValue()));
        assertEquals(LOCAL_PORT, state.getSpeakerPreferences().getPort().getValue().intValue());
    ...
    public void testHandleNotifyMsg() throws BGPDocumentedException {
        ...
        assertEquals(1, this.bgpSession.getBgpSesionState().getMessagesStats().getErrorMsgs().getErrorReceived().getCount().getValue().longValue());

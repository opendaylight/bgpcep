...
public class AppPeerTest extends AbstractConfig {
    ...
    public void testAppPeer() {
        ...
        Mockito.verify(this.rib).createPeerDOMChain(any(TransactionChainListener.class));
        ...
        Mockito.verify(this.rib, times(2)).createPeerDOMChain(any(TransactionChainListener.class));
        ...
        Mockito.verify(this.rib, times(4)).createPeerDOMChain(any(TransactionChainListener.class));
        ...
        APP_PEER.instantiateServiceInstance();
        Mockito.verify(this.rib, times(6)).createPeerDOMChain(any(TransactionChainListener.class));
        APP_PEER.closeServiceInstance();

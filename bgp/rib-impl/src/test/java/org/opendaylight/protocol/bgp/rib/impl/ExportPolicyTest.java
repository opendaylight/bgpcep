...
public class ExportPolicyTest {
    ...
    public void testEbgpEffectiveAttributes() {
        ...
        assertEquals(clusterIn, this.REF_POLICY.effectiveAttributes(peerRole, clusterIn));
        assertEquals(clusterIn, this.INT_POLICY.effectiveAttributes(peerRole, clusterIn));

        final ContainerNode asPathIn = createPathInput(null);
        assertEquals(createPathInputWithAs(), this.EXT_POLICY.effectiveAttributes(peerRole, asPathIn));
    }
    ...
    public void testIbgpEffectiveAttributes() {
        ...
        assertEquals(createInputWithOriginator(), this.REF_POLICY.effectiveAttributes(peerRole, clusterIn));
        assertEquals(null, this.INT_POLICY.effectiveAttributes(peerRole, clusterIn));
    ...
    public void testRrClientEffectiveAttributes() {
        ...
        assertEquals(createInputWithOriginator(), this.REF_POLICY.effectiveAttributes(peerRole, clusterIn));
        assertEquals(createInputWithOriginator(), this.INT_POLICY.effectiveAttributes(peerRole, clusterIn));

...
public final class IPv6RIBSupportTest extends AbstractRIBSupportTest {
    ...
    public void testEmptyRoute() throws Exception {
        final Routes empty = new Ipv6RoutesCaseBuilder().setIpv6Routes(new Ipv6RoutesBuilder().setIpv6Route(Collections.emptyList()).build()).build();
    ...
    public void testBuildMpUnreachNlriUpdate() {
        final Update update = RIB_SUPPORT.buildUpdate(Collections.emptyList(), createRoutes(
            new Ipv6RoutesBuilder().setIpv6Route(Collections.singletonList(ROUTE)).build()), ATTRIBUTES);
    ...
    public void testBuildMpReachNlriUpdate() {
        final Update update = RIB_SUPPORT.buildUpdate(createRoutes(
            new Ipv6RoutesBuilder().setIpv6Route(Collections.singletonList(ROUTE)).build()), Collections.emptyList(), ATTRIBUTES);
    ...
    public void testRouteIdAddPath() {
        final NodeIdentifierWithPredicates expected = createRouteNIWP(new Ipv6RoutesBuilder().setIpv6Route(Collections.singletonList(ROUTE)).build());
    ...
    public void testRoutePath() {
        final NodeIdentifierWithPredicates prefixNii = createRouteNIWP(new Ipv6RoutesBuilder().setIpv6Route(Collections.singletonList(ROUTE)).build());
    ...
    public void testChangedRoutes() {
        ...
        final Routes routes = new Ipv6RoutesCaseBuilder().setIpv6Routes(new Ipv6RoutesBuilder().setIpv6Route(Collections.singletonList(ROUTE)).build()).build();

...
public class Bgpcep1078Test extends AbstractRIBTestSetup {
    ...
    private AdvertizedRoute advRoute;
    ...
    public void rewrittenRouteIsNotSharedAcrossPeers() {
        ...
        doAnswer(inv -> {
            ...
            return rewrittenFor.equals(params.getToPeerId())
    ...
    private void exportUnchanged() {
        doAnswer(inv -> inv.getArgument(1)).when(routingPolicies)
    ...
    private AdvertizedRoute routeWithLocalPref(final Uint32 localPref) {

...
public final class CheckUtil {
    ...
    public static void checkRestartState(final BGPPeer peer, final int restartTimeSeconds) {
        final long restartTimeNanos = TimeUnit.SECONDS.toNanos(restartTimeSeconds);
        final Stopwatch sw = Stopwatch.createStarted();

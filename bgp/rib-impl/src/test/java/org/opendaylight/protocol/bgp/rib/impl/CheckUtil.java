...
public final class CheckUtil {
    ...
    public static void checkState(final Object object, final State state,
                                  final Function<Object, State> function) {
        checkInLoop(state, object, function, 50, 10);
    }

    private static void checkInLoop(final State state, final Object object, final Function<Object, State> function,

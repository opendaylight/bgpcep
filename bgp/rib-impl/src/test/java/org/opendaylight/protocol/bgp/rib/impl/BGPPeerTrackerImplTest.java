...
public class BGPPeerTrackerImplTest {
    ...
    @Test
    public void testClosingRegistrationRemovesPeerFromSnapshots() {
    ...
    @Test
    public void testInternalPeerExcludedFromNonInternalPeers() {
        stubPeer(peerA, PEER_A, PeerRole.Ebgp);
    ...
    @Test
    public void testEmptyTrackerReturnsEmptySnapshots() {

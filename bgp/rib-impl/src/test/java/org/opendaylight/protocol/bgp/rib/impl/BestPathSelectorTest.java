...
public class BestPathSelectorTest {
    ...
    public void testExtractSegments() {
        ...
        final UnkeyedListNode segmentsList = Builders.unkeyedListBuilder().withNodeIdentifier(SEGMENTS_NID)
            .addChild(SET_SEGMENT)
            .addChild(LIST_SEGMENT)
            .build();
        ...
        // test
        final List<Segments> actual = this.state.extractSegments(segmentsList);

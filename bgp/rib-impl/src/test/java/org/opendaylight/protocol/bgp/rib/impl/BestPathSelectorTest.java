...
public class BestPathSelectorTest {
    ...
    private DataContainerNodeAttrBuilder<NodeIdentifier, ContainerNode> localPrefContBuilder;
    private ImmutableLeafNodeBuilder<Long> prefBuilder;
    private DataContainerNodeAttrBuilder<NodeIdentifier, ContainerNode> medContBuilder;
    private ImmutableLeafNodeBuilder<Long> medBuilder;
    private DataContainerNodeAttrBuilder<NodeIdentifier, ContainerNode> originContBuilder;
    private ImmutableLeafNodeBuilder<String> valueBuilder;
    ...
    private ContainerNode createStateFromPrefMedOrigin() {
        dataContBuilder = ImmutableContainerNodeSchemaAwareBuilder.create();
        dataContBuilder.withNodeIdentifier(new NodeIdentifier(QName.create("data")));
        // local pref
        localPrefContBuilder = ImmutableContainerNodeSchemaAwareBuilder.create();
        localPrefContBuilder.withNodeIdentifier(new NodeIdentifier(LocalPref.QNAME));

        prefBuilder = new ImmutableLeafNodeBuilder<>();
        ...
        // multi exit disc
        medContBuilder = ImmutableContainerNodeSchemaAwareBuilder.create();
        medContBuilder.withNodeIdentifier(new NodeIdentifier(MultiExitDisc.QNAME));

        medBuilder = new ImmutableLeafNodeBuilder<>();
        ...
        // origin
        originContBuilder = ImmutableContainerNodeSchemaAwareBuilder.create();
        originContBuilder.withNodeIdentifier(new NodeIdentifier(Origin.QNAME));

        valueBuilder = new ImmutableLeafNodeBuilder<>();

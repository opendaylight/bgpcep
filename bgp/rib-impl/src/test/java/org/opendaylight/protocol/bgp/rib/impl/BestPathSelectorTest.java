...
//        segmentBuilder.withNodeIdentifier(SEGMENTS_NID);
        //?
...
//        segmentBuilder.addChild(SEQ_SEGMENT);
        segments.addChild(SEQ_SEGMENT);
...
//        segmentsBuilder.withNodeIdentifier(SEGMENTS_NID);
//        segmentsBuilder.addChild(SET_SEGMENT);
//        segmentsBuilder.addChild(SEQ_SEGMENT);
//
//        final DataContainerNodeAttrBuilder<NodeIdentifier, ContainerNode> asPathContBuilder = ImmutableContainerNodeSchemaAwareBuilder.create();
//        asPathContBuilder.withNodeIdentifier(new NodeIdentifier(this.asPathQName)).addChild(segmentsBuilder.build());
...
//    @Test
//    public void testAsPathSegmentsResolve() {
//        final CollectionNodeBuilder<UnkeyedListEntryNode, UnkeyedListNode> segmentsBuilder = Builders.unkeyedListBuilder();
//        segmentsBuilder.withNodeIdentifier(SEGMENTS_NID);
//        segmentsBuilder.addChild(SET_SEGMENT);
//        segmentsBuilder.addChild(SEQ_SEGMENT);
...
//        final DataContainerNodeAttrBuilder<NodeIdentifier, ContainerNode> asPathContBuilder = ImmutableContainerNodeSchemaAwareBuilder.create();
//        asPathContBuilder.withNodeIdentifier(new NodeIdentifier(this.asPathQName)).addChild(segmentsBuilder.build());
//        final BestPathState pathState = new BestPathState(asPathContBuilder.build());
////        assertEquals(10L, pathState.getPeerAs());
//        assertEquals(4, pathState.getAsPathLength());
//    }
}

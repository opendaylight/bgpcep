...
public class BestPathSelectorTest {
    ...
    private final String KEY = "ROUTER_ID1";
    private final String KEY2 = "ROUTER_ID2";
    private final String KEY3 = "ROUTER_ID3";
    ...
    public void testBestPathForEquality() {
        this.selector.processPath(this.ROUTER_ID2, createStateFromPrefMedOriginASPath(), KEY2, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);
        final BestPath processedPath = this.selector.result();

        assertEquals(KEY2, processedPath.getKey());
    ...
    public void testBestPathWithHigherLocalPref() {
        this.selector.processPath(this.ROUTER_ID2, createStateFromPrefMedOrigin(), KEY2, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);//local-pref 123
        BestPath processedPath = this.selector.result();
        assertEquals(123L, processedPath.getState().getLocalPref().longValue());

        this.selector.processPath(this.ROUTER_ID2, createStateFromPrefMedOriginASPath(), KEY2, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);   // local-pref 321
        ...
        this.selector.processPath(this.ROUTER_ID2, this.dataContBuilder.build(), KEY2, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);
        processedPath = this.selector.result();
        assertEquals(321L, processedPath.getState().getLocalPref().longValue());
    }
    ...
    public void testBestPathForNonEquality() {
        this.selector.processPath(this.ROUTER_ID3, createStateFromPrefMedOrigin(), KEY3, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);
        final BestPath processedPath = this.selector.result();
    ...
    public void testBgpOrigin() {
        ...
        this.selector.processPath(this.ROUTER_ID3, containerIncom, KEY3, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);
        ...
        this.selector.processPath(this.ROUTER_ID3, containerException, KEY3, BEST_OFFSET_POSITON, BEST_PATH_ID, PREFIX);

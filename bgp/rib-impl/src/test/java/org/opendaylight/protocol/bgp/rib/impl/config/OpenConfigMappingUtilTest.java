...
public class OpenConfigMappingUtilTest {
    ...
    private class RibMock implements RIB {
    ...
    public void testIsActive() throws Exception {
        assertEquals(true, OpenConfigMappingUtil.isActive(new NeighborBuilder().build()));
        assertEquals(true, OpenConfigMappingUtil.isActive(new NeighborBuilder().setTransport(new TransportBuilder().build()).build()));
        assertEquals(true, OpenConfigMappingUtil.isActive(new NeighborBuilder().setTransport(createTransport()).build()));
    }

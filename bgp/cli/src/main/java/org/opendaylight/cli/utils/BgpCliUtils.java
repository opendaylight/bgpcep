...
public final class BgpCliUtils{
    ...
    public static void displayAll(final BgpSessionState bgpSessionState, final PrintStream printStream) throws IOException, JMException {
        ...
        //Messages Stats
        table.addRow().addContent("MessagesStats.ErrorMsgsSent", bgpSessionState.getMessagesStats().getErrorMsgs().getErrorSent().getCount());
        table.addRow().addContent("MessagesStats.ErrorMsgsReceived", bgpSessionState.getMessagesStats().getErrorMsgs().getErrorReceived().getCount());
        table.addRow().addContent("MessagesStats.KeepAliveMsgsSent", bgpSessionState.getMessagesStats().getKeepAliveMsgs().getSent().getCount());
        table.addRow().addContent("MessagesStats.KeepAliveMsgsReceived", bgpSessionState.getMessagesStats().getKeepAliveMsgs().getReceived().getCount());
        table.addRow().addContent("MessagesStats.TotalMsgsSent", bgpSessionState.getMessagesStats().getTotalMsgs().getSent().getCount());
        table.addRow().addContent("MessagesStats.TotalMsgsReceived", bgpSessionState.getMessagesStats().getTotalMsgs().getReceived().getCount());
        table.addRow().addContent("MessagesStats.UpdateMsgsSent", bgpSessionState.getMessagesStats().getUpdateMsgs().getSent().getCount());
        table.addRow().addContent("MessagesStats.UpdateMsgsReceived", bgpSessionState.getMessagesStats().getUpdateMsgs().getReceived().getCount());

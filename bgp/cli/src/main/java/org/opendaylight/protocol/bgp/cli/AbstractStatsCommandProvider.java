...
public abstract class AbstractStatsCommandProvider extends OsgiCommandSupport {
    ...
    protected abstract void onExecution(@Nonnull PrintStream out, @Nonnull BGPPeerRuntimeMXBean peerRuntimeMXBean, @Nonnull ObjectName objectName) throws IOException, JMException;

...
public final class BgpCliUtils{
    ...
    public static void displayAll(final ObjectName objectName, final BgpSessionState bgpSessionState, final PrintStream printStream) {
        ...
        table.addRow().addContent(MESSAGE_STATS_LABEL + "ErrorMsgsSent", messageStats.getErrorMsgs().getErrorSent().getCount());
        table.addRow().addContent(MESSAGE_STATS_LABEL + "ErrorMsgsReceived", messageStats.getErrorMsgs().getErrorReceived().getCount());
        ...
        //Peer Preferences
        final PeerPreferences peerPreferences = bgpSessionState.getPeerPreferences();
        table.addRow().addContent(PEER_PREFERENCES_LABEL + "AddPathCapability", peerPreferences.getAddPathCapability());
        table.addRow().addContent(PEER_PREFERENCES_LABEL + "Address", peerPreferences.getAddress());
        ...
        table.addRow().addContent(PEER_PREFERENCES_LABEL + "Holdtime", peerPreferences.getHoldtime());
        ...
        //Speaker Preferences
        final SpeakerPreferences speakerPreferences = bgpSessionState.getSpeakerPreferences();
        table.addRow().addContent(SPEAKER_PREFERENCES_LABEL + "AddPathCapability", speakerPreferences.getAddPathCapability());
        table.addRow().addContent(SPEAKER_PREFERENCES_LABEL + "Address", speakerPreferences.getAddress());
        ...
        table.addRow().addContent(SPEAKER_PREFERENCES_LABEL + "Holdtime", speakerPreferences.getHoldtime());

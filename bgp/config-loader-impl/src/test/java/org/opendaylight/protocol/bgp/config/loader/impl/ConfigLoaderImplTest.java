...
public class ConfigLoaderImplTest extends AbstractConfigLoader {
    @Mock
    private ConfigFileProcessor processor;
    ...
    public void setUp() throws Exception {
        ...
        doNothing().when(this.processor).loadConfiguration(any());
        doReturn("processor").when(this.processor).toString();
    }

    @Override
    protected String getResourceFolder() {
        return getClass().getClassLoader().getResource("etc/opendaylight/bgp").getPath();
    }
    ...
    public void configLoaderImplTest() throws Exception {
        ...
        this.newFileFunctionHandler.apply("protocols-config.xml");

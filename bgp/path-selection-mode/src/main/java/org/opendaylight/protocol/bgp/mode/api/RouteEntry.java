...
import org.opendaylight.protocol.bgp.rib.spi.policy.AdvertizedBesthPathContainer;
...
public interface RouteEntry {
     ...
     * @deprecated Use {@link #updateBestPath(RouteEntryDependenciesContainer, PathArgument, DOMDataWriteTransaction)}
     */
    @Deprecated
     ...
     * @param ribSupport rib support
     * @param tx         DOM transaction
     * @deprecated Use {@link #advertizeBestPath(RouteEntryDependenciesContainer, org.opendaylight.protocol.bgp.rib.spi.policy.AdvertizedBesthPathContainer,
     ...
     * @param tx                     DOM transaction
     */
    default void updateBestPath(
        @Nonnull RouteEntryDependenciesContainer routeEntryDependencies,
        @Nonnull PathArgument rootPath,
     ...
     * This is the first step once session is established and before any route provided by peer is processed.
     *
     * @param routeEntryDependencies  RouteEntry Dependencies
     * @param routeAttributeContainer containing information from route
     * @param tx                      DOM transaction
     */
    default void advertizeBestPath(
        @Nonnull RouteEntryDependenciesContainer routeEntryDependencies,
        @Nonnull AdvertizedBesthPathContainer routeAttributeContainer,
        @Nonnull DOMDataWriteTransaction tx) {
        //TBD
    }
}
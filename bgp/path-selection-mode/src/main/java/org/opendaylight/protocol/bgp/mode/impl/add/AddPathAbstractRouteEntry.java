...
public abstract class AddPathAbstractRouteEntry extends AbstractRouteEntry {
    ...
    private void fillAdjRibsOut(final boolean isFirstBestPath, final ContainerNode attributes,
            final MapEntryNode defaultValue, final MapEntryNode addPathValue, final PathArgument routeIdAddPathDefault,
        ...
        for (final PeerRole role : PeerRole.values()) {
            ...
            if (peerGroup != null) {
                final ContainerNode effectiveAttributes
                        = peerGroup.effectiveAttributes(getRoutePeerIdRole(peerPT, routePeerId), attributes);

...
public abstract class AddPathAbstractRouteEntry extends AbstractRouteEntry<AddPathBestPath> {
    ...
    public void updateBestPaths(
        ...
        if (this.bestPathRemoved != null) {
            this.bestPathRemoved.forEach(path -> {
                final Identifier newRouteKey = ribSupport.createNewRouteIdentifier(path.getPathId(), routeKey);
        ...
        if (this.removedPaths != null) {
            this.removedPaths.forEach(removedPath -> {
                final Identifier routeKeyAddPath
                        = ribSupport.createNewRouteIdentifier(removedPath.getPathId(), routeKey);
                final Identifier routeKeyNonAddPath = ribSupport.createNewRouteIdentifier(NON_PATH_ID_VALUE, routeKey);
    ...
    private void writeRoutePath(final RouteEntryInfo entryInfo,
        ...
        Identifier newRouteKey = ribSupport.createNewRouteIdentifier(destPeerSupAddPath
    ...
    private void addPathToDataStore(
        ...
        final Identifier routeKeyAddPath = ribSup.createNewRouteIdentifier(path.getPathId(), routeKey);
        final Identifier routeKeyAddNonPath = ribSup.createNewRouteIdentifier(NON_PATH_ID_VALUE, routeKey);

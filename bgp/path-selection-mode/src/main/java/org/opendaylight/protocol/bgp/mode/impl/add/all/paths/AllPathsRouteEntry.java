...
final class AllPathsRouteEntry<C extends Routes & DataObject & ChoiceIn<Tables>, S extends ChildOf<? super C>,
    ...
    private void addPath(final Builder<AddPathBestPath> builder, final int offset) {
        final Route route = verifyNotNull(offsets.getValue(values, offset));
        builder.add(new AddPathBestPath(new BestPathStateImpl(route.getAttributes()), offsets.getKey(offset),

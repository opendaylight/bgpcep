...
public class BaseRouteEntryTest {
    ...
    // Raw types: BaseRouteEntry is generic over the YANG-generated route container, which is irrelevant here -- the
    // RIBSupport mock supplies the attributes directly, so binding a concrete type only adds noise.
    @SuppressWarnings({ "rawtypes", "unchecked" })
    private final RIBSupport ribSupport = mock(RIBSupport.class);
    @SuppressWarnings({ "rawtypes", "unchecked" })

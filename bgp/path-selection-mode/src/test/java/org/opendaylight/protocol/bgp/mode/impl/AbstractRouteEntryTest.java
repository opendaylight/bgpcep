...
public class AbstractRouteEntryTest {
    ...
    private YangInstanceIdentifier loc_rib_target_yii;
    private YangInstanceIdentifier loc_rib_out_target_yii;
    protected YangInstanceIdentifier route_pa_yii;
    protected YangInstanceIdentifier route_pa_add_path_yii;
    protected YangInstanceIdentifier route_ribout_yii;
    protected YangInstanceIdentifier route_add_ribout_yii;
    protected YangInstanceIdentifier route_ribout_att_yii;
    protected YangInstanceIdentifier route_add_ribout_att_yii;
    private YangInstanceIdentifier loc_rib_out_target_yii_peer2;
    protected YangInstanceIdentifier route_ribout_att_yii_peer2;
    protected YangInstanceIdentifier route_ribout_yii_peer2;
    ...
    protected void setUp() {
        ...
        this.loc_rib_target_yii = LOC_RIB_TARGET.node(ROUTES_IDENTIFIER);
        this.loc_rib_out_target_yii = PEER_YII.node(AdjRibOut.QNAME).node(Tables.QNAME).node(RibSupportUtils.toYangTablesKey(TABLES_KEY)).node(ROUTES_IDENTIFIER);
        this.route_pa_yii = loc_rib_target_yii.node(ROUTE_ID_PA);
        this.route_pa_add_path_yii = loc_rib_target_yii.node(ROUTE_ID_PA_ADD_PATH);
        this.route_ribout_yii = loc_rib_out_target_yii.node(ROUTE_ID_PA);
        this.route_add_ribout_yii = loc_rib_out_target_yii.node(ROUTE_ID_PA_ADD_PATH);
        this.route_ribout_att_yii = loc_rib_out_target_yii.node(ROUTE_ID_PA).node(ATTRS_EXTENSION_Q);
        this.route_add_ribout_att_yii = loc_rib_out_target_yii.node(ROUTE_ID_PA_ADD_PATH).node(ATTRS_EXTENSION_Q);

        this.loc_rib_out_target_yii_peer2 = PEER_YII2.node(AdjRibOut.QNAME).node(Tables.QNAME).node(RibSupportUtils.toYangTablesKey(TABLES_KEY)).node(ROUTES_IDENTIFIER);
        this.route_ribout_yii_peer2 = loc_rib_out_target_yii_peer2.node(ROUTE_ID_PA);
        this.route_ribout_att_yii_peer2 = loc_rib_out_target_yii_peer2.node(ROUTE_ID_PA).node(ATTRS_EXTENSION_Q);
        mockRibSupport();
        mockExportPolicies();
        mockExportGroup();
    ...
    private void mockTransactionChain() {
        ...
        Mockito.doAnswer(new Answer<Object>() {
            ...
            public Object answer(final InvocationOnMock invocation) throws Throwable {
                final Object[] args = invocation.getArguments();
                if (route_pa_yii.equals(args[1])) {
                    yIIChanges.remove(route_pa_yii);
                } else if(route_ribout_yii.equals(args[1])) {
                    yIIChanges.remove(route_ribout_yii);
                    yIIChanges.remove(route_add_ribout_att_yii);
    ...
    private void mockRibSupport() {
        ...
        Mockito.doAnswer(new Answer<Object>() {
            ...
            public Object answer(final InvocationOnMock invocation) throws Throwable {
                ...
                if (ROUTE_ID_PA.equals(paa) && yii.equals(loc_rib_target_yii)) {
                    return route_pa_yii;
                } else if (ROUTE_ID_PA_ADD_PATH.equals(paa) && yii.equals(loc_rib_target_yii)) {
                    return route_pa_add_path_yii;
                } else if (ROUTE_ID_PA.equals(paa) && yii.equals(loc_rib_out_target_yii)) {
                    return route_ribout_yii;
                } else if (ROUTE_ID_PA_ADD_PATH.equals(paa) && yii.equals(loc_rib_out_target_yii)) {
                    return route_add_ribout_yii;
                } else if (ROUTE_ID_PA.equals(paa) && yii.equals(loc_rib_out_target_yii_peer2)) {
                    return route_ribout_yii_peer2;
                }

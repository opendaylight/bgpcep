 ...
 */
public final class SourceTreeJoinHandler extends AbstractCMulticast<SourceTreeJoinCase> {
    @Override
    public int getType() {
    ...
    public SourceTreeJoinCase parseMvpn(final ByteBuf buffer) {
        return new SourceTreeJoinCaseBuilder().setCMulticast(parseCMulticastGrouping(buffer)).build();
    }

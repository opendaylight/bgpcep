 ...
 */
abstract class AbstractCMulticast<T extends MvpnChoice> extends AbstractMvpnNlri<T> {

    final CMulticast parseCMulticastGrouping(final ByteBuf buffer) {
    ...
    ByteBuf serializeCMulticast(final CMulticast route) {

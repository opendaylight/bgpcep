...
import org.opendaylight.protocol.bgp.mvpn.impl.attributes.tunnel.identifier.TunnelIdentifierHandler;
...
public class PMSITunnelAttributeHandlerTest {
    ...
    public void testTunnelIdentifierUtil() {
        ...
        assertEquals(TunnelIdentifierHandler.NO_TUNNEL_INFORMATION_PRESENT, tunnelIdentifierHandler
                .serialize(new PMSITunnelAttributeHandlerTestUtil.MockTunnelIdentifier(), Unpooled.buffer()));
    }

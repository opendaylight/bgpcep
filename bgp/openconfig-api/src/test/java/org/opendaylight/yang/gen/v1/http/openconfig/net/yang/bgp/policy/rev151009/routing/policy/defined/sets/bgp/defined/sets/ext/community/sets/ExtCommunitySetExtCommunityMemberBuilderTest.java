...
public class ExtCommunitySetExtCommunityMemberBuilderTest {
    ...
    public void testExtCommunity() {
        final ExtCommunityMember extCommMemeber = ExtCommunitySetExtCommunityMemberBuilder.getDefaultInstance("route-origin:12.34.56.78:123");
        Assert.assertEquals("route-origin:12.34.56.78:123", extCommMemeber.getBgpExtCommunityType().getString());
    }

...
public class Ipv6ReachabilityTopologyBuilderTest extends AbstractTopologyBuilderTest {
    ...
    private static final long ROUTE_IP6PATH_ID= 1;
    ...
    protected void setupWithDataBroker(final DataBroker dataBroker) {
        ...
        this.ipv6RouteIID = path.builder().child((Class)Ipv6Routes.class).child(Ipv6Route.class, new Ipv6RouteKey(new PathId(ROUTE_IP6PATH_ID),
    ...
    public Ipv6Route createIpv6Route(final String netxHop) {
        final Attributes attribute = new AttributesBuilder()
            ...
            .build();
        return new Ipv6RouteBuilder().setKey(new Ipv6RouteKey(new PathId(ROUTE_IP6PATH_ID), new Ipv6Prefix(ROUTE_IP6PREFIX)))

...
public class Ipv6TologyProviderTest extends AbstractBgpTopologyProviderTest {
    private Ipv6TopologyProvider ipv6TopologyProvider;
    @Before
    @Override
    public void setUp() {
        super.setUp();
        this.ipv6TopologyProvider = new Ipv6TopologyProvider(this.bgpTopologyDeployer);
    }

    @Test
    public void testCreatedIpv6TopologyProvider() throws Exception {
        assertNotNull(this.ipv6TopologyProvider);
    }
    ...
    public void testTopologyTypeFilter() throws Exception {
        ...
        topologyBuilder.setTopologyTypes(Ipv6ReachabilityTopologyBuilder.IPV6_TOPOLOGY_TYPE);
        ...
        boolean result = this.ipv6TopologyProvider.topologyTypeFilter(this.topologyTypes1Builder.build());
        assertFalse(result);
        result = this.ipv6TopologyProvider.topologyTypeFilter(topology);
        assertTrue(result);
    }
}

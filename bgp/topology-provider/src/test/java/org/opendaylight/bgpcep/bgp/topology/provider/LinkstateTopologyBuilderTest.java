...
public class LinkstateTopologyBuilderTest extends AbstractTopologyBuilderTest {
    ...
    public void testLinkstateTopologyBuilderTopologyTypes() {
        ...
        assertNotNull(topology.getTopologyTypes().getAugmentation(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev150210.TopologyTypes1.class));
        assertNotNull(topology.getTopologyTypes().getAugmentation(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.bgp.linkstate.rev150210.TopologyTypes1.class).getBgpLinkstateTopology());
    }

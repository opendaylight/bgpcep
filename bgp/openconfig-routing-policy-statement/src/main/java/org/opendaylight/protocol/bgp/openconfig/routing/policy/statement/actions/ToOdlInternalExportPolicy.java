 ...
 */
public final class ToOdlInternalExportPolicy extends AbstractReflectingExportPolicy {
    @Override
    public ContainerNode applyExportAction(final long localAs, final Ipv4Address originatorId,
        final ClusterIdentifier clusterId, final YangInstanceIdentifier.PathArgument routeKey,
        final PeerId fromPeerId, final PeerRole fromPeerRole, final PeerId toPeer, final PeerRole toPeerRole,
        final ContainerNode attributes, final Augmentation<Actions> action) {
        return null;
    }
}
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.AssociationType;
...
public final class AssociationObjectParserType1 extends AbstractBGPObjectParser {
    ...
    protected RsvpTeObject localParseObject(final ByteBuf byteBuf) throws RSVPParsingException {
        ...
        asso.setIpAddress(new IpAddress(Ipv4Util.addressForByteBuf(byteBuf)));
        return asso.build();
    }

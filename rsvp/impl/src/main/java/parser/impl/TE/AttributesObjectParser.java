...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.rsvp.rev130820.attribute.flags.FlagContainerBuilder;
...
public final class AttributesObjectParser extends AbstractBGPObjectParser {
    ...
    protected static List<FlagContainer> parseFlag(final ByteBuf byteBuf) {
        ...
        while (byteBuf.isReadable()) {
            ...
            FlagContainerBuilder flagBuilder = new FlagContainerBuilder().setFlags(value);

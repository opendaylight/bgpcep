 ...
 */
public class SERODynamicProtectionSubobjectParser extends AbstractProtectionParser implements EROSubobjectSerializer {
    ...
    public void serializeSubobject(final SubobjectContainer subobject, final ByteBuf buffer) {
        ...
        final ProtectionSubobject protObj = ((DynamicControlProtectionCase) subobject.getSubobjectType()).getProtectionSubobject();

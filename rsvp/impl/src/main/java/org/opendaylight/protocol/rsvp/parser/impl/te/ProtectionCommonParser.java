...
public class ProtectionCommonParser {
    ...
    final protected static void serializeBodyType1(final ProtectionSubobject protObj, final ByteBuf output) {
    ...
    final protected static void serializeBodyType2(final ProtectionSubobject protObj, final ByteBuf output) {
        final BitArray flagBitArray = new BitArray(FLAGS_SIZE);
        flagBitArray.set(SECONDARY, protObj.isSecondary());
    ...
    final protected static ProtectionSubobject parseCommonProtectionBodyType2(final ByteBuf byteBuf) throws RSVPParsingException {
    ...
    final protected static ProtectionSubobject parseCommonProtectionBodyType1(final ByteBuf byteBuf) {
    ...
    final protected void serializeBody(final Short cType, final ProtectionSubobject protObj, final ByteBuf output) {
        output.writeZero(BYTE_SIZE);
    ...
    final protected ProtectionSubobject parseCommonProtectionBody(final short cType, final ByteBuf byteBuf) throws RSVPParsingException {

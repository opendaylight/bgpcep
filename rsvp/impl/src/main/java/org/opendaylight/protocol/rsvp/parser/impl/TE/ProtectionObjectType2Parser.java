...
public final class ProtectionObjectType2Parser extends AbstractRSVPObjectParser {
    ...
    protected RsvpTeObject localParseObject(final ByteBuf byteBuf) throws RSVPParsingException {
        DynamicControlProtectionObjectBuilder builder = new DynamicControlProtectionObjectBuilder();

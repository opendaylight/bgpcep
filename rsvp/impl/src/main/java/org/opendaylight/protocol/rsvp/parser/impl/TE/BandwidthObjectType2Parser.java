...
public final class BandwidthObjectType2Parser extends AbstractRSVPObjectParser {
    ...
    public void localSerializeObject(final RsvpTeObject teLspObject, final ByteBuf output) {
        ...
        serializeAttributeHeader(BandwidthObjectType1Parser.BODY_SIZE, CLASS_NUM, CTYPE, output);

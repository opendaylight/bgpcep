...
public final class SessionAttributeObjectType1Parser extends AbstractRSVPObjectParser {
    ...
    protected RsvpTeObject localParseObject(final ByteBuf byteBuf) throws RSVPParsingException {
        ...
        builder.setLocalProtectionDesired(bs.get(SessionAttributeObjectType7Parser.LOCAL_PROTECTION));
        builder.setLabelRecordingDesired(bs.get(SessionAttributeObjectType7Parser.LABEL_RECORDING));
        builder.setSeStyleDesired(bs.get(SessionAttributeObjectType7Parser.SE_STYLE));
    ...
    public void localSerializeObject(final RsvpTeObject teLspObject, final ByteBuf output) {
        ...
        final int pad = SessionAttributeObjectType7Parser.getPadding(sessionName.readableBytes());
        ...
        bs.set(SessionAttributeObjectType7Parser.LOCAL_PROTECTION, sessionObject.isLocalProtectionDesired());
        bs.set(SessionAttributeObjectType7Parser.LABEL_RECORDING, sessionObject.isLabelRecordingDesired());
        bs.set(SessionAttributeObjectType7Parser.SE_STYLE, sessionObject.isSeStyleDesired());
        bs.toByteBuf(output);

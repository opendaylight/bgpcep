...
import org.opendaylight.controller.config.yang.rsvp.parser.spi.SimpleRSVPExtensionProviderContextModuleFactory;
import org.opendaylight.controller.config.yang.rsvp.parser.spi.SimpleRSVPExtensionProviderContextModuleMXBean;
...
public class SimpleRSVPExtensionProviderContextModuleTest extends AbstractConfigTest {
    ...
    public static ObjectName createSimpleBmpExtensionProviderContextModuleInstance(final ConfigTransactionJMXClient transaction, final List<ObjectName> extensions) throws Exception {

...
class XROSubobjectListParserTest {

    private final XROSubobjectRegistry registry = mock(XROSubobjectRegistry.class);
    private final SubobjectContainer subObj = mock(SubobjectContainer.class);
    private final XroListParser parser = new XroListParser(registry);
    ...
    private static class XroListParser extends XROSubobjectListParser {

...
public abstract class AbstractProtectionParser {
    ...
    protected ProtectionSubobject parseCommonProtectionBody(final ByteBuf byteBuf) throws RSVPParsingException {
        //skip reserved
        byteBuf.readByte();
    ...
    public static ProtectionSubobject parseCommonProtectionBodyType2(final ByteBuf byteBuf) throws RSVPParsingException {

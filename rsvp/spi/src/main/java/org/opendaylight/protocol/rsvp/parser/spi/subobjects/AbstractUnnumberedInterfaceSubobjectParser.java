...
public abstract class AbstractUnnumberedInterfaceSubobjectParser {
    protected UnnumberedCase parseUnnumeredInterface(final ByteBuf buffer) {
    ...
    protected void serializeUnnumeredInterface(final Unnumbered unnumbered, final ByteBuf body) {

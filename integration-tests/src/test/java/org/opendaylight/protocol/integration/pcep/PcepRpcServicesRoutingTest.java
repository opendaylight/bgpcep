    ...
    public void testRoutedRpcTopologyTunnelPcepProgrammingService() throws Exception {
        ...
        BindingAwareProvider provider1 = new AbstractTestProvider() {
            ...
            public void onSessionInitiated(BindingAwareBroker.ProviderContext session) {
                ...
                firstReg.registerPath(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.topology.tunnel.pcep.programming.rev131030.TopologyContext.class, topology);
            }
        };
        ...
        BindingAwareProvider provider2 = new AbstractTestProvider() {
            ...
            public void onSessionInitiated(BindingAwareBroker.ProviderContext session) {
                ...
                secondReg.registerPath(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.topology.tunnel.pcep.programming.rev131030.TopologyContext.class, topology2);
            }
        };
        ...
        BindingAwareConsumer consumer = new BindingAwareConsumer() {
            ...
            public PcepCreateP2pTunnelInput getPcepCreateP2pTunnelInput(InstanceIdentifier<Topology> topology) {
                ...
                builder.setTopologyIdentifier(new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.topology.tunnel.pcep.programming.rev131030.TopologyRef(topology));
                return builder.build();
            }
        };
        broker.registerConsumer(consumer, getBundleContext());

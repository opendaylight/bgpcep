...
public class PcepRpcServicesRoutingTest extends AbstractPcepOsgiTest {
    ...
    private void initMock(final NetworkTopologyPcepService pcepService) {
        ...
        final ListenableFuture futureReSyncTrigger = Futures.immediateFuture(RpcResultBuilder.<TriggerReSyncOutput>success().build());
        final ListenableFuture futureReSyncLspTrigger = Futures.immediateFuture(RpcResultBuilder.<TriggerReSyncLspOutput>success().build());
    ...
    private void initMock(final NetworkTopologyPcepProgrammingService pcepService) {
        @SuppressWarnings("rawtypes")
        final ListenableFuture future = Futures.immediateFuture(RpcResultBuilder.<AddLspOutput>success().build());
        final ListenableFuture futureTriggerInitialSync = Futures.immediateFuture(RpcResultBuilder.<TriggerInitialSyncOutput>success().build());
        final ListenableFuture futureTriggerResync = Futures.immediateFuture(RpcResultBuilder.<TriggerReSyncOutput>success().build());
        final ListenableFuture futureTriggerResyncLsp = Futures.immediateFuture(RpcResultBuilder.<TriggerReSyncLspOutput>success().build());
        ...
        when(pcepService.submitTriggerInitialSync(Mockito.<SubmitTriggerInitialSyncInput>any())).thenReturn(futureTriggerInitialSync);
        when(pcepService.submitTriggerReSync(Mockito.<SubmitTriggerReSyncInput>any())).thenReturn(futureTriggerResync);
        when(pcepService.submitTriggerReSyncLsp(Mockito.<SubmitTriggerReSyncLspInput>any())).thenReturn(futureTriggerResyncLsp);

 ...
 * 
 * @see <a href="http://tools.ietf.org/html/rfc5440#section-7.6">PCEP EndPointsObject</a>
 * @param <T> subtype of NetworkAddress
 */
public class PCEPEndPointsObject<T extends NetworkAddress<T>> extends PCEPEndPoints {
	 ...
	 * 
	 * @param sourceAddress T. Cant't be null.
	 * @param destinationAddress T. Cant't be null.
	 */
	public PCEPEndPointsObject(final T sourceAddress, final T destinationAddress) {
		super(true, false);

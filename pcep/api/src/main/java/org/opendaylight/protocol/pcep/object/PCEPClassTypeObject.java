 ...
 * 
 * @see <a href="http://tools.ietf.org/html/rfc5455#section-5"> Object Definition</a>
 */
public class PCEPClassTypeObject extends PCEPObject {
	 ...
	 * 
	 * @param classType short, must be positive and less than 8.
	 */
	public PCEPClassTypeObject(final short classType) {
		super(true, false);

 ...
 * 
 * @see <a href="http://tools.ietf.org/html/rfc5440#section-7.8">PCEP Metric Object</a>
 */
public class PCEPMetricObject extends PCEPObject {
	 ...
	 * 
	 * @param bound boolean
	 * @param computedMetric boolean
	 * @param metric cannot be null
	 * @param processed boolean
	 * @param ignored boolean
	 */
	public PCEPMetricObject(final boolean bound, final boolean computedMetric, final AbstractMetric<?> metric, final boolean processed,

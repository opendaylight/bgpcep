 ...
 * 
 * @see <a href="http://tools.ietf.org/html/rfc5440#section-7.15">PCEP Error Object</a>
 */
public class PCEPErrorObject extends PCEPObject {
	 ...
	 * 
	 * @param type PCEPErrors. Can't be null.
	 */
	public PCEPErrorObject(final PCEPErrors type) {
		this(type, null);
	}
	 ...
	 */
	public PCEPErrorObject(final PCEPErrors type, final List<PCEPTlv> tlvs) {
		super(false, false);
		this.error = type;
		if (tlvs != null)
			this.tlvs = tlvs;

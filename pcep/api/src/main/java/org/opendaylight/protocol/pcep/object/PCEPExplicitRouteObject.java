 ...
 * 
 * @see <a href="http://tools.ietf.org/html/rfc5440#section-7.9">PCEP Explicit Route Object</a>
 */
public class PCEPExplicitRouteObject extends PCEPObject {
	 ...
	 */
	public PCEPExplicitRouteObject(final List<ExplicitRouteSubobject> subobjects, final boolean ignored) {
		super(false, ignored);

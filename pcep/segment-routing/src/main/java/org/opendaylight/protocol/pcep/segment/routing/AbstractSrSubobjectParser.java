...
public abstract class AbstractSrSubobjectParser {
    ...
    public ByteBuf serializeSubobject(final SrSubobject srSubobject) {
        ...
        if (srSubobject.getSid() != null) {
            if (srSubobject.isMFlag() != null && srSubobject.isMFlag()) {
    ...
    protected final SrSubobject parseSrSubobject(final ByteBuf buffer, final Function<BitArray, Void> getFlags, final int fPosition, final int sPosition, final int cPosition, final int mPosition)

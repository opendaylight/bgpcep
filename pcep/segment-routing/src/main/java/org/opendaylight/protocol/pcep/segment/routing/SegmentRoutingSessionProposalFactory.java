...
public class SegmentRoutingSessionProposalFactory implements PCEPCapability {

    private final boolean isSegmentRoutingCapable;

    public SegmentRoutingSessionProposalFactory(final boolean isSegmentRoutingCapable) {

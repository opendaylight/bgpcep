...
public class SegmentRoutingSessionProposalFactory extends PCEPStatefulCapability {

    private final boolean isSegmentRoutingCapable;

    public SegmentRoutingSessionProposalFactory(final boolean stateful, final boolean active,
        ...
        super(stateful, active, instant, triggeredSync, triggeredResync, deltaLspSync, includeDbVersion);
        this.isSegmentRoutingCapable = isSegmentRoutingCapable;
    }

    @Override
    public void setCapabilityProposal(final InetSocketAddress address, final TlvsBuilder builder) {
        super.setCapabilityProposal(address, builder);

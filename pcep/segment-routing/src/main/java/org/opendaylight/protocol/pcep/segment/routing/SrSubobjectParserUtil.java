...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.segment.routing.rev140506.sr.subobject.Nai;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.segment.routing.rev140506.sr.subobject.nai.IpAdjacency;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.segment.routing.rev140506.sr.subobject.nai.IpNodeId;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.segment.routing.rev140506.sr.subobject.nai.UnnumberedAdjacency;
...
class SrSubobjectParserUtil {
    ...
    public static final int M_FLAG_POSITION = 7;
    public static final int C_FLAG_POSITION = 6;
    public static final int S_FLAG_POSITION = 5;
    public static final int F_FLAG_POSITION = 4;
    ...
    public static SrSubobject parseSrSubobject(final ByteBuf buffer, final Function<BitSet, Void> getFlags)

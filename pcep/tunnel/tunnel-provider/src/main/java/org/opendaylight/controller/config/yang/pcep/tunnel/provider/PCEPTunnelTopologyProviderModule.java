...
public final class PCEPTunnelTopologyProviderModule extends AbstractPCEPTunnelTopologyProviderModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final BindingAwareBroker.RoutedRpcRegistration<TopologyTunnelPcepProgrammingService> reg =
                rpcRegistry.addRoutedRpcImplementation(
        ...
        final InstanceIdentifier<Topology> topology = InstanceIdentifier.builder(NetworkTopology.class)
                .child(Topology.class, new TopologyKey(getTopologyId())).build();
        ...
        final class TunnelTopologyReferenceCloseable extends DefaultTopologyReference implements AutoCloseable {
            TunnelTopologyReferenceCloseable(final InstanceIdentifier<Topology> instanceIdentifier) {

...
final class UpdateTunnelInstructionExecutor extends AbstractInstructionExecutor {
    ...
    private UpdateLspInput buildUpdateInput(final Link link, final Node node) {
        ...
        final var args = new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.topology.pcep.rev260528
        ...
        final AdministrativeStatus adminStatus = updateTunnelInput.getAdministrativeStatus();
        if (adminStatus != null) {
            args.setLsp(new LspBuilder().setLspFlags(new LspFlagsBuilder()

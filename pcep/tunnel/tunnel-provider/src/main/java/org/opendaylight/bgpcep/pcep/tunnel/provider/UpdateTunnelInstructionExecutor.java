...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.ietf.stateful.rev210825.PcepUpdateTunnelInput1;
...
final class UpdateTunnelInstructionExecutor extends AbstractInstructionExecutor {
    ...
    private UpdateLspInput buildUpdateInput(final Link link, final Node node) {
        ...
        final org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.topology.pcep.rev200120.update.lsp
                ...
                .yang.topology.pcep.rev200120.update.lsp.args.ArgumentsBuilder();

...
public final class UpdateTunnelInstructionExecutor extends AbstractInstructionExecutor {
    ...
    private final PcepUpdateTunnelInput input;
    private final DataBroker dataProvider;
    private final NetworkTopologyPcepService topologyService;

    protected UpdateTunnelInstructionExecutor(final PcepUpdateTunnelInput input, final DataBroker dataProvider, final NetworkTopologyPcepService topologyService) {
        super(input);
        this.input = input;
    ...
    protected ListenableFuture<OperationResult> invokeOperation() {
        ...
        try (final ReadOnlyTransaction t = this.dataProvider.newReadOnlyTransaction()) {
            ...
            return Futures.transform(
                (ListenableFuture<RpcResult<UpdateLspOutput>>) this.topologyService.updateLsp(buildUpdateInput(link, node, input)),

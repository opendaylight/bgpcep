 ...
 * Parser for {@link Srp}
 */
public final class InitiatedSrpObjectParser extends AbstractObjectWithTlvsParser<SrpBuilder> {
	...
	public InitiatedSrpObjectParser(final TlvHandlerRegistry tlvReg) {
		super(tlvReg);
	}

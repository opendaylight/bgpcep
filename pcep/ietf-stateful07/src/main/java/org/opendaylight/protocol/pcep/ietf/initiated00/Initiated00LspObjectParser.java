 ...
 * Parser for {@link Lsp}
 */
public class Initiated00LspObjectParser extends AbstractObjectWithTlvsParser<TlvsBuilder> {
	...
	public Initiated00LspObjectParser(final TlvHandlerRegistry tlvReg) {
		super(tlvReg);
	}

...
public final class PathBindingTlvParser implements TlvParser, TlvSerializer {
    ...
    private static final int MPLS_BINDING_LENGTH = 4 + 2;
    ...
    public Tlv parseTlv(final ByteBuf buffer) throws PCEPDeserializerException {
        ...
        return new PathBindingBuilder().setBindingTypeValue(codec.readBindingValue(buffer)).build();
    }
    ...
    private static final class MplsLabelCodec extends PathBindingTlvCodec {
        ...
        @Override
        void writeBindingValue(final ByteBuf buf, final BindingTypeValue bindingValue) {
        ...
        @Override
        BindingTypeValue readBindingValue(final ByteBuf buffer) {
    ...
    private abstract static class PathBindingTlvCodec {
        ...
        final void writeBinding(final ByteBuf buf, final BindingTypeValue binding) {
            ...
            writeBindingValue(buf, binding);
        }

        abstract BindingTypeValue readBindingValue(ByteBuf buf);

        abstract void writeBindingValue(ByteBuf buf, BindingTypeValue value);
    }

...
public class SyncOperationsPCEPParserModule extends AbstractSyncOperationsPCEPParserModule{
    ...
    public SyncOperationsPCEPParserModule(final ModuleIdentifier identifier, final DependencyResolver dependencyResolver,
        final SyncOperationsPCEPParserModule oldModule, final java.lang.AutoCloseable oldInstance) {

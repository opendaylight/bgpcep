...
public class ManagedTePath implements ConnectedEdgeTrigger, ConnectedVertexTrigger {
     ...
     *
     * @param rpcRegistry  Rpc Consumer Registry
     *
     * @return      Add LSP Output to convey the RPC result
     */
    public ListenableFuture<RpcResult<AddLspOutput>> addPath(final RpcConsumerRegistry rpcRegistry) {
        ...
        sent = true;
        final ListenableFuture<RpcResult<AddLspOutput>> enforce = rpcRegistry.getRpc(AddLsp.class)
            .invoke(getAddLspInput());
        LOG.info("Call Add LSP to {} with {}", rpcRegistry, enforce);
     ...
     */
    public ListenableFuture<RpcResult<UpdateLspOutput>> updatePath(final RpcConsumerRegistry rpcRegistry) {
        ...
        final ListenableFuture<RpcResult<UpdateLspOutput>> enforce = rpcRegistry.getRpc(UpdateLsp.class)
            .invoke(getUpdateLspInput());
        LOG.info("Call Update LSP to {} with {}", rpcRegistry, enforce);
     ...
     */
    public ListenableFuture<RpcResult<RemoveLspOutput>> removePath(final RpcConsumerRegistry rpcRegistry) {
        ...
        final RemoveLspInput rli = new RemoveLspInputBuilder()
                ...
                .setNetworkTopologyRef(new NetworkTopologyRef(pcepTopology))
                .build();
        final ListenableFuture<RpcResult<RemoveLspOutput>> enforce = rpcRegistry.getRpc(RemoveLsp.class).invoke(rli);
        LOG.info("Call Remove LSP to {} with {}", rpcRegistry, enforce);

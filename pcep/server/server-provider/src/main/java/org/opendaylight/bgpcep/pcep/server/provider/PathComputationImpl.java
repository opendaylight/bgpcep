...
public class PathComputationImpl implements PathComputation {
    ...
    private static PathConstraints getConstraints(final EndpointsObj endpoints, final Bandwidth bandwidth,
        ...
        /* Set Exclude Route and Include Route if any */
        ctsBuilder.setExcludeRoute(getExcludeRoute(xro, ctsBuilder.getAddressFamily()));
        ctsBuilder.setIncludeRoute(getIncludeRoute(iro, ctsBuilder.getAddressFamily()));

...
public final class PathManagerProvider implements FutureCallback<Empty>, AutoCloseable, ConnectedGraphTrigger {
    ...
    public PathManagerProvider(final DataBroker dataBroker, final KeyedInstanceIdentifier<Topology, TopologyKey> topology,
            final RpcService rpcService, final DefaultPceServerProvider pceServerProvider) {
    ...
    @Override
    public void verifyVertex(final Collection<ConnectedVertexTrigger> triggers, @Nullable
    final ConnectedVertex current,
            @Nullable
            final Vertex next) {
    ...
    @Override
    public void verifyEdge(final Collection<ConnectedEdgeTrigger> triggers, @Nullable
    final ConnectedEdge current,
            @Nullable
            final Edge next) {

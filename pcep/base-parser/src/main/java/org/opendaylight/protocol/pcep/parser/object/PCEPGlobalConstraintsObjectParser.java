...
public class PCEPGlobalConstraintsObjectParser extends AbstractObjectWithTlvsParser<TlvsBuilder> {
    ...
    public Gc parseObject(final ObjectHeader header, final ByteBuf bytes) throws PCEPDeserializerException {
        ...
        builder.setMaxHop(ByteBufUintUtil.readUint8(bytes));
        builder.setMaxUtilization(ByteBufUintUtil.readUint8(bytes));
        builder.setMinUtilization(ByteBufUintUtil.readUint8(bytes));
        builder.setOverBookingFactor(ByteBufUintUtil.readUint8(bytes));

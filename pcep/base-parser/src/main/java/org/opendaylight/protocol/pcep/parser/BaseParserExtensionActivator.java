...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.close.object.CClose;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.of.list.tlv.OfList;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.order.tlv.Order;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.overload.duration.tlv.OverloadDuration;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.pcrep.message.pcrep.message.replies.result.failure._case.no.path.tlvs.NoPathVector;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.req.missing.tlv.ReqMissing;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.rp.object.Rp;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.secondary.explicit.route.object.Sero;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev210825.unreach.destination.object.UnreachDestinationObj;
...
public final class BaseParserExtensionActivator implements PCEPExtensionProviderActivator {
    ...
    private static void registerObjectParsers(final List<Registration> regs,
        ...
        regs.add(context.registerObjectSerializer(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang
            .pcep.types.rev210825.reoptimization.bandwidth.object.ReoptimizationBandwidth.class, bwExistingParser));
    ...
    private static void registerExtensionsObjectParsers(final List<Registration> regs,
        ...
        regs.add(context.registerObjectSerializer(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang
            .pcep.types.rev210825.path.key.object.PathKey.class, pathKeyParser));

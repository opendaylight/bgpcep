...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250328.secondary.reported.route.object.srro.SubobjectBuilder;
...
public final class PCEPSecondaryRecordRouteObjectParser extends AbstractRROWithSubobjectsParser {
    ...
    public void serializeObject(final Object object, final ByteBuf buffer) {
        ...
        final List<Subobject> subObjects = sero.nonnullSubobject().stream()
            .map(so -> new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250328

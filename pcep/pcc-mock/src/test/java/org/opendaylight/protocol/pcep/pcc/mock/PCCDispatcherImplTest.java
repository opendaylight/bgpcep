...
public class PCCDispatcherImplTest {
    ...
    public void testClientReconnect() throws Exception {
        ...
        final var futureServer = pcepDispatcher.createServer(serverAddress, KeyMapping.of(), registry, nf);
        futureServer.sync();
        ...
        final var future2 = pcepDispatcher.createServer(serverAddress, KeyMapping.of(), registry,

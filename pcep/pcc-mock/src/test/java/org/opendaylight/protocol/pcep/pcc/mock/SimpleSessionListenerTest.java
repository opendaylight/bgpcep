...
public class SimpleSessionListenerTest {
    ...
    public void testSessionListenerPcRpt() throws UnknownHostException {
        final SimpleSessionListener sessionListser = new SimpleSessionListener(1, false, InetAddress.getByName(IP_ADDRESS), true);
    ...
    public void testSessionListenerPcErr() throws UnknownHostException {
        final SimpleSessionListener sessionListser = new SimpleSessionListener(1, true, InetAddress.getByName(IP_ADDRESS), true);
    ...
    public void testRemoveLspWithUnknowPlspId() throws UnknownHostException {
        final SimpleSessionListener sessionListener = new SimpleSessionListener(1, false, InetAddress.getByName(IP_ADDRESS), true);

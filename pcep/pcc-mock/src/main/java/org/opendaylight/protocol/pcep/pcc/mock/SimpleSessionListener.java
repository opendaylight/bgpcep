...
public class SimpleSessionListener implements PCEPSessionListener {
    ...
    public SimpleSessionListener(final int lspsCount, final boolean pcError, final InetAddress address, final boolean isDelegated) {
    ...
    public void onSessionUp(final PCEPSession session) {
        ...
        // end-of-sync marker
        session.sendMessage(createPcRtpMessage(createLsp(0, true, Optional.<Tlvs> absent(), isDelegated), Optional.<Srp> absent(),

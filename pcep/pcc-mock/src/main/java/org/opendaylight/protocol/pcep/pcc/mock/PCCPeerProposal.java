...
final class PCCPeerProposal implements PCEPPeerProposal {
    private final BigInteger dbVersion;

    public PCCPeerProposal(final BigInteger dbVersion) {
    ...
    public void setPeerSpecificProposal(final InetSocketAddress address, final TlvsBuilder openBuilder) {
        ...
        final LspDbVersion LspDBV = new LspDbVersionBuilder().setLspDbVersionValue(dbVersion).build();

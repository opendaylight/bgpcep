...
//TODO get rid of OpenBuilder
    ...
    public void testReplyMsg() throws IOException, PCEPDeserializerException {
        ...
        rBuilder.setResult(new SuccessCaseBuilder().setSuccess(new SuccessBuilder().setPaths(paths).build()).build())
            .build();
    ...
    public void testRepMsgWithVendorInforObjects() throws IOException, PCEPDeserializerException {
        ...
        paBuilder.setEro(this.ero);
        paths.add(paBuilder.build());
        rBuilder.setResult(new SuccessCaseBuilder().setSuccess(new SuccessBuilder().setPaths(paths)

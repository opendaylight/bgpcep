...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.config.rev250930.pcep.config.session.config.TlsBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.message.rev250930.Keepalive;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.message.rev250930.Open;
...
class FiniteStateMachineTest extends AbstractPCEPSessionTest {
    ...
    void testFailedToEstablishTLS() {
        ...
        assertEquals(2, msgsSend.size());
        assertInstanceOf(Pcerr.class, msgsSend.get(1));

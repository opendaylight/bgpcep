...
public class PCEPDispatcherImplTest {
    ...
    private PCEPDispatcherImpl dispatcher3;
    ...
    private PCCMock<Message, PCEPSessionImpl, PCEPSessionListener> pccMockSpy;
    ...
    public void setUp() {
        ...
        this.dispatcher3 = new PCEPDispatcherImpl(msgReg, new DefaultPCEPSessionNegotiatorFactory(open, 0), eventLoopGroup, eventLoopGroup);
        ...
        this.pccMockSpy = Mockito.spy(this.pccMock);
    }
    ...
    public void testCustomizeBootstrap() {
        ...
        this.pccMockSpy.createClient(CLIENT1_ADDRESS,
            new NeverReconnectStrategy(GlobalEventExecutor.INSTANCE, 500),
            new SessionListenerFactory<PCEPSessionListener>() {
                @Override
                public PCEPSessionListener getSessionListener() {
...
//        Mockito.verify(this.disp2Spy).customizeBootstrap(Mockito.any(Bootstrap.class));
    ...
    public void testUnsupportedOperationException() {
        ...
        keys.put(this.CLIENT1_ADDRESS.getAddress(), new String("CLIENT1_ADDRESS").getBytes() );
        keys.put(this.CLIENT2_ADDRESS.getAddress(), new String("CLIENT2_ADDRESS").getBytes() );
        final ChannelFuture futureChannel = this.dispatcher3.createServer(new InetSocketAddress("0.0.0.0", PORT), keys,
            new SessionListenerFactory<PCEPSessionListener>() {
                @Override
                public PCEPSessionListener getSessionListener() {
                    return new SimpleSessionListener();

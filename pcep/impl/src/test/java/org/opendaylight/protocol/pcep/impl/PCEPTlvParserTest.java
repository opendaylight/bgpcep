...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250602.NoPathVectorTlv;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250602.association.range.tlv.AssociationRangeBuilder;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250602.association.range.tlv.association.range.AssociationRangesBuilder;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250602.order.tlv.Order;
...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250602.req.missing.tlv.ReqMissing;
...
public class PCEPTlvParserTest {
    ...
    public void testNoPathVectorTlv() throws PCEPDeserializerException {
        ...
        final NoPathVectorTlv tlv = new NoPathVectorBuilder()
                .setFlags(new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev250602
    ...
    public void testPathSetupTypeCapabilityTlvParser() throws PCEPDeserializerException {
        ...
        final PathSetupTypeCapability pstCapability = new PathSetupTypeCapabilityBuilder()
            .setPstNumber(Uint8.valueOf(3))
            .setPsts(List.of(PsType.RsvpTe, PsType.SrMpls, PsType.Srv6))
            .setSubTlvs(new SubTlvsBuilder()

...
//TODO use capital letter in variables names - see PCEPEROSubobjectParserTest.java for example
    private static final byte[] generalizedLabelBytes =
    ...
    private static final byte[] wavebandLabelBytes =
    ...
    public void testGeneralizedLabel() throws PCEPDeserializerException {
        ...
        assertEquals(
            builder.build(), parser.parseLabel(Unpooled.wrappedBuffer(ByteArray.cutBytes(generalizedLabelBytes, 2))));
    ...
    public void testWavebandLabel() throws PCEPDeserializerException {
        ...
        assertEquals(
            builder.build(), parser.parseLabel(Unpooled.wrappedBuffer(ByteArray.cutBytes(wavebandLabelBytes, 2))));
        final ByteBuf buff = Unpooled.buffer();
    ...
    public void testTypeOneLabel() throws PCEPDeserializerException {
        ...
        assertEquals(
            builder.build(), parser.parseLabel(Unpooled.wrappedBuffer(ByteArray.cutBytes(typeOneLabelBytes, 2))));
        final ByteBuf buff = Unpooled.buffer();

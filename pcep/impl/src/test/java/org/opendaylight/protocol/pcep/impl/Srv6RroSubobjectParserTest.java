...
class Srv6RroSubobjectParserTest {
    ...
    @Test
    void testSrv6RroSubobjectSrv6Sid() throws PCEPDeserializerException {
    ...
    @Test
    void testSrv6RroSubobjectSrv6SidStructure() throws PCEPDeserializerException {
        final Srv6RroTypeBuilder builder = new Srv6RroTypeBuilder()
                .setSrv6NaiType(NaiType.Ipv6NodeId)
                .setEndpointBehavior(Uint16.TEN)
                .setVFlag(false)
    ...
    @Test
    void testSrv6RroSubobjectIpv6NodeIdNAI() throws PCEPDeserializerException {
        final Srv6RroTypeBuilder builder = new Srv6RroTypeBuilder()
                .setSrv6NaiType(NaiType.Ipv6NodeId)
                .setEndpointBehavior(Uint16.TEN)
                .setVFlag(false)
    ...
    @Test
    void testSrv6RroSubobjectIpv6AdjacencyNAI() throws PCEPDeserializerException {
        final Srv6RroTypeBuilder builder = new Srv6RroTypeBuilder()
    ...
    @Test
    void testSrv6RroSubobjectIpv6LocalNAI() throws PCEPDeserializerException {
        final Srv6RroTypeBuilder builder = new Srv6RroTypeBuilder()

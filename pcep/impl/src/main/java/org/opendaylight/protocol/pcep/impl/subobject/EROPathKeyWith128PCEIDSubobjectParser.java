...
public class EROPathKeyWith128PCEIDSubobjectParser implements EROSubobjectParser, EROSubobjectSerializer {
	...
	public byte[] serializeSubobject(final Subobjects subobject) {
		...
		// System.arraycopy(ByteArray.shortToBytes((short) subobject.getPathKey()), 0, retBytes, PK_F_OFFSET,
		// PK_F_LENGTH);

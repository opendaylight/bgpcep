 ...
 */
public class LSPIdentifierIPv4TlvParser implements PCEPTlvParser {
	...
	public IPv4LSPIdentifiersTlv parse(byte[] valueBytes) throws PCEPDeserializerException {
	...
	public byte[] put(PCEPTlv objToSerialize) {
		...
		IPv4LSPIdentifiersTlv tlv = (IPv4LSPIdentifiersTlv) objToSerialize;

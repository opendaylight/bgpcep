...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.types.rev131005.endpoints.object.endpoints.obj.ipv6.endpoints.obj.Ipv6;
...
/**
 * Parser for IPv6 {@link Ipv6EndpointsObj}
 */
public class PCEPEndPointsIpv6ObjectParser implements ObjectParser, ObjectSerializer {
    ...
    public Object parseObject(final ObjectHeader header, final ByteBuf bytes) throws PCEPDeserializerException {
        ...
        builder.setIpv6(b.build());
        return builder.build();
    }

    @Override
    public void serializeObject(final Object object, final ByteBuf buffer) {
        Preconditions.checkArgument(object instanceof Ipv6EndpointsObj, "Wrong instance of PCEPObject. Passed %s. Needed EndpointsObject.", object.getClass());
        final Ipv6EndpointsObj ePObj = (Ipv6EndpointsObj) object;
        final ByteBuf body = Unpooled.buffer(Ipv6Util.IPV6_LENGTH + Ipv6Util.IPV6_LENGTH);
        final Ipv6 ipv6 = ePObj.getIpv6();

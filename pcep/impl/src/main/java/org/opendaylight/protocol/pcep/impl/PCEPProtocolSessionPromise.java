 ...
 */
@ThreadSafe
public class PCEPProtocolSessionPromise extends DefaultPromise<PCEPSessionImpl> {
    ...
    public PCEPProtocolSessionPromise(EventExecutor executor, InetSocketAddress address, ReconnectStrategy strategy, Bootstrap b) {
        super(executor);
    ...
    public synchronized Promise<PCEPSessionImpl> setSuccess(PCEPSessionImpl result) {

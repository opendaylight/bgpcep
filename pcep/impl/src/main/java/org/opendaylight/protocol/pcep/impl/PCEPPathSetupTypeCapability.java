...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.pcep.config.rev230112.PathSetupTypeCapabilities;
...
public final class PCEPPathSetupTypeCapability extends PCEPCapability {
    ...
    public PCEPPathSetupTypeCapability(final boolean rsvpTe, final boolean srMpls, final boolean srv6) {
        ...
        final var builder = new PathSetupTypeCapabilityBuilder().setPstNumber(Uint8.valueOf(psts.size())).setPsts(psts);
        if (srMpls || srv6) {
            builder.setSubTlvs(constructPstTlvs(psts));
        }
    ...
    private static SubTlvs constructPstTlvs(final List<PsType> psts) {
    ...
    public boolean equals(final Object obj) {
        return this == obj || obj instanceof PCEPPathSetupTypeCapability other
            && pstCapability.getPstNumber().intValue() == other.getPSTCapability().getPstNumber().intValue()

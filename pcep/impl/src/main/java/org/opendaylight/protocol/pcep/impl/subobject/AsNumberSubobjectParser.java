...
public class AsNumberSubobjectParser implements SubobjectParser, SubobjectSerializer {
	...
	public CSubobject parseSubobject(byte[] buffer) throws PCEPDeserializerException {
	...
	public byte[] serializeSubobject(CSubobject subobject) {
		if (!(subobject instanceof AsNumberSubobject))
			throw new IllegalArgumentException("Unknown ExplicitRouteSubobject instance. Passed " + subobject.getClass()

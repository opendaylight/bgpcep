...
public class HandlerRegistryImpl implements HandlerRegistry {
	...
	static {
		...
		reg.registerSubobjectParser(AsNumberSubobjectParser.TYPE, new AsNumberSubobjectParser());

		reg.registerSubobjectSerializer(AsNumberSubobject.class, new AsNumberSubobjectParser());

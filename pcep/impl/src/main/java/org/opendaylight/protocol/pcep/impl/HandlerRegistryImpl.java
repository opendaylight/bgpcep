...
public class HandlerRegistryImpl implements HandlerRegistry {
	...
	static {
		...
		reg.registerObjectParser(PCEPEndPointsIPv4ObjectParser.CLASS, PCEPEndPointsIPv4ObjectParser.TYPE,
				new PCEPEndPointsIPv4ObjectParser(reg));
		reg.registerObjectParser(PCEPEndPointsIPv6ObjectParser.CLASS, PCEPEndPointsIPv6ObjectParser.TYPE,
				new PCEPEndPointsIPv6ObjectParser(reg));
		...
		// FIXME : merge parsers
		reg.registerObjectSerializer(EndpointsObject.class, new PCEPEndPointsIPv4ObjectParser(reg));
		reg.registerObjectSerializer(EndpointsObject.class, new PCEPEndPointsIPv6ObjectParser(reg));

...
abstract class AbstractRROWithSubobjectsParser implements ObjectParser, ObjectSerializer {
    ...
    AbstractRROWithSubobjectsParser(final RROSubobjectRegistry subobjReg) {

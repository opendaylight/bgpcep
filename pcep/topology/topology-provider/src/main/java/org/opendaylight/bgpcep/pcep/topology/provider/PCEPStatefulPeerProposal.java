...
final class PCEPStatefulPeerProposal extends AbstractRegistration implements PCEPPeerProposal {
    ...
    private static final class SpeakerIdListener extends AbstractListener<PcepNodeSyncConfig, byte[]> {
    ...
    private static final class LspDbVersionListener extends AbstractListener<LspDbVersion, LspDbVersion> {

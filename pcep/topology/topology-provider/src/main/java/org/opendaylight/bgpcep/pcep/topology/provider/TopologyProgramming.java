...
final class TopologyProgramming {
    ...
    private ListenableFuture<RpcResult<SubmitAddLspOutput>> submitAddLsp(final SubmitAddLspInput input) {
    ...
    private ListenableFuture<RpcResult<SubmitRemoveLspOutput>> submitRemoveLsp(final SubmitRemoveLspInput input) {
        Preconditions.checkArgument(input.getNode() != null);
        Preconditions.checkArgument(input.getName() != null);
    ...
    private ListenableFuture<RpcResult<SubmitUpdateLspOutput>> submitUpdateLsp(final SubmitUpdateLspInput input) {
        Preconditions.checkArgument(input.getNode() != null);
        Preconditions.checkArgument(input.getName() != null);
    ...
    private ListenableFuture<RpcResult<SubmitEnsureLspOperationalOutput>> submitEnsureLspOperational(
    ...
    private ListenableFuture<RpcResult<SubmitTriggerSyncOutput>> submitTriggerSync(final SubmitTriggerSyncInput input) {
        Preconditions.checkArgument(input.getNode() != null);

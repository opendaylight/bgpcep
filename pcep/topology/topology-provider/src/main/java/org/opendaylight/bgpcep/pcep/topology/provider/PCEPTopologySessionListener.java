...
class PCEPTopologySessionListener extends AbstractTopologySessionListener<SrpIdNumber, PlspId> {
    ...
    @Override
    protected void onSessionUp(final PathComputationClientBuilder pccBuilder, final Tlvs remoteTlvs) {
        if (remoteTlvs != null) {
        ...
        LOG.debug("Peer {} does not advertise stateful TLV", pccBuilder.getIpAddress().stringValue());
    }

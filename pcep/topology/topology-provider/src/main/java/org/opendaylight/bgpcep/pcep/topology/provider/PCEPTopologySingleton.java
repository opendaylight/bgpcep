...
final class PCEPTopologySingleton {
    ...
    private final class Active extends State implements ClusterSingletonService {
        ...
        // This part of the shutdown procedure needs to synchronize with instantiation
        private synchronized ListenableFuture<?> lockedTerminate() {
            ...
            if (closeFuture == null) {
                // FIXME: check if there is no instance and use an immediate future in that case

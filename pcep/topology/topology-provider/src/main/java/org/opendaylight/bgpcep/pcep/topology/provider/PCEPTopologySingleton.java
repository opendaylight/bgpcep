...
final class PCEPTopologySingleton {
    ...
    private final class Active extends State implements ClusterSingletonService {
        ...
        // FIXME: this probably needs another indirection through a 'PCEPTopologyInstance' to handle stateful/stateless
        //        config and similar.
        @GuardedBy("this")
        ...
        public synchronized void instantiateServiceInstance() {
            ...
            LOG.debug("Topology {} instance {} instantiating", topology, PCEPTopologySingleton.this);
            // FIXME: implement this
            provider = PCEPTopologyProvider.create(tracker, scheduler, null);
        }
        ...
        public ListenableFuture<?> closeServiceInstance() {
            ...
            synchronized (this) {
                LOG.debug("Topology {} instance {} closing", topology, PCEPTopologySingleton.this);
                if (closeFuture == null) {
                ...
                ret = provider.closeServiceInstance();
                provider = null;
            }
            ...
            ret.addListener(() -> {
                LOG.debug("Topology {} instance {} completing close", topology, PCEPTopologySingleton.this);
                synchronized (this) {
                    closeFuture = null;
                }
                LOG.debug("Topology {} instance {} closed", topology, PCEPTopologySingleton.this);

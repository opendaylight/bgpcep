...
public final class PCEPTopologyTracker implements ClusteredDataTreeChangeListener<TopologyPcep>, AutoCloseable {
    ...
    private final ConcurrentMap<TopologyKey, PCEPTopologyInstance> instances = new ConcurrentHashMap<>();
    @GuardedBy("this")
    ...
    public synchronized void close() {
        ...
        instances.values().forEach(PCEPTopologyInstance::destroy);
        // Second pass: wait for cleanup
        instances.values().forEach(PCEPTopologyInstance::awaitCleanup);
    ...
    void finishDestroy(final TopologyKey topology, final PCEPTopologyInstance instance) {

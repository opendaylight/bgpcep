...
public class Stateful07TopologySessionListenerTest extends AbstractPCEPSessionTest<Stateful07TopologySessionListenerFactory> {
    ...
    @Override
    @Before
    public void setUp() throws IllegalAccessException, TransactionCommitFailedException, InstantiationException {
        super.setUp();
     ...
     */
    @Test
    public void testOnServerSessionManagerDown() throws ExecutionException, InterruptedException, TransactionCommitFailedException {
        this.listener.onSessionUp(this.session);
     ...
     */
    @Test
    public void testOnServerSessionManagerUnstarted()
            throws ReadFailedException, ExecutionException, InterruptedException, TransactionCommitFailedException {
        stopSessionManager();

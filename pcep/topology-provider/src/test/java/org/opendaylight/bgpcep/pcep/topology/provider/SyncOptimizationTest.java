...
public class SyncOptimizationTest {
    ...
    public void testDoesLspDbMatchPositive() {
        ...
        Mockito.doReturn(tlvs).when(pcepSession).getLocalSessionCharacteristics();
    ...
    public void testDoesLspDbMatchNegative() {
        ...
        Mockito.doReturn(localTlvs).when(pcepSession).getLocalSessionCharacteristics();
    ...
    @Test
    public void testIsIncrementalSyncEnabledPositive() {
    ...
    @Test
    public void testIsIncrementalSyncEnabledNegative() {
        final Tlvs localTlvs = createTlvs(1l, true, true);
        final Tlvs remoteTlvs = createTlvs(2l, false, true);
        Mockito.doReturn(localTlvs).when(pcepSession).getLocalSessionCharacteristics();
        Mockito.doReturn(remoteTlvs).when(pcepSession).getRemoteTlvs();
        final SyncOptimization syncOpt = new SyncOptimization(pcepSession);
    ...
    @Test
    public void testIsIncrementalSyncEnabledNegative2() {
        final Tlvs localTlvs = createTlvs(1l, true, true);
        final Tlvs remoteTlvs = createTlvs(1l, true, false);
        Mockito.doReturn(localTlvs).when(pcepSession).getLocalSessionCharacteristics();
        Mockito.doReturn(remoteTlvs).when(pcepSession).getRemoteTlvs();
        final SyncOptimization syncOpt = new SyncOptimization(pcepSession);
        assertFalse(syncOpt.isDeltaSyncEnabled());

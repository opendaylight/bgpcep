...
public class TopologyProgrammingTest extends AbstractPCEPSessionTest<MockedTopologySessionListenerFactory> {
    ...
    @Mock
    private io.netty.util.concurrent.Future<Void> futureTriggerSyncOutput;
    @Mock
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doAnswer(new Answer<io.netty.util.concurrent.Future<Void>>() {
            @Override
            public io.netty.util.concurrent.Future<Void> answer(final InvocationOnMock invocation) throws Throwable {

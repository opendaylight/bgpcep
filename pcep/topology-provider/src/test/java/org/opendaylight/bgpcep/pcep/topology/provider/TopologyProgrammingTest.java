...
import org.opendaylight.bgpcep.pcep.topology.provider.TopologyProgrammingTest.MockedTopologySesionListenerFactory;
...
public class TopologyProgrammingTest extends AbstractPCEPSessionTest<MockedTopologySesionListenerFactory> {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doAnswer(new Answer<Future<RpcResult<AddLspOutput>>>() {
            ...
            public Future<RpcResult<AddLspOutput>> answer(InvocationOnMock invocation) throws Throwable {
                TopologyProgrammingTest.this.addLspInput = (AddLspInput) invocation.getArguments()[0];
        ...
        Mockito.doAnswer(new Answer<Future<RpcResult<UpdateLspOutput>>>() {
            ...
            public Future<RpcResult<UpdateLspOutput>> answer(InvocationOnMock invocation) throws Throwable {
                TopologyProgrammingTest.this.updateLspInput = (UpdateLspInput) invocation.getArguments()[0];
        ...
        Mockito.doAnswer(new Answer<Future<RpcResult<RemoveLspOutput>>>() {
            ...
            public Future<RpcResult<RemoveLspOutput>> answer(InvocationOnMock invocation) throws Throwable {
                TopologyProgrammingTest.this.removeLspInput = (RemoveLspInput) invocation.getArguments()[0];
    ...
    public void testSubmitAddLsp() {
        ...
        Assert.assertEquals(NAME, this.addLspInput.getName());
        Assert.assertEquals(NODE_ID, this.addLspInput.getNode());
    }
    ...
    public void testSubmitUpdateLsp() {
        ...
        Assert.assertEquals(NAME, this.updateLspInput.getName());
        Assert.assertEquals(NODE_ID, this.updateLspInput.getNode());
    }
    ...
    public void testSubmitRemoveLsp() {
        ...
        Assert.assertEquals(NAME, this.removeLspInput.getName());
        Assert.assertEquals(NODE_ID, this.removeLspInput.getNode());
    }

    protected static final class MockedTopologySesionListenerFactory implements TopologySessionListenerFactory {
        @Override

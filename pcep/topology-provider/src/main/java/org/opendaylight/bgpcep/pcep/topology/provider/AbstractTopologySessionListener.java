...
/**
 * Base class for PCEP topology providers. It handles the common tasks
 * involved in creating managing a PCEP server (PCE) endpoint and exposing
 * a network topology based on it. It needs to be subclassed to form a
 * fully functional block, where the subclass provides handling of incoming
 * messages.
 *

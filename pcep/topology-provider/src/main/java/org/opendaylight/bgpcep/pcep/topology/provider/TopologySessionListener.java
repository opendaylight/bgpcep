...
final class TopologySessionListener implements PCEPSessionListener {
	private static final Logger LOG = LoggerFactory.getLogger(TopologySessionListener.class);
	 ...
	 */
	TopologySessionListener(final ServerSessionManager serverSessionManager) {

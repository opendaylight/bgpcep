...
public final class PCEPTopologyProvider extends DefaultTopologyReference implements AutoCloseable {
    ...
    public void close() throws InterruptedException {
        try {
            final ChannelFuture futureClose;
            futureClose = this.channel.close().sync();
            LOG.debug("Server channel {} closed", futureClose.channel());
        } catch (InterruptedException e) {
            LOG.error("Failed to close channel", this.channel);
        }

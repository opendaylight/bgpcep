...
import static org.opendaylight.bgpcep.pcep.topology.provider.PCEPTopologyDeployerImpl.PCEP_TOPOLOGY_BEAN;
...
import org.opendaylight.bgpcep.pcep.topology.provider.PCEPTopologyProviderRuntime;
...
public final class PCEPTopologyProviderModule extends
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        final WaitingServiceTracker<PCEPTopologyProviderRuntime> pcepTopologyRuntimeProviderTracker =
            WaitingServiceTracker.create(PCEPTopologyProviderRuntime.class, this.bundleContext,
                "(" + PCEPTopologyProviderRuntime.class.getName() + "=" + topologyID.getValue() + ")");
        final PCEPTopologyProviderRuntime pcepTopologyProviderRuntime = pcepTopologyRuntimeProviderTracker
            .waitForService(WaitingServiceTracker.FIVE_MINUTES);

        pcepTopologyProviderRuntime.registerRuntimeRootRegistration(getRootRuntimeBeanRegistratorWrapper());
        ...
        return Reflection.newProxy(PcepTopologyProviderCloseable.class, new AbstractInvocationHandler() {
            ...
            protected Object handleInvocation(Object proxy, Method method, Object[] args) throws Throwable {
                if (method.getName().equals("close")) {
                    ...
                    pcepTopologyRuntimeProviderTracker.close();
                    return null;
                } else {

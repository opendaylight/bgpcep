...
public class MplsLabelUtilTest {
    ...
    public void testBottomBit() {
        assertEquals(0, MplsLabelUtil.getBottomBit(Unpooled.copiedBuffer(VAL1_LEFT_BYTES)));
        assertEquals(1, MplsLabelUtil.getBottomBit(Unpooled.copiedBuffer(VAL1_LEFT_BYTES_BOTTOM)));
    }

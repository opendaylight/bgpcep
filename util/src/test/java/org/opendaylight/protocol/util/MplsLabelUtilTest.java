...
public class MplsLabelUtilTest {
    ...
    private static final int VAL1_LEFT = 80;
    private static final int VAL1_LEFT_BOTTOM = 81;
    ...
    public void testCreateLabel() {
        assertEquals(new MplsLabel(VAL1), MplsLabelUtil.mplsLabelForInt(VAL1_LEFT_BOTTOM));
    ...
    public void testBottomBit() {
        assertEquals(VAL1_LEFT_BOTTOM, MplsLabelUtil.setBottomBit(VAL1_LEFT));
        assertEquals(0, MplsLabelUtil.getBottomBit(VAL1_LEFT));
        assertEquals(1, MplsLabelUtil.getBottomBit(VAL1_LEFT_BOTTOM));
    }

...
public final class ByteBufUintUtil {
    ...
    public static void writeNonNull(final ByteBuf buf, final Uint8 uint) {
        buf.writeByte(uint.byteValue());
    }

    public static void writeNonNull(final ByteBuf buf, final Uint16 uint) {
        buf.writeShort(uint.shortValue());
    }

    public static void writeNonNull(final ByteBuf buf, final Uint32 uint) {
        buf.writeInt(uint.intValue());
    }

    public static void writeNonNull(final ByteBuf buf, final Uint64 uint) {
        buf.writeLong(uint.longValue());
    }
}

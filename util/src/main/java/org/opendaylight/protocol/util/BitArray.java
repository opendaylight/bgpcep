...
public final class BitArray {
    ...
    public void set(final int index, final Boolean value) {
        ...
        final byte b = this.backingArray[this.backingArray.length - pos - 1];
        this.backingArray[this.backingArray.length - pos - 1] = (byte) (UnsignedBytes.toInt(b) | mask(index, pos));
    }
    ...
    public boolean get(final int index) {
        ...
        final int pos = calculatePosition(index);
        final byte b = this.backingArray[this.backingArray.length - pos -1];
        return ((byte) (UnsignedBytes.toInt(b) & mask(index, pos))) == 0 ? false : true;
    }
    ...
    private static int calculatePosition(final int index) {
        return calculateBytes(index) - ((index % Byte.SIZE == 0) ? 0 : 1);
    }
    ...
    private static byte mask(final int index, final int bytePos) {
        return (byte) (1 << (index - (Byte.SIZE * bytePos)));
    }

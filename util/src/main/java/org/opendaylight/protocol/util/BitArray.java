...
public final class BitArray {
    ...
    public BitArray(final int size) {
        ...
        this.size = size;
        final int length = calculateBytes(size);
        this.backingArray = new byte[length];
        this.offset = (length * Byte.SIZE) - size;
    }
    ...
    public boolean get(final int index) {
        ...
        return ((byte) (UnsignedBytes.toInt(b) & mask(index))) == 0 ? false : true;
    }

...
public class ByteBufWriteUtil {
     ...
     * @param output ByteBuf, where value or zero is written.
     */
    public static void writeByte(final Byte value, final ByteBuf output) {
        if(value != null) {
     ...
     */
    public static void writeBitSet(final BitSet bitSet, final int outputLenght, final ByteBuf output) {

...
public final class ByteBufWriteUtil {
    ...
    /**
     * Writes byte <code>value</code> if not null, otherwise writes zero to the
     * <code>output</code> ByteBuf. ByteBuf's writerIndex is increased by 1.
     *
     * @param value
     *            Byte value to be written to the output.
     * @param output
     *            ByteBuf, where value or zero is written.
     */
     ...
     *
     * @param ipv4Prefix
     *            IPv4 prefix value to be written to the output.
     * @param output
     ...
     *
     * @param ipv6Prefix
     *            IPv6 prefix to be written to the output.
     * @param output
     ...
     *
     * @param bitSet
     *            BitSet values to be written to the output.
     * @param outputLength

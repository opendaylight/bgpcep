...
/**
 * Interface exposed by classes which can create KeyAccess instances
...
public interface KeyAccessFactory {
	 ...
	 * @return a KeyAccess instance, or null if the channel is not supported
	 *         by this factory.
	 * @throws NullPointerException if channel is null
	 */
	@Nullable KeyAccess getKeyAccess(@Nonnull Channel channel);

	/**
	 * Check whether a particular channel class is supported by this factory.
	 *
	 * @param clazz Channel class, may not be null
	 * @return true if the class is supported, i.e. getKeyAccess() can be
	 *         expected to succeed.
